...
static MinMaxTestParam::TupleTable g_minmax_table_cl
{
    // element type
    {
        ElemType::U8,
...
NEW_TESTCASE(matrix, MinMax, opencl)
{
    MinMaxTest minmax_test(UnitTest::GetInstance()->GetContext(), g_minmax_table_cl);
