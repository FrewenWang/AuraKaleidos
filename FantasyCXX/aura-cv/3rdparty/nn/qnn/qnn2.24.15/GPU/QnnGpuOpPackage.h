...
typedef struct {
  ...
  /// GPU device iaura 2D max width
  size_t iaura2dMaxWidth;
  /// GPU device iaura 2D max height
  size_t iaura2dMaxHeight;
  ...
  /// GPU device iaura 2D Array max width
  size_t iaura2dArrayMaxWidth;
  /// GPU device iaura 2D Array max height
  size_t iaura2dArrayMaxHeight;
  /// GPU device iaura 2D Array max depth
  size_t iaura2dArrayMaxDepth;
...
typedef enum {
  ...
  /// GPU driver iaura 2D memory object
  QNN_GPU_MEM_OBJ_TYPE_IAURA2D = 2,
  /// GPU driver iaura 2D array memory object
  QNN_GPU_MEM_OBJ_TYPE_IAURA2D_ARRAY = 3,
  /// Aggregation of GPU driver iaura 2D memory objects
  QNN_GPU_MEM_OBJ_TYPE_AGGREGATED_IAURA2D = 4,
  /// Aggregation of GPU driver iaura 2D array memory objects
  QNN_GPU_MEM_OBJ_TYPE_AGGREGATED_IAURA2D_ARRAY = 5,
...
typedef struct {
  ...
  ///   QNN_GPU_MEM_OBJ_TYPE_IAURA2D                  -> {height,width}                        \n
  ///   QNN_GPU_MEM_OBJ_TYPE_IAURA2D_ARRAY            -> {height,width,array_size}             \n
  ///   QNN_GPU_MEM_OBJ_TYPE_AGGREGATED_IAURA2D       -> {num_batches,height,width}            \n
  ///   QNN_GPU_MEM_OBJ_TYPE_AGGREGATED_IAURA2D_ARRAY -> {num_batches,height,width,array_size}
  uint32_t* dimensions;
  ...
  ///   QNN_GPU_MEM_OBJ_TYPE_IAURA2D                  -> 2            \n
  ///   QNN_GPU_MEM_OBJ_TYPE_IAURA2D_ARRAY            -> 3            \n
  ///   QNN_GPU_MEM_OBJ_TYPE_AGGREGATED_IAURA2D       -> 3            \n
  ///   QNN_GPU_MEM_OBJ_TYPE_AGGREGATED_IAURA2D_ARRAY -> 4
