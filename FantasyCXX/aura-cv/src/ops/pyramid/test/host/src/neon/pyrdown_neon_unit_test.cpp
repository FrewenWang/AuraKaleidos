...
static PyrDownParam::TupleTable g_pyrdown_table_neon
{
    //elem type
    {
        ElemType::U8,
...
NEW_TESTCASE(pyramid, PyrDown, neon)
{
    PyrDownTest test(UnitTest::GetInstance()->GetContext(), g_pyrdown_table_neon);
