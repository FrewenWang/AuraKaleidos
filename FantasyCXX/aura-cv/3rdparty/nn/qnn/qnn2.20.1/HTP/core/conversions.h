...
/**
 * @brief 'iaura' conversion from TIN to TOUT (which must be the same size)
 * e.g. iaura_convert<unsigned,float>( 1.25f) -> 0x3fa00000
 */

template <typename TOUT, typename TIN> inline constexpr TOUT iaura_convert(TIN x)
{
