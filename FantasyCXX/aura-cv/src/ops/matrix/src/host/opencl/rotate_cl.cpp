...
static std::string GetCLBuildOptions(Context *ctx, ElemType elem_type, DT_S32 elem_counts, RotateType rot_type)
{
...
std::vector<CLKernel> RotateCL::GetCLKernels(Context *ctx, ElemType elem_type, DT_S32 ochannel, RotateType type)
{
    std::vector<CLKernel> cl_kernels;
    DT_S32 elem_counts    = (1 == ochannel) ? 8 : 4;
