...
static SumMeanTestParam::TupleTable g_summean_table_none
{
    // element type
    {
...
NEW_TESTCASE(matrix, SumMean, none)
{
    SumMeanTest summean_test(UnitTest::GetInstance()->GetContext(), g_summean_table_none);
