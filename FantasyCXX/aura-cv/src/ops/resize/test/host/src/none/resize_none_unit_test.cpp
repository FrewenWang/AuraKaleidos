...
static ResizeParam::TupleTable g_resize_up_table_none
{
    // elem_type
    {
...
static ResizeParam::TupleTable g_resize_down_table_none
{
    // elem_type
    {
        ElemType::U8,  ElemType::S8,
...
NEW_TESTCASE(resize, Resize, none)
{
    ResizeTest test_up(UnitTest::GetInstance()->GetContext(), g_resize_up_table_none);
    test_up.RunTest(this, UnitTest::GetInstance()->GetStressCount());
    ResizeTest test_down(UnitTest::GetInstance()->GetContext(), g_resize_down_table_none);
