...
static GemmParam::TupleTable g_gemm_table_none
{
    // elem_type
    {
        ElemType::F32,
...
NEW_TESTCASE(matrix, Gemm, none)
{
    MatrixGemmTest matrix_gemm_test(UnitTest::GetInstance()->GetContext(), g_gemm_table_none);
