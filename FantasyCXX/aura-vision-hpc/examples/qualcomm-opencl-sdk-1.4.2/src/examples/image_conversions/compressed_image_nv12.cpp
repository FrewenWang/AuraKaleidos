...
// Desc: This program shows how to compress an NV12 image.
//
// Author:      QUALCOMM
//
...
int main(int argc, char** argv)
{
    ...
    err = clFinish(command_queue); // Note the blocking read below will flush/finish the queue, but this is included for clarity.
    if (err != CL_SUCCESS)
    {
