...
kernel void LaplacianMain3x3C2(global St *src, int istep,
                               ...
                               struct Scalar border_value)
{
    ...
    v16it_sum_l = v16it_src_p + v16it_src_n;
    v16it_sum_c =  ROT_R(v16it_src_c, 16, 14) * (V16InterType)-4;
    v16it_sum_r =  ROT_R(v16it_sum_l, 16, 12);

    v16it_result = (v16it_sum_l + v16it_sum_c + v16it_sum_r) * (V16InterType)2;
