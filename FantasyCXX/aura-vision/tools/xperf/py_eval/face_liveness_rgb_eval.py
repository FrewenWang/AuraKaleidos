...
class FaceLivenessRGB(BaseEval):
    def __init__(self):
        super(FaceLivenessRGB, self).__init__()
        self.feature_name = 'face_liveness_rgb'
        self.local_data_path = self.local_data_path + '/' + self.feature_name
        self.save_file_name = 'face_liveness_rgb_sample_images'
    ...
    def prepare_eval_data(self):
        ...
        cd /home/iov/vision_space/data/VisionImages/test_images/face_liveness_rgb
    ...
    def eval(self, predict_json):
        f1 = open(os.path.join(self.local_data_path, 'face_liveness_rgb_detect_wrong_images.csv'), 'w', encoding='utf-8');
