...
NEW_TESTCASE(runtime_hexagon_instructions_splat_test)
{
    ...
    ret |= SplatTest<MI_U8>(ctx);
    ret |= SplatTest<MI_S8>(ctx);
    ret |= SplatTest<MI_U16>(ctx);
    ret |= SplatTest<MI_S16>(ctx);
    ret |= SplatTest<MI_U32>(ctx);
    ret |= SplatTest<MI_S32>(ctx);
    ret |= SplatTest<MI_F32>(ctx);
