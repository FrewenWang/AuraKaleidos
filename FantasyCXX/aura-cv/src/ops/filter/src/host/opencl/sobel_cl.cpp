...
static std::string GetCLBuildOptions(Context *ctx, DT_S32 dx, DT_S32 dy, DT_F32 scale, BorderType border_type,
...
static DT_VOID GetCLGlobalSize(DT_S32 ksize, DT_S32 height, DT_S32 width, cl::NDRange range[2], DT_S32 &main_width)
{
    ksize              = (1 == ksize) ? 3 : ksize;

    DT_S32 elem_counts = (3 == ksize) ? 6 : ((5 == ksize) ? 4 : 2);
...
Status SobelCL::SetArgs(const Array *src, Array *dst, DT_S32 dx, DT_S32 dy, DT_S32 ksize,
                        DT_F32 scale, BorderType border_type, const Scalar &border_value)
{
...
Status SobelCL::Run()
{
    ...
    cl_ret = m_cl_kernels[0].Run<cl::Buffer, DT_S32, cl::Buffer, DT_S32, DT_S32, DT_F32, DT_S32, DT_S32, CLScalar>(
    ...
    cl_ret |= m_cl_kernels[1].Run<cl::Buffer, DT_S32, cl::Buffer, DT_S32, DT_S32, DT_S32, DT_F32, DT_S32, DT_S32, DT_S32, CLScalar>(
                                  m_cl_src.GetCLMemRef<cl::Buffer>(), istep,
                                  m_cl_dst.GetCLMemRef<cl::Buffer>(), ostep,
...
std::vector<CLKernel> SobelCL::GetCLKernels(Context *ctx, DT_S32 dx, DT_S32 dy, DT_S32 ksize, DT_F32 scale, BorderType border_type,
