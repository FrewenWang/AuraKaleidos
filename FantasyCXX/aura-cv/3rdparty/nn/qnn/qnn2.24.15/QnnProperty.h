...
/**
 * @brief Property key to determine whether a backend supports updating quantization tensor encodings
 *        for UPDATABLE_NATIVE tensors.
 */
#define QNN_PROPERTY_TENSOR_SUPPORT_UPDATEABLE_NATIVE_TENSORS (QNN_PROPERTY_GROUP_TENSOR + 6)

/**
 * @brief Property key to determine whether a backend supports updating quantization tensor encodings
 *        for UPDATABLE_APP_READ, UPDATABLE_APP_WRITE, and UPDATABLE_APP_READWRITE tensors.
 */
