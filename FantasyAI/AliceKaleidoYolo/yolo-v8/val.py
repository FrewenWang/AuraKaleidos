...
from src.utils.general import (LOGGER, check_dataset, check_img_size, check_requirements, check_yaml,
...
from src.utils.torch_utils import select_device, smart_inference_mode, time_sync
...
def run(
    ...
    for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
        ...
        # Inference
        out, _ = model(im) if training else model(im, augment=augment, val=True)  # inference, loss outputs
        dt[1] += time_sync() - t2
