...
AURA_ALWAYS_INLINE AURA_VOID CvtShuffVectorX3(HVX_VectorX3 &v3_vec0, HVX_VectorX3 &v3_vec1, MI_S32 rt)
{
...
AURA_ALWAYS_INLINE AURA_VOID CvtSplatVectorX2(const MI_U8 *src_p, const MI_U8 *src_c, const MI_U8 *src_n0, const MI_U8 *src_n1, MI_S32 offset,
...
AURA_ALWAYS_INLINE AURA_VOID CvtSplatVectorX2(const MI_U16 *src_p, const MI_U16 *src_c, const MI_U16 *src_n0, const MI_U16 *src_n1, MI_S32 offset,
                                            HVX_VectorX2 &v2u8_src_p, HVX_VectorX2 &v2u8_src_c, HVX_VectorX2 &v2u8_src_n0, HVX_VectorX2 &v2u8_src_n1)
{
...
AURA_ALWAYS_INLINE AURA_VOID CvtBayer2BgrCore(const HVX_VectorX2 &v2u8_src_p_x0, const HVX_VectorX2 &v2u8_src_c_x0, const HVX_VectorX2 &v2u8_src_n0_x0, const HVX_VectorX2 &v2u8_src_n1_x0,
...
AURA_ALWAYS_INLINE AURA_VOID CvtBayer2BgrCore(const HVX_VectorX2 &v2u16_src_p_x0, const HVX_VectorX2 &v2u16_src_c_x0, const HVX_VectorX2 &v2u16_src_n0_x0, const HVX_VectorX2 &v2u16_src_n1_x0,
...
static Status CvtBayer2BgrHvxImpl(const Mat &src, Mat &dst, MI_BOOL swapb, MI_BOOL swapg, MI_S32 start_row, MI_S32 end_row)
{
    ...
    MI_S32 offset = 3 * width;
    MI_S32 b_idx  = swapb ? 2 : 0;
    MI_S32 r_idx  = swapb ? 0 : 2;

    MI_S32 elem_counts = AURA_HVLEN / ElemTypeSize(dst.GetElemType());
    MI_S32 width_align = (width - 2) & (-(elem_counts * 2));
    ...
    MI_U64 L2fetch_param = L2PfParam(istride, width * ichannel * ElemTypeSize(src.GetElemType()), 4, 0);
...
Status CvtBayer2BgrHvx(Context *ctx, const Mat &src, Mat &dst, MI_BOOL swapb, MI_BOOL swapg)
{
    ...
    switch (dst.GetElemType())
    {
        case ElemType::U8:
        {
            ret = wp->ParallelFor((MI_S32)0, height, CvtBayer2BgrHvxImpl<MI_U8>, std::cref(src), std::ref(dst), swapb, swapg);
            break;
        }

        case ElemType::U16:
        {
            ret = wp->ParallelFor((MI_S32)0, height, CvtBayer2BgrHvxImpl<MI_U16>, std::cref(src), std::ref(dst), swapb, swapg);
            break;
        }
