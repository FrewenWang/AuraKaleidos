...
AURA_ALWAYS_INLINE DT_VOID Gaussian7x7VCore(HVX_Vector &vu8_src_p2, HVX_Vector &vu8_src_p1, HVX_Vector &vu8_src_p0, HVX_Vector &vu8_src_c,
                                            HVX_Vector &vu8_src_n0, HVX_Vector &vu8_src_n1, HVX_Vector &vu8_src_n2,
...

{
    ...
    DT_U32 k3k3k3k3 = Q6_R_vsplatb_R(kernel[3]);

    wu16_sum = Q6_Wh_vmpa_WubRub(Q6_W_vcombine_VV(vu8_src_p2, vu8_src_n2), k0k0k0k0);
    wu16_sum = Q6_Wh_vmpaacc_WhWubRub(wu16_sum, Q6_W_vcombine_VV(vu8_src_p1, vu8_src_n1), k1k1k1k1);
    wu16_sum = Q6_Wh_vmpaacc_WhWubRub(wu16_sum, Q6_W_vcombine_VV(vu8_src_p0, vu8_src_n0), k2k2k2k2);
    wu16_sum = Q6_Wuh_vmpyacc_WuhVubRub(wu16_sum, vu8_src_c, k3k3k3k3);
}

// using Tp = DT_U8
template <typename Tp, typename std::enable_if<std::is_same<Tp, DT_U8>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID Gaussian7x7HCore(HVX_VectorPair &wu16_sum_x0, HVX_VectorPair &wu16_sum_x1, HVX_VectorPair &wu16_sum_x2,
                                            HVX_Vector &vu8_result, const DT_U16 *kernel)
{
    DT_U32 k0k0k0k0   = Q6_R_vsplatb_R(kernel[0]);
    DT_U32 k1k1k1k1   = Q6_R_vsplatb_R(kernel[1]);
    DT_U32 k2k2k2k2   = Q6_R_vsplatb_R(kernel[2]);
    DT_U32 k3k3       = (kernel[3] << 16) | kernel[3];
    ...
    wu32_sum_lo = Q6_Ww_vmpa_WuhRb(Q6_W_vcombine_VV(vu16_sum_l1_hi, vu16_sum_r0_hi), k0k0k0k0);
    wu32_sum_lo = Q6_Ww_vmpaacc_WwWuhRb(wu32_sum_lo, Q6_W_vcombine_VV(vu16_sum_l0_lo, vu16_sum_r0_lo), k1k1k1k1);
    wu32_sum_lo = Q6_Ww_vmpaacc_WwWuhRb(wu32_sum_lo, Q6_W_vcombine_VV(vu16_sum_l0_hi, vu16_sum_c_hi), k2k2k2k2);
    wu32_sum_lo = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum_lo, vu16_sum_c_lo, k3k3);

    wu32_sum_hi = Q6_Ww_vmpa_WuhRb(Q6_W_vcombine_VV(vu16_sum_l0_lo, vu16_sum_r1_lo), k0k0k0k0);
    wu32_sum_hi = Q6_Ww_vmpaacc_WwWuhRb(wu32_sum_hi, Q6_W_vcombine_VV(vu16_sum_l0_hi, vu16_sum_r0_hi), k1k1k1k1);
    wu32_sum_hi = Q6_Ww_vmpaacc_WwWuhRb(wu32_sum_hi, Q6_W_vcombine_VV(vu16_sum_c_lo, vu16_sum_r0_lo), k2k2k2k2);
    wu32_sum_hi = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum_hi, vu16_sum_c_hi, k3k3);
...
AURA_ALWAYS_INLINE DT_VOID Gaussian7x7VCore(HVX_Vector &vu16_src_p2, HVX_Vector &vu16_src_p1, HVX_Vector &vu16_src_p0, HVX_Vector &vu16_c_src,
                                            HVX_Vector &vu16_src_n0, HVX_Vector &vu16_src_n1, HVX_Vector &vu16_src_n2,
                                            HVX_VectorPair &wu32_sum, const DT_U32 *kernel)
{
    ...
    wu32_sum = Q6_Wuw_vmpy_VuhRuh(vu16_src_p2, k0k0);
    wu32_sum = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum, vu16_src_p1, k1k1);
    wu32_sum = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum, vu16_src_p0, k2k2);
    wu32_sum = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum, vu16_c_src,  k3k3);
    wu32_sum = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum, vu16_src_n0, k2k2);
    wu32_sum = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum, vu16_src_n1, k1k1);
    wu32_sum = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum, vu16_src_n2, k0k0);
}

// using Tp = DT_U16
template <typename Tp, typename std::enable_if<std::is_same<Tp, DT_U16>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID Gaussian7x7HCore(HVX_VectorPair &wu32_sum_x0, HVX_VectorPair &wu32_sum_x1, HVX_VectorPair &wu32_sum_x2,
                                            HVX_Vector &vu16_result, const DT_U32 *kernel)
{
    ...
    wu64_sum    = Q6_Wd_vmulacc_WdVwVw(wu64_sum, vu32_sum_r0_lo, vu32_k1);
    wu64_sum    = Q6_Wd_vmulacc_WdVwVw(wu64_sum, vu32_sum_r0_hi, vu32_k0);
    ...
    wu64_sum    = Q6_Wd_vmul_VwVw(vu32_sum_l0_lo, vu32_k0);
    wu64_sum    = Q6_Wd_vmulacc_WdVwVw(wu64_sum, vu32_sum_l0_hi, vu32_k1);
...
AURA_ALWAYS_INLINE DT_VOID Gaussian7x7VCore(HVX_Vector &vs16_src_p2, HVX_Vector &vs16_src_p1, HVX_Vector &vs16_src_p0, HVX_Vector &vs16_src_c,
                                            HVX_Vector &vs16_src_n0, HVX_Vector &vs16_src_n1, HVX_Vector &vs16_src_n2,
                                            HVX_VectorPair &ws32_sum, const DT_S32 *kernel)
{
    ...
    DT_S32 k3k3 = (kernel[3] << 16) | kernel[3];

    ws32_sum = Q6_Ww_vmpy_VhRh(vs16_src_p2, k0k0);
    ws32_sum = Q6_Ww_vmpyacc_WwVhRh(ws32_sum, vs16_src_p1, k1k1);
    ws32_sum = Q6_Ww_vmpyacc_WwVhRh(ws32_sum, vs16_src_p0, k2k2);
    ws32_sum = Q6_Ww_vmpyacc_WwVhRh(ws32_sum, vs16_src_c,  k3k3);
    ws32_sum = Q6_Ww_vmpyacc_WwVhRh(ws32_sum, vs16_src_n0, k2k2);
    ws32_sum = Q6_Ww_vmpyacc_WwVhRh(ws32_sum, vs16_src_n1, k1k1);
    ws32_sum = Q6_Ww_vmpyacc_WwVhRh(ws32_sum, vs16_src_n2, k0k0);
}

// using Tp = DT_S16
template <typename Tp, typename std::enable_if<std::is_same<Tp, DT_S16>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID Gaussian7x7HCore(HVX_VectorPair &ws32_sum_x0, HVX_VectorPair &ws32_sum_x1, HVX_VectorPair &ws32_sum_x2,
                                            HVX_Vector &vs16_result, const DT_S32 *kernel)
{
    ...
    HVX_Vector vs32_sum_l0_lo = Q6_V_vlalign_VVR(vs32_sum_x1_lo, vs32_sum_x0_lo, align_size);
    HVX_Vector vs32_sum_l0_hi = Q6_V_vlalign_VVR(vs32_sum_x1_hi, vs32_sum_x0_hi, align_size);
    HVX_Vector vs32_sum_c_lo  = vs32_sum_x1_lo;
    HVX_Vector vs32_sum_c_hi  = vs32_sum_x1_hi;
    HVX_Vector vs32_sum_r0_lo = Q6_V_valign_VVR(vs32_sum_x2_lo, vs32_sum_x1_lo, align_size);
    HVX_Vector vs32_sum_r0_hi = Q6_V_valign_VVR(vs32_sum_x2_hi, vs32_sum_x1_hi, align_size);
    ...
    ws64_sum    = Q6_Wd_vmulacc_WdVwVw(ws64_sum, vs32_sum_r0_lo, vs32_k1);
    ws64_sum    = Q6_Wd_vmulacc_WdVwVw(ws64_sum, vs32_sum_r0_hi, vs32_k0);
    ...
    ws64_sum    = Q6_Wd_vmul_VwVw(vs32_sum_l0_lo, vs32_k0);
    ws64_sum    = Q6_Wd_vmulacc_WdVwVw(ws64_sum, vs32_sum_l0_hi, vs32_k1);
...
AURA_ALWAYS_INLINE DT_VOID Gaussian7x7VCore(HVX_Vector &vu32_src_p2, HVX_Vector &vu32_src_p1, HVX_Vector &vu32_p0_src, HVX_Vector &vu32_src_c,
                                            HVX_Vector &vu32_src_n0, HVX_Vector &vu32_src_n1, HVX_Vector &vu32_src_n2,
                                            HVX_VectorPair &wu64_sum, const DT_U32 *kernel)
{
    ...
    wu64_sum = Q6_Wud_vmul32xlo16_VuwVuw(vu32_src_p2, vu32_k0);
    wu64_sum = Q6_Wud_vadd_WudWud(wu64_sum, Q6_Wud_vmul32xlo16_VuwVuw(vu32_src_p1, vu32_k1));
    wu64_sum = Q6_Wud_vadd_WudWud(wu64_sum, Q6_Wud_vmul32xlo16_VuwVuw(vu32_p0_src, vu32_k2));
    wu64_sum = Q6_Wud_vadd_WudWud(wu64_sum, Q6_Wud_vmul32xlo16_VuwVuw(vu32_src_c,  vu32_k3));
    wu64_sum = Q6_Wud_vadd_WudWud(wu64_sum, Q6_Wud_vmul32xlo16_VuwVuw(vu32_src_n0, vu32_k2));
    wu64_sum = Q6_Wud_vadd_WudWud(wu64_sum, Q6_Wud_vmul32xlo16_VuwVuw(vu32_src_n1, vu32_k1));
    wu64_sum = Q6_Wud_vadd_WudWud(wu64_sum, Q6_Wud_vmul32xlo16_VuwVuw(vu32_src_n2, vu32_k0));
}

// using Tp = DT_S32
template <typename Tp, typename std::enable_if<std::is_same<Tp, DT_S32>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID Gaussian7x7VCore(HVX_Vector &vs32_src_p2, HVX_Vector &vs32_src_p1, HVX_Vector &vs32_src_p0, HVX_Vector &vs32_src_c,
                                            HVX_Vector &vs32_src_n0, HVX_Vector &vs32_src_n1, HVX_Vector &vs32_src_n2,
                                            HVX_VectorPair &ws64_sum, const DT_S32 *kernel)
{
    ...
    ws64_sum = Q6_Wd_vmul_VwVw(vs32_src_p2, vs32_k0);
    ws64_sum = Q6_Wd_vmulacc_WdVwVw(ws64_sum, vs32_src_p1, vs32_k1);
    ws64_sum = Q6_Wd_vmulacc_WdVwVw(ws64_sum, vs32_src_p0, vs32_k2);
    ws64_sum = Q6_Wd_vmulacc_WdVwVw(ws64_sum, vs32_src_c,  vs32_k3);
    ws64_sum = Q6_Wd_vmulacc_WdVwVw(ws64_sum, vs32_src_n0, vs32_k2);
    ws64_sum = Q6_Wd_vmulacc_WdVwVw(ws64_sum, vs32_src_n1, vs32_k1);
    ws64_sum = Q6_Wd_vmulacc_WdVwVw(ws64_sum, vs32_src_n2, vs32_k0);
}

// using Tp = DT_U32 DT_S32
template <typename Tp, typename Kt, typename std::enable_if<sizeof(Tp) == 4>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID Gaussian7x7HCore(HVX_VectorPair &wd64_sum_x0, HVX_VectorPair &wd64_sum_x1, HVX_VectorPair &wd64_sum_x2,
                                            HVX_Vector &vd32_result, const Kt *kernel)
{
    ...
    wd64_sum    = Q6_Wud_vmul32xlo16_VuwVuw(vd64_sum_l2_lo, vu32_k0);
    wd64_sum    = Q6_Wud_vadd_WudWud(wd64_sum, Q6_Wud_vmul32xlo16_VuwVuw(vd64_sum_l1_lo, vu32_k1));
    wd64_sum    = Q6_Wud_vadd_WudWud(wd64_sum, Q6_Wud_vmul32xlo16_VuwVuw(vd64_sum_l0_lo, vu32_k2));
    wd64_sum    = Q6_Wud_vadd_WudWud(wd64_sum, Q6_Wud_vmul32xlo16_VuwVuw(vd64_sum_c_lo,  vu32_k3));
    wd64_sum    = Q6_Wud_vadd_WudWud(wd64_sum, Q6_Wud_vmul32xlo16_VuwVuw(vd64_sum_r0_lo, vu32_k2));
    wd64_sum    = Q6_Wud_vadd_WudWud(wd64_sum, Q6_Wud_vmul32xlo16_VuwVuw(vd64_sum_r1_lo, vu32_k1));
    wd64_sum    = Q6_Wud_vadd_WudWud(wd64_sum, Q6_Wud_vmul32xlo16_VuwVuw(vd64_sum_r2_lo, vu32_k0));
    wd64_sum    = Q6_Wud_vadd_WudWud(wd64_sum, Q6_W_vcombine_VV(Q6_V_vzero(), vu32_half));

    vd32_sum_hi = Q6_Vw_vmpyie_VwVuh(vd64_sum_l2_hi, vu32_k0);
    vd32_sum_hi = Q6_Vw_vadd_VwVw(vd32_sum_hi, Q6_Vw_vmpyie_VwVuh(vd64_sum_l1_hi, vu32_k1));
    vd32_sum_hi = Q6_Vw_vadd_VwVw(vd32_sum_hi, Q6_Vw_vmpyie_VwVuh(vd64_sum_l0_hi, vu32_k2));
    vd32_sum_hi = Q6_Vw_vadd_VwVw(vd32_sum_hi, Q6_Vw_vmpyie_VwVuh(vd64_sum_c_hi,  vu32_k3));
    vd32_sum_hi = Q6_Vw_vadd_VwVw(vd32_sum_hi, Q6_Vw_vmpyie_VwVuh(vd64_sum_r0_hi, vu32_k2));
    vd32_sum_hi = Q6_Vw_vadd_VwVw(vd32_sum_hi, Q6_Vw_vmpyie_VwVuh(vd64_sum_r1_hi, vu32_k1));
    vd32_sum_hi = Q6_Vw_vadd_VwVw(vd32_sum_hi, Q6_Vw_vmpyie_VwVuh(vd64_sum_r2_hi, vu32_k0));
...
template <typename Tp, typename Kt, typename std::enable_if<sizeof(Tp) != 4>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID Gaussian7x7HCore(HVX_VectorPair &w_sum_x0, HVX_VectorPair &w_sum_x1, HVX_VectorPair &w_sum_x2, HVX_VectorPair &w_sum_x3,
                                            HVX_Vector &v_result_x0, HVX_Vector &v_result_x1, const Kt *kernel, DT_S32 rest)
{
    ...
    Gaussian7x7HCore<Tp>(w_sum_x0, w_sum_x1, w_sum_r0, v_result_x0, kernel);
    Gaussian7x7HCore<Tp>(w_sum_l0, w_sum_x2, w_sum_x3, v_result_x1, kernel);
}

// Tp = DT_U32 DT_S32
template <typename Tp, typename Kt, typename std::enable_if<sizeof(Tp) == 4>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID Gaussian7x7HCore(HVX_VectorPair &wd64_sum_x0, HVX_VectorPair &wd64_sum_x1, HVX_VectorPair &wd64_sum_x2, HVX_VectorPair &wd64_sum_x3,
                                            HVX_Vector &vd32_result_x0, HVX_Vector &vd32_result_x1, const Kt *kernel, DT_S32 rest)
{
    ...
    Gaussian7x7HCore<Tp>(wd64_sum_x0, wd64_sum_x1, wd64_sum_r0, vd32_result_x0, kernel);
    Gaussian7x7HCore<Tp>(wd64_sum_l0, wd64_sum_x2, wd64_sum_x3, vd32_result_x1, kernel);
}
                              ...
                              const Kt *kernel, const std::vector<Tp> &border_value)
{
    ...
    // left border
    {
        ...
        for (DT_S32 ch = 0; ch < C; ch++)
        {
            ...
            Gaussian7x7VCore<Tp>(v_border_p2, v_border_p1, v_border_p0, v_border_c, v_border_n0, v_border_n1, v_border_n2, mw_sum_x0.val[ch], kernel);
            Gaussian7x7VCore<Tp>(mv_src_p2.val[ch], mv_src_p1.val[ch], mv_src_p0.val[ch], mv_src_c.val[ch], mv_src_n0.val[ch], mv_src_n1.val[ch], mv_src_n2.val[ch], mw_sum_x1.val[ch], kernel);
        }
    }
    ...
    // main(0 ~ n-2)
    {
        for (DT_S32 x = elem_counts; x <= back_offset; x += elem_counts)
        {
            ...
            for (DT_S32 ch = 0; ch < C; ch++)
            {
                Gaussian7x7VCore<Tp>(mv_src_p2.val[ch], mv_src_p1.val[ch], mv_src_p0.val[ch], mv_src_c.val[ch], mv_src_n0.val[ch], mv_src_n1.val[ch], mv_src_n2.val[ch], mw_sum_x2.val[ch], kernel);
                Gaussian7x7HCore<Tp>(mw_sum_x0.val[ch], mw_sum_x1.val[ch], mw_sum_x2.val[ch], mv_result.val[ch], kernel);
            }
    ...
    // remain
    {
        ...
        for (DT_S32 ch = 0; ch < C; ch++)
        {
            ...
            Gaussian7x7VCore<Tp>(mv_src_p2.val[ch], mv_src_p1.val[ch], mv_src_p0.val[ch], mv_src_c.val[ch], mv_src_n0.val[ch], mv_src_n1.val[ch], mv_src_n2.val[ch], w_sum_x2, kernel);
            Gaussian7x7VCore<Tp>(v_border_p2, v_border_p1, v_border_p0, v_border_c, v_border_n0, v_border_n1, v_border_n2, w_sum_x3, kernel);

            Gaussian7x7HCore<Tp, Kt>(mw_sum_x0.val[ch], mw_sum_x1.val[ch], w_sum_x2, w_sum_x3, mv_result.val[ch], mv_last.val[ch], kernel, rest);
        }
...
static Status Gaussian7x7HvxImpl(const Mat &src, Mat &dst, const Mat &kmat, const std::vector<Tp> &border_value,
                                 const Tp *border_buffer, DT_S32 start_row, DT_S32 end_row)
{
    ...
    for (DT_S32 y = start_row; y < end_row; y++)
    {
        ...
        Gaussian7x7Row<Tp, BORDER_TYPE, C, Kt>(src_p2, src_p1, src_p0, src_c, src_n0, src_n1, src_n2, dst_row, width, kernel, border_value);
...
static Status Gaussian7x7HvxHelper(Context *ctx, const Mat &src, Mat &dst, const Mat &kmat,
                                   const std::vector<Tp> &border_value, const Tp *border_buffer)
{
    ...
    switch (channel)
    {
        case 1:
        {
            ret = wp->ParallelFor((DT_S32)0, height, Gaussian7x7HvxImpl<Tp, BORDER_TYPE, 1>,
        ...
        case 2:
        {
            ret = wp->ParallelFor((DT_S32)0, height, Gaussian7x7HvxImpl<Tp, BORDER_TYPE, 2>,
                                  std::cref(src), std::ref(dst), std::cref(kmat), std::cref(border_value), border_buffer);
            break;
        }
        ...
        case 3:
        {
            ret = wp->ParallelFor((DT_S32)0, height, Gaussian7x7HvxImpl<Tp, BORDER_TYPE, 3>,
                                  std::cref(src), std::ref(dst), std::cref(kmat), std::cref(border_value), border_buffer);
            break;
        }
                                   ...
                                   BorderType border_type, const Scalar &border_value)
{
    ...
    switch (border_type)
    {
        case BorderType::CONSTANT:
        {
            ...
            ret = Gaussian7x7HvxHelper<Tp, BorderType::CONSTANT>(ctx, src, dst, kmat, vec_border_value, border_buffer);
        ...
        {
            ret = Gaussian7x7HvxHelper<Tp, BorderType::REPLICATE>(ctx, src, dst, kmat, vec_border_value, border_buffer);
            break;
        }

        case BorderType::REFLECT_101:
        {
            ret = Gaussian7x7HvxHelper<Tp, BorderType::REFLECT_101>(ctx, src, dst, kmat, vec_border_value, border_buffer);
            break;
        }
                      ...
                      BorderType border_type, const Scalar &border_value)
{
    ...
    switch (src.GetElemType())
    {
        case ElemType::U8:
        {
            ret = Gaussian7x7HvxHelper<DT_U8>(ctx, src, dst, kmat, border_type, border_value);
            break;
        }

        case ElemType::U16:
        {
            ret = Gaussian7x7HvxHelper<DT_U16>(ctx, src, dst, kmat, border_type, border_value);
            break;
        }

        case ElemType::S16:
        {
            ret = Gaussian7x7HvxHelper<DT_S16>(ctx, src, dst, kmat, border_type, border_value);
            break;
        }

        case ElemType::U32:
        {
            ret = Gaussian7x7HvxHelper<DT_U32>(ctx, src, dst, kmat, border_type, border_value);
            break;
        }

        case ElemType::S32:
        {
            ret = Gaussian7x7HvxHelper<DT_S32>(ctx, src, dst, kmat, border_type, border_value);
            break;
        }
