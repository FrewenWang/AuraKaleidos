...
static BilateralParam::TupleTable g_bilateral_table_neon {
    // element
    {
        ElemType::U8,
    },
...
NEW_TESTCASE(filter, Bilateral, neon)
{
    BilateralTest test(UnitTest::GetInstance()->GetContext(), g_bilateral_table_neon);
