...
kernel void GaussianMain3x3C3(global St *src, int istep,
                              ...
                              struct Scalar border_value)
{
    ...
    V16St        v16it_src_p, v16it_src_c, v16it_src_n;
    ...
    else
    {
        ...
        V8St  v8it_border_value  = {v3it_border_value.s12, v3it_border_value, v3it_border_value};
    ...
    v16it_sum   = (GAUSSIAN_CONVERT(v16it_src_p, V16InterType) + GAUSSIAN_CONVERT(v16it_src_n, V16InterType)) * (Kt)filter[0] +
                  GAUSSIAN_CONVERT(v16it_src_c, V16InterType) * (Kt)filter[1];

    v8it_result = (v16it_sum.s01234567 + v16it_sum.s6789ABCD) * (V8InterType)filter[0] + (v16it_sum.s3456789A) * (V8InterType)filter[1];
    it_result   = (v16it_sum.s8 + v16it_sum.sE) * (InterType)filter[0] + (v16it_sum.sB) * (InterType)filter[1];
