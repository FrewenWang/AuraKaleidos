...
AURA_ALWAYS_INLINE AURA_VOID Gaussian3x3VCore(HVX_Vector &vu8_src_p0, HVX_Vector &vu8_src_c, HVX_Vector &vu8_src_n0,
...
// using Tp = MI_U8
template <typename Tp, typename std::enable_if<std::is_same<Tp, MI_U8>::value>::type* = MI_NULL>
AURA_ALWAYS_INLINE AURA_VOID Gaussian3x3HCore(HVX_VectorPair &wu16_sum_x0, HVX_VectorPair &wu16_sum_x1, HVX_VectorPair &wu16_sum_x2,
...
AURA_ALWAYS_INLINE AURA_VOID Gaussian3x3VCore(HVX_Vector &vu16_src_p0, HVX_Vector &vu16_src_c, HVX_Vector &vu16_src_n0,
...
// using Tp = MI_U16
template <typename Tp, typename std::enable_if<std::is_same<Tp, MI_U16>::value>::type* = MI_NULL>
AURA_ALWAYS_INLINE AURA_VOID Gaussian3x3HCore(HVX_VectorPair &wu32_sum_x0, HVX_VectorPair &wu32_sum_x1, HVX_VectorPair &wu32_sum_x2,
...
AURA_ALWAYS_INLINE AURA_VOID Gaussian3x3VCore(HVX_Vector &vs16_src_p0, HVX_Vector &vs16_src_c, HVX_Vector &vs16_src_n0,
...
// using Tp = MI_S16
template <typename Tp, typename std::enable_if<std::is_same<Tp, MI_S16>::value>::type* = MI_NULL>
AURA_ALWAYS_INLINE AURA_VOID Gaussian3x3HCore(HVX_VectorPair &ws32_sum_x0, HVX_VectorPair &ws32_sum_x1, HVX_VectorPair &ws32_sum_x2,
...
AURA_ALWAYS_INLINE AURA_VOID Gaussian3x3VCore(HVX_Vector &vu32_src_p0, HVX_Vector &vu32_src_c, HVX_Vector &vu32_src_n0,
...
AURA_ALWAYS_INLINE AURA_VOID Gaussian3x3HCore(HVX_VectorPair &wd64_sum_x0, HVX_VectorPair &wd64_sum_x1, HVX_VectorPair &wd64_sum_x2,
...
AURA_ALWAYS_INLINE AURA_VOID Gaussian3x3VCore(HVX_Vector &vs32_src_p0, HVX_Vector &vs32_src_c, HVX_Vector &vs32_src_n0,
...
template <typename Tp, typename Kt, typename std::enable_if<sizeof(Tp) != 4>::type* = MI_NULL>
AURA_ALWAYS_INLINE AURA_VOID Gaussian3x3HCore(HVX_VectorPair &w_sum_x0, HVX_VectorPair &w_sum_x1, HVX_VectorPair &w_sum_x2, HVX_VectorPair &w_sum_x3,
...
// Tp = MI_U32 MI_S32
template <typename Tp, typename Kt, typename std::enable_if<sizeof(Tp) == 4>::type* = MI_NULL>
AURA_ALWAYS_INLINE AURA_VOID Gaussian3x3HCore(HVX_VectorPair &wd64_sum_x0, HVX_VectorPair &wd64_sum_x1, HVX_VectorPair &wd64_sum_x2, HVX_VectorPair &wd64_sum_x3,
...
static AURA_VOID Gaussian3x3Row(const Tp *src_p0, const Tp *src_c, const Tp *src_n0, Tp *dst,
                                   ...
                                   const std::vector<Tp> &border_value, const Tp *border_buffer)
{
    ...
    switch (channel)
    {
        ...
        case 1:
        {
            ...
            ret = wp->ParallelFor((MI_S32)0, height, Gaussian3x3HvxImpl<Tp, BORDER_TYPE, 1>,
        ...
        case 2:
        {
            ret = wp->ParallelFor((MI_S32)0, height, Gaussian3x3HvxImpl<Tp, BORDER_TYPE, 2>,
                                  std::cref(src), std::ref(dst), std::cref(kmat), std::cref(border_value), border_buffer);
            break;
        }
        ...
        case 3:
        {
            ret = wp->ParallelFor((MI_S32)0, height, Gaussian3x3HvxImpl<Tp, BORDER_TYPE, 3>,
                                  std::cref(src), std::ref(dst), std::cref(kmat), std::cref(border_value), border_buffer);
            break;
        }
...
/**
 * 模板函数。传入的模板数据可能是：MI_U8、MI_U16、MI_S16、MI_U32、MI_S32
 * @tparam Tp
 * @param ctx
 * @param src
 * @param dst
                      ...
                      BorderType border_type, const Scalar &border_value)
{
    ...
    switch (src.GetElemType())
    {
        ...
        case ElemType::U8:
        {
            ret = Gaussian3x3HvxHelper<MI_U8>(ctx, src, dst, kmat, border_type, border_value);
            break;
        }

        case ElemType::U16:
        {
            ret = Gaussian3x3HvxHelper<MI_U16>(ctx, src, dst, kmat, border_type, border_value);
            break;
        }

        case ElemType::S16:
        {
            ret = Gaussian3x3HvxHelper<MI_S16>(ctx, src, dst, kmat, border_type, border_value);
            break;
        }

        case ElemType::U32:
        {
            ret = Gaussian3x3HvxHelper<MI_U32>(ctx, src, dst, kmat, border_type, border_value);
            break;
        }

        case ElemType::S32:
        {
            ret = Gaussian3x3HvxHelper<MI_S32>(ctx, src, dst, kmat, border_type, border_value);
            break;
        }
