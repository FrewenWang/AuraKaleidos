...
static const char* TAG = "Test_Change_Dtype";
...
std::vector<double> TestChangeDtype::test_change_dtype_u8_to_fp32_176x144() {
    ...
    float cosine_distance = FaceIdUtil::compare_image_data((float*)src_mat_fp32.data,
...
std::vector<double> TestChangeDtype::test_change_dtype_fp32_to_u8_176x144() {
    ...
    float cosine_distance = FaceIdUtil::compare_image_data((char*)src_mat_u8.data,
