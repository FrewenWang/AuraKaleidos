...
template <> struct Scalar<uint8x8_t>   { using SType = DT_U8;  };
template <> struct Scalar<int8x8_t>    { using SType = DT_S8;  };
template <> struct Scalar<uint16x4_t>  { using SType = DT_U16; };
template <> struct Scalar<int16x4_t>   { using SType = DT_S16; };
template <> struct Scalar<uint32x2_t>  { using SType = DT_U32; };
template <> struct Scalar<int32x2_t>   { using SType = DT_S32; };
template <> struct Scalar<uint64x1_t>  { using SType = DT_U64; };
template <> struct Scalar<int64x1_t>   { using SType = DT_S64; };
template <> struct Scalar<float32x2_t> { using SType = DT_F32; };
#if defined(__aarch64__)
template <> struct Scalar<float64x1_t> { using SType = DT_F64; };
#endif // __aarch64__
#if defined(AURA_ENABLE_NEON_FP16)
template <> struct Scalar<float16x4_t> { using SType = MI_F16; };
#endif

template <> struct Scalar<uint8x16_t>  { using SType = DT_U8;  };
template <> struct Scalar<int8x16_t>   { using SType = DT_S8;  };
template <> struct Scalar<uint16x8_t>  { using SType = DT_U16; };
template <> struct Scalar<int16x8_t>   { using SType = DT_S16; };
template <> struct Scalar<uint32x4_t>  { using SType = DT_U32; };
template <> struct Scalar<int32x4_t>   { using SType = DT_S32; };
template <> struct Scalar<uint64x2_t>  { using SType = DT_U64; };
template <> struct Scalar<int64x2_t>   { using SType = DT_S64; };
template <> struct Scalar<float32x4_t> { using SType = DT_F32; };
#if defined(__aarch64__)
template <> struct Scalar<float64x2_t> { using SType = DT_F64; };
#endif // __aarch64__
#if defined(AURA_ENABLE_NEON_FP16)
template <> struct Scalar<float16x8_t> { using SType = MI_F16; };
#endif

template <> struct Scalar<uint8x8x1_t>   { using SType = DT_U8;  };
template <> struct Scalar<uint8x8x2_t>   { using SType = DT_U8;  };
template <> struct Scalar<uint8x8x3_t>   { using SType = DT_U8;  };
template <> struct Scalar<uint8x8x4_t>   { using SType = DT_U8;  };
template <> struct Scalar<int8x8x1_t>    { using SType = DT_S8;  };
template <> struct Scalar<int8x8x2_t>    { using SType = DT_S8;  };
template <> struct Scalar<int8x8x3_t>    { using SType = DT_S8;  };
template <> struct Scalar<int8x8x4_t>    { using SType = DT_S8;  };
template <> struct Scalar<uint16x4x1_t>  { using SType = DT_U16; };
template <> struct Scalar<uint16x4x2_t>  { using SType = DT_U16; };
template <> struct Scalar<uint16x4x3_t>  { using SType = DT_U16; };
template <> struct Scalar<uint16x4x4_t>  { using SType = DT_U16; };
template <> struct Scalar<int16x4x1_t>   { using SType = DT_S16; };
template <> struct Scalar<int16x4x2_t>   { using SType = DT_S16; };
template <> struct Scalar<int16x4x3_t>   { using SType = DT_S16; };
template <> struct Scalar<int16x4x4_t>   { using SType = DT_S16; };
template <> struct Scalar<uint32x2x1_t>  { using SType = DT_U32; };
template <> struct Scalar<uint32x2x2_t>  { using SType = DT_U32; };
template <> struct Scalar<uint32x2x3_t>  { using SType = DT_U32; };
template <> struct Scalar<uint32x2x4_t>  { using SType = DT_U32; };
template <> struct Scalar<int32x2x1_t>   { using SType = DT_S32; };
template <> struct Scalar<int32x2x2_t>   { using SType = DT_S32; };
template <> struct Scalar<int32x2x3_t>   { using SType = DT_S32; };
template <> struct Scalar<int32x2x4_t>   { using SType = DT_S32; };
template <> struct Scalar<uint64x1x1_t>  { using SType = DT_U64; };
template <> struct Scalar<uint64x1x2_t>  { using SType = DT_U64; };
template <> struct Scalar<uint64x1x3_t>  { using SType = DT_U64; };
template <> struct Scalar<uint64x1x4_t>  { using SType = DT_U64; };
template <> struct Scalar<int64x1x1_t>   { using SType = DT_S64; };
template <> struct Scalar<int64x1x2_t>   { using SType = DT_S64; };
template <> struct Scalar<int64x1x3_t>   { using SType = DT_S64; };
template <> struct Scalar<int64x1x4_t>   { using SType = DT_S64; };
template <> struct Scalar<float32x2x1_t> { using SType = DT_F32; };
template <> struct Scalar<float32x2x2_t> { using SType = DT_F32; };
template <> struct Scalar<float32x2x3_t> { using SType = DT_F32; };
template <> struct Scalar<float32x2x4_t> { using SType = DT_F32; };
#if defined(__aarch64__)
template <> struct Scalar<float64x1x1_t> { using SType = DT_F64; };
template <> struct Scalar<float64x1x2_t> { using SType = DT_F64; };
template <> struct Scalar<float64x1x3_t> { using SType = DT_F64; };
template <> struct Scalar<float64x1x4_t> { using SType = DT_F64; };
#endif // __aarch64__
#if defined(AURA_ENABLE_NEON_FP16)
...
template <> struct Scalar<uint8x16x1_t>  { using SType = DT_U8;  };
template <> struct Scalar<uint8x16x2_t>  { using SType = DT_U8;  };
template <> struct Scalar<uint8x16x3_t>  { using SType = DT_U8;  };
template <> struct Scalar<uint8x16x4_t>  { using SType = DT_U8;  };
template <> struct Scalar<int8x16x1_t>   { using SType = DT_S8;  };
template <> struct Scalar<int8x16x2_t>   { using SType = DT_S8;  };
template <> struct Scalar<int8x16x3_t>   { using SType = DT_S8;  };
template <> struct Scalar<int8x16x4_t>   { using SType = DT_S8;  };
template <> struct Scalar<uint16x8x1_t>  { using SType = DT_U16; };
template <> struct Scalar<uint16x8x2_t>  { using SType = DT_U16; };
template <> struct Scalar<uint16x8x3_t>  { using SType = DT_U16; };
template <> struct Scalar<uint16x8x4_t>  { using SType = DT_U16; };
template <> struct Scalar<int16x8x1_t>   { using SType = DT_S16; };
template <> struct Scalar<int16x8x2_t>   { using SType = DT_S16; };
template <> struct Scalar<int16x8x3_t>   { using SType = DT_S16; };
template <> struct Scalar<int16x8x4_t>   { using SType = DT_S16; };
template <> struct Scalar<uint32x4x1_t>  { using SType = DT_U32; };
template <> struct Scalar<uint32x4x2_t>  { using SType = DT_U32; };
template <> struct Scalar<uint32x4x3_t>  { using SType = DT_U32; };
template <> struct Scalar<uint32x4x4_t>  { using SType = DT_U32; };
template <> struct Scalar<int32x4x1_t>   { using SType = DT_S32; };
template <> struct Scalar<int32x4x2_t>   { using SType = DT_S32; };
template <> struct Scalar<int32x4x3_t>   { using SType = DT_S32; };
template <> struct Scalar<int32x4x4_t>   { using SType = DT_S32; };
template <> struct Scalar<uint64x2x1_t>  { using SType = DT_U64; };
template <> struct Scalar<uint64x2x2_t>  { using SType = DT_U64; };
template <> struct Scalar<uint64x2x3_t>  { using SType = DT_U64; };
template <> struct Scalar<uint64x2x4_t>  { using SType = DT_U64; };
template <> struct Scalar<int64x2x1_t>   { using SType = DT_S64; };
template <> struct Scalar<int64x2x2_t>   { using SType = DT_S64; };
template <> struct Scalar<int64x2x3_t>   { using SType = DT_S64; };
template <> struct Scalar<int64x2x4_t>   { using SType = DT_S64; };
template <> struct Scalar<float32x4x1_t> { using SType = DT_F32; };
template <> struct Scalar<float32x4x2_t> { using SType = DT_F32; };
template <> struct Scalar<float32x4x3_t> { using SType = DT_F32; };
template <> struct Scalar<float32x4x4_t> { using SType = DT_F32; };
#if defined(__aarch64__)
template <> struct Scalar<float64x2x1_t> { using SType = DT_F64; };
template <> struct Scalar<float64x2x2_t> { using SType = DT_F64; };
template <> struct Scalar<float64x2x3_t> { using SType = DT_F64; };
template <> struct Scalar<float64x2x4_t> { using SType = DT_F64; };
#endif // __aarch64__
#if defined(AURA_ENABLE_NEON_FP16)
...
template <> struct DVector<DT_U8>  { using VType = uint8x8_t;   };
template <> struct DVector<DT_S8>  { using VType = int8x8_t;    };
template <> struct DVector<DT_U16> { using VType = uint16x4_t;  };
template <> struct DVector<DT_S16> { using VType = int16x4_t;   };
template <> struct DVector<DT_U32> { using VType = uint32x2_t;  };
template <> struct DVector<DT_S32> { using VType = int32x2_t;   };
template <> struct DVector<DT_U64> { using VType = uint64x1_t;  };
template <> struct DVector<DT_S64> { using VType = int64x1_t;   };
template <> struct DVector<DT_F32> { using VType = float32x2_t; };
#if defined(__aarch64__)
template <> struct DVector<DT_F64> { using VType = float64x1_t; };
#endif // __aarch64__
#if defined(AURA_ENABLE_NEON_FP16)
...
template <> struct QVector<DT_U8>  { using VType = uint8x16_t;  };
template <> struct QVector<DT_S8>  { using VType = int8x16_t;   };
template <> struct QVector<DT_U16> { using VType = uint16x8_t;  };
template <> struct QVector<DT_S16> { using VType = int16x8_t;   };
template <> struct QVector<DT_U32> { using VType = uint32x4_t;  };
template <> struct QVector<DT_S32> { using VType = int32x4_t;   };
template <> struct QVector<DT_U64> { using VType = uint64x2_t;  };
template <> struct QVector<DT_S64> { using VType = int64x2_t;   };
template <> struct QVector<DT_F32> { using VType = float32x4_t; };
#if defined(__aarch64__)
template <> struct QVector<DT_F64> { using VType = float64x2_t; };
#endif // __aarch64__
#if defined(AURA_ENABLE_NEON_FP16)
...
template <> struct MDVector<DT_U8, 1>  { using MVType = uint8x8x1_t;   };
template <> struct MDVector<DT_U8, 2>  { using MVType = uint8x8x2_t;   };
template <> struct MDVector<DT_U8, 3>  { using MVType = uint8x8x3_t;   };
template <> struct MDVector<DT_U8, 4>  { using MVType = uint8x8x4_t;   };
template <> struct MDVector<DT_S8, 1>  { using MVType = int8x8x1_t;    };
template <> struct MDVector<DT_S8, 2>  { using MVType = int8x8x2_t;    };
template <> struct MDVector<DT_S8, 3>  { using MVType = int8x8x3_t;    };
template <> struct MDVector<DT_S8, 4>  { using MVType = int8x8x4_t;    };
template <> struct MDVector<DT_U16, 1> { using MVType = uint16x4x1_t;  };
template <> struct MDVector<DT_U16, 2> { using MVType = uint16x4x2_t;  };
template <> struct MDVector<DT_U16, 3> { using MVType = uint16x4x3_t;  };
template <> struct MDVector<DT_U16, 4> { using MVType = uint16x4x4_t;  };
template <> struct MDVector<DT_S16, 1> { using MVType = int16x4x1_t;   };
template <> struct MDVector<DT_S16, 2> { using MVType = int16x4x2_t;   };
template <> struct MDVector<DT_S16, 3> { using MVType = int16x4x3_t;   };
template <> struct MDVector<DT_S16, 4> { using MVType = int16x4x4_t;   };
template <> struct MDVector<DT_U32, 1> { using MVType = uint32x2x1_t;  };
template <> struct MDVector<DT_U32, 2> { using MVType = uint32x2x2_t;  };
template <> struct MDVector<DT_U32, 3> { using MVType = uint32x2x3_t;  };
template <> struct MDVector<DT_U32, 4> { using MVType = uint32x2x4_t;  };
template <> struct MDVector<DT_S32, 1> { using MVType = int32x2x1_t;   };
template <> struct MDVector<DT_S32, 2> { using MVType = int32x2x2_t;   };
template <> struct MDVector<DT_S32, 3> { using MVType = int32x2x3_t;   };
template <> struct MDVector<DT_S32, 4> { using MVType = int32x2x4_t;   };
template <> struct MDVector<DT_U64, 1> { using MVType = uint64x1x1_t;  };
template <> struct MDVector<DT_U64, 2> { using MVType = uint64x1x2_t;  };
template <> struct MDVector<DT_U64, 3> { using MVType = uint64x1x3_t;  };
template <> struct MDVector<DT_U64, 4> { using MVType = uint64x1x4_t;  };
template <> struct MDVector<DT_S64, 1> { using MVType = int64x1x1_t;   };
template <> struct MDVector<DT_S64, 2> { using MVType = int64x1x2_t;   };
template <> struct MDVector<DT_S64, 3> { using MVType = int64x1x3_t;   };
template <> struct MDVector<DT_S64, 4> { using MVType = int64x1x4_t;   };
template <> struct MDVector<DT_F32, 1> { using MVType = float32x2x1_t; };
template <> struct MDVector<DT_F32, 2> { using MVType = float32x2x2_t; };
template <> struct MDVector<DT_F32, 3> { using MVType = float32x2x3_t; };
template <> struct MDVector<DT_F32, 4> { using MVType = float32x2x4_t; };
#if defined(__aarch64__)
template <> struct MDVector<DT_F64, 1> { using MVType = float64x1x1_t; };
template <> struct MDVector<DT_F64, 2> { using MVType = float64x1x2_t; };
template <> struct MDVector<DT_F64, 3> { using MVType = float64x1x3_t; };
template <> struct MDVector<DT_F64, 4> { using MVType = float64x1x4_t; };
#endif // __aarch64__
#if defined(AURA_ENABLE_NEON_FP16)
...
template <> struct MQVector<DT_U8, 1>  { using MVType = uint8x16x1_t;  };
template <> struct MQVector<DT_U8, 2>  { using MVType = uint8x16x2_t;  };
template <> struct MQVector<DT_U8, 3>  { using MVType = uint8x16x3_t;  };
template <> struct MQVector<DT_U8, 4>  { using MVType = uint8x16x4_t;  };
template <> struct MQVector<DT_S8, 1>  { using MVType = int8x16x1_t;   };
template <> struct MQVector<DT_S8, 2>  { using MVType = int8x16x2_t;   };
template <> struct MQVector<DT_S8, 3>  { using MVType = int8x16x3_t;   };
template <> struct MQVector<DT_S8, 4>  { using MVType = int8x16x4_t;   };
template <> struct MQVector<DT_U16, 1> { using MVType = uint16x8x1_t;  };
template <> struct MQVector<DT_U16, 2> { using MVType = uint16x8x2_t;  };
template <> struct MQVector<DT_U16, 3> { using MVType = uint16x8x3_t;  };
template <> struct MQVector<DT_U16, 4> { using MVType = uint16x8x4_t;  };
template <> struct MQVector<DT_S16, 1> { using MVType = int16x8x1_t;   };
template <> struct MQVector<DT_S16, 2> { using MVType = int16x8x2_t;   };
template <> struct MQVector<DT_S16, 3> { using MVType = int16x8x3_t;   };
template <> struct MQVector<DT_S16, 4> { using MVType = int16x8x4_t;   };
template <> struct MQVector<DT_U32, 1> { using MVType = uint32x4x1_t;  };
template <> struct MQVector<DT_U32, 2> { using MVType = uint32x4x2_t;  };
template <> struct MQVector<DT_U32, 3> { using MVType = uint32x4x3_t;  };
template <> struct MQVector<DT_U32, 4> { using MVType = uint32x4x4_t;  };
template <> struct MQVector<DT_S32, 1> { using MVType = int32x4x1_t;   };
template <> struct MQVector<DT_S32, 2> { using MVType = int32x4x2_t;   };
template <> struct MQVector<DT_S32, 3> { using MVType = int32x4x3_t;   };
template <> struct MQVector<DT_S32, 4> { using MVType = int32x4x4_t;   };
template <> struct MQVector<DT_U64, 1> { using MVType = uint64x2x1_t;  };
template <> struct MQVector<DT_U64, 2> { using MVType = uint64x2x2_t;  };
template <> struct MQVector<DT_U64, 3> { using MVType = uint64x2x3_t;  };
template <> struct MQVector<DT_U64, 4> { using MVType = uint64x2x4_t;  };
template <> struct MQVector<DT_S64, 1> { using MVType = int64x2x1_t;   };
template <> struct MQVector<DT_S64, 2> { using MVType = int64x2x2_t;   };
template <> struct MQVector<DT_S64, 3> { using MVType = int64x2x3_t;   };
template <> struct MQVector<DT_S64, 4> { using MVType = int64x2x4_t;   };
template <> struct MQVector<DT_F32, 1> { using MVType = float32x4x1_t; };
template <> struct MQVector<DT_F32, 2> { using MVType = float32x4x2_t; };
template <> struct MQVector<DT_F32, 3> { using MVType = float32x4x3_t; };
template <> struct MQVector<DT_F32, 4> { using MVType = float32x4x4_t; };
#if defined(__aarch64__)
template <> struct MQVector<DT_F64, 1> { using MVType = float64x2x1_t; };
template <> struct MQVector<DT_F64, 2> { using MVType = float64x2x2_t; };
template <> struct MQVector<DT_F64, 3> { using MVType = float64x2x3_t; };
template <> struct MQVector<DT_F64, 4> { using MVType = float64x2x4_t; };
#endif // __aarch64__
#if defined(AURA_ENABLE_NEON_FP16)
