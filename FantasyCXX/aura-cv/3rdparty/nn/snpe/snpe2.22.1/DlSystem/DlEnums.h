...
/**
 * Enumeration that lists the supported iaura encoding formats.
 */
typedef enum
{
  /// For unknown iaura type. Also used as a default value for IauraEncoding_t.
  SNPE_IAURA_ENCODING_UNKNOWN = 0,
