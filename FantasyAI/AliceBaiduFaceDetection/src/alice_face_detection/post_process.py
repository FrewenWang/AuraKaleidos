...
from .bbox_utils import nonempty_bbox, rbox2poly
from . import ops
try:
...
class BBoxPostProcess(object):
    ...
    def __call__(self, head_out, rois, im_shape, scale_factor):
        ...
        if bbox_pred.shape[0] == 0:
            ...
            bbox_pred = paddle.to_tensor(np.repeat(sentinel, batch_size, axis=0))
            bbox_num = paddle.ones([batch_size], dtype='int32')
