...
const static char *TAG = "TestOpenCLCreateCommandQueue";


class TestOpenCLCreateCommandQueue : public testing::Test {
public:
...
TEST_F(TestOpenCLCreateCommandQueue, TestGetPlatform) {
...
TEST_F(TestOpenCLCreateCommandQueue, TestGetPlatformInfo) {
...
TEST_F(TestOpenCLCreateCommandQueue, TestGetDevice) {
