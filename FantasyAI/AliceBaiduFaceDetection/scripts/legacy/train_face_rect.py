...
if __name__ == "__main__":
    ...
    if use_cloud:
        ...
        pretrain_weight = ""
        # 使用剪枝文件
        path_prune_pickle = "/home/baiduiov/03.ProgramSpace/20.AI/01.WorkSpace/AliceAILearning/AliceBaiduFaceDetection/assets/dan_2d4f_prune.pickle"
