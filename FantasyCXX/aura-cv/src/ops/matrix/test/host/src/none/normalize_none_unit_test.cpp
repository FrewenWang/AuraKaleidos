...
static NormalizeParam::TupleTable g_normalize_table_none
{
    // element type
    {
...
NEW_TESTCASE(matrix, Normalize, none)
{
    MatrixNormalizeTest matrix_normalize_test(UnitTest::GetInstance()->GetContext(), g_normalize_table_none);
