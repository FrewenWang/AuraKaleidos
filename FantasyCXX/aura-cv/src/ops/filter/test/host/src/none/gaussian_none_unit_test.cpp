...
static GaussianParam::TupleTable g_gaussian_table_none {
    //elem type
    {
        ElemType::U8,
        ElemType::S16,
...
NEW_TESTCASE(filter, Gaussian, none)
{
    GaussianTest test(UnitTest::GetInstance()->GetContext(), g_gaussian_table_none);
