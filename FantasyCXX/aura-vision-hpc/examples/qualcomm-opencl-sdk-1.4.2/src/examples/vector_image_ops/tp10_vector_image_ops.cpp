...
// Desc: Demonstrates use of vector image ops for tp10 using Qualcomm extensions to OpenCL. These
...
int main(int argc, char** argv)
{
    ...
    cl_mem_dmabuf_host_ptr out_tp10_mem = wrapper.make_buffer_for_yuv_image(out_tp10_format, out_tp10_desc);
    ...
    for (size_t i = 0; i < kernel_execution_params.size(); ++i)
    {
        ...
        if (ioctl(out_tp10_mem.dmabuf_filedesc, DMA_BUF_IOCTL_SYNC, &buf_sync))
        {
