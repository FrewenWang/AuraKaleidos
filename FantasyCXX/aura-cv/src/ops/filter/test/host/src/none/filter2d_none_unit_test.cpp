...
static Filter2dParam::TupleTable g_filter2d_table_none {
    {
...
NEW_TESTCASE(filter, Filter2d, none)
{
    Filter2dTest test(UnitTest::GetInstance()->GetContext(), g_filter2d_table_none);
