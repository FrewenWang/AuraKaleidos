...
kernel void LaplacianRemain5x5C1(global St *src, int istep,
                                 ...
                                 int main_width, struct Scalar border_value)
{
    ...
    InterType   it_sum_pn1, it_sum_pn0, it_sum_c;
    InterType   it_result;
    Dt          dt_result;
    ...
    it_sum_pn1 = (v8it_sum_pn1.s0 + v8it_sum_pn1.s4) * (InterType)2 +
                 (v8it_sum_pn1.s1 + v8it_sum_pn1.s3) * (InterType)4 +
                 (v8it_sum_pn1.s2 * (InterType)4);
    it_sum_pn0 = (v8it_sum_pn0.s0 + v8it_sum_pn0.s4) * (InterType)4 +
                 (v8it_sum_pn0.s2 * (InterType)-8);
    it_sum_c   = (v8it_src_c.s0 + v8it_src_c.s4) * (InterType)4 +
                 (v8it_src_c.s1 + v8it_src_c.s3) * (InterType)-8 +
                 (v8it_src_c.s2 * (InterType)-24);

    it_result = it_sum_pn1 + it_sum_pn0 + it_sum_c;
