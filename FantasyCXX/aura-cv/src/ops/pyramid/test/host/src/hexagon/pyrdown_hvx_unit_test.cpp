...
static PyrDownParam::TupleTable g_pyrdown_table_hvx
{
    //elem type
    {
        ElemType::U8,
...
NEW_TESTCASE(pyramid, PyrDown, hvx)
{
    ...
    PyrDownTest test(UnitTest::GetInstance()->GetContext(), g_pyrdown_table_hvx);
