...
def predict_image_onnx(ort_sess):
    ...
    image = cv2.imread("demo_phone.jpg")
    img_w = image.shape[1]
    img_h = image.shape[0]
    ...
    # image.tofile("demo_1x3x160x320.raw")
    # image = np.fromfile("demo_1x3x160x320.raw", dtype=np.float32)
...
if __name__ == "__main__":
    onnx_file = "HandPhoneDetection0419V15Main_quant.onnx"
