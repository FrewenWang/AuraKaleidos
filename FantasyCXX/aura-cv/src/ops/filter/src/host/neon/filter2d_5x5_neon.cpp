...
AURA_ALWAYS_INLINE DT_VOID Filter2d5x5Prepare(MVqType *mvq_src_p1, MVqType *mvq_src_p0, MVqType *mvq_src_c, MVqType *mvq_src_n0, MVqType *mvq_src_n1)
{
...
template <typename MVqType>
AURA_ALWAYS_INLINE DT_VOID Filter2d5x5Prepare(MVqType *mvq_src_p1, MVqType *mvq_src_p0, MVqType *mvq_src_c0, MVqType *mvq_src_c1, MVqType *mvq_src_n0, MVqType *mvq_src_n1)
{
    mvq_src_p1[0] = mvq_src_p1[1];
    mvq_src_p0[0] = mvq_src_p0[1];
...
AURA_ALWAYS_INLINE DT_VOID Filter2d5x5Core(uint8x16_t &vqu8_src_x0, uint8x16_t &vqu8_src_x1, uint8x16_t &vqu8_src_x2,
...
AURA_ALWAYS_INLINE DT_VOID Filter2d5x5Core(d16x8_t &vq16_src_x0, d16x8_t &vq16_src_x1, d16x8_t &vq16_src_x2,
...
AURA_ALWAYS_INLINE DT_VOID Filter2d5x5Core(float32x4_t &vqf32_src_x0, float32x4_t &vqf32_src_x1, float32x4_t &vqf32_src_x2,
...
AURA_ALWAYS_INLINE DT_VOID Filter2d5x5Core(float16x8_t &vqf16_src_x0, float16x8_t &vqf16_src_x1, float16x8_t &vqf16_src_x2,
                                           float32x4_t &vqf32_result_lo, float32x4_t &vqf32_result_hi,
                                           const std::vector<DT_F32> &kernel, DT_S32 line)
{
    const DT_S32 idx = 5 * line;
...
AURA_ALWAYS_INLINE DT_VOID Filter2d5x5OneRow(const Tp *src_p1, const Tp *src_p0, const Tp *src_c, const Tp *src_n0, const Tp *src_n1,
                                             Tp *dst, DT_S32 width, const std::vector<DT_F32> &kdata, const std::vector<Tp> &border_value)
{
...
template <typename Tp, BorderType BORDER_TYPE, DT_S32 C>
AURA_ALWAYS_INLINE DT_VOID Filter2d5x5TwoRow(const Tp *src_p1, const Tp *src_p0, const Tp *src_c0, const Tp *src_c1, const Tp *src_n0, const Tp *src_n1,
                                             Tp *dst_c0, Tp *dst_c1, DT_S32 width, const std::vector<DT_F32> &kdata, const std::vector<Tp> &border_value)
{
    using MVqType = typename neon::MQVector<Tp, C>::MVType;
...
template <typename Tp, BorderType BORDER_TYPE, DT_S32 C>
static Status Filter2d5x5NeonImpl(const Mat &src, Mat &dst, const std::vector<DT_F32> &kdata,
...
static Status Filter2d5x5NeonHelper(Context *ctx, const Mat &src, Mat &dst, const std::vector<DT_F32> &kdata,
                       ...
                       BorderType border_type, const Scalar &border_value, const OpTarget &target)
{
    ...
    switch (pattern)
    {
        ...
        {
            ret = Filter2d5x5NeonHelper<DT_U8>(ctx, src, dst, kdata, border_type, border_value, target);
            break;
        }

        case AURA_MAKE_PATTERN(ElemType::U16, ElemType::U16):
        {
            ret = Filter2d5x5NeonHelper<DT_U16>(ctx, src, dst, kdata, border_type, border_value, target);
            break;
        }

        case AURA_MAKE_PATTERN(ElemType::S16, ElemType::S16):
        {
            ret = Filter2d5x5NeonHelper<DT_S16>(ctx, src, dst, kdata, border_type, border_value, target);
            break;
        }
        ...
        {
            ret = Filter2d5x5NeonHelper<DT_F32>(ctx, src, dst, kdata, border_type, border_value, target);
            break;
        }
