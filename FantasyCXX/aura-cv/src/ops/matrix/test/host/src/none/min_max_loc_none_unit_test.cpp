...
static MinMaxLocParam::TupleTable g_min_max_loc_table_none
{
    // element type
    {
...
NEW_TESTCASE(matrix, MinMaxLoc, none)
{
    MinMaxLocTest test(UnitTest::GetInstance()->GetContext(), g_min_max_loc_table_none);
