...
static Status NormalizeMinMaxNeon(Context *ctx, const Mat &src, Mat &dst, MI_F32 alpha, MI_F32 beta, const OpTarget &target)
{
...
static Status NormalizeNormNeon(Context *ctx, const Mat &src, Mat &dst, MI_F32 alpha, NormType type, const OpTarget &target)
{
...
Status NormalizeNeon::SetArgs(const Array *src, Array *dst, MI_F32 alpha, MI_F32 beta, NormType type)
{
