...
static GuideFilterParam::TupleTable g_guidefilter_table_neon {
    //elem type
    {
        ElemType::U8,
        ElemType::S8,
...
NEW_TESTCASE(filter, GuideFilter, neon)
{
    GuideFilterTest test(UnitTest::GetInstance()->GetContext(), g_guidefilter_table_neon);
