"""
File: yolo_head_one.py
Brief: head, 从fpn输出中取出最大分辨率fm用于检测 
Author: baidu(baidu@baidu.com)
Date: 2021/04/22 14:47:30
Last modified: 2021/05/22 14:47:30
"""
...
class YOLOv3HeadOne(nn.Layer):
    ...
    def __init__(self,
        ...
        """
        super(YOLOv3HeadOne, self).__init__()
        ...
        for i in range(len(self.anchors)):
            ...
            #print("in_channels is {}; i is {}\t{}".format(self.in_channels[i], i, num_filters))
            conv = nn.Conv2D(
    ...
    def forward(self, feats, targets=None):
        ...
        for i, feat in enumerate(feats):
            #print("{} feat shape is {}".format(i, feat.shape))
            if i != 2:
                continue
            #print("feat shape = {}".format(feat.shape))
            yolo_output = self.yolo_outputs[i - 2](feat)
