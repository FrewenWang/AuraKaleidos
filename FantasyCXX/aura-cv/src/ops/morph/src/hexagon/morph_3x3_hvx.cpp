...
AURA_ALWAYS_INLINE AURA_VOID Morph3x3VCore(HVX_Vector &v_src_p0, HVX_Vector &v_src_n0, HVX_Vector &v_result)
{
    MorphHvxMinMax<Tp, MORPH_TYPE>(v_src_p0, v_src_n0, v_result);
}

template <typename Tp, MorphType MORPH_TYPE>
AURA_ALWAYS_INLINE AURA_VOID Morph3x3VCore(HVX_Vector &v_src_p0, HVX_Vector &v_src_c, HVX_Vector &v_src_n0, HVX_Vector &v_result)
{
    MorphHvxMinMax<Tp, MORPH_TYPE>(v_src_p0, v_src_c, v_src_n0, v_result);
}

template <typename Tp, MorphType MORPH_TYPE>
AURA_ALWAYS_INLINE AURA_VOID Morph3x3HCore(HVX_Vector &v_vertical_px1, HVX_Vector &v_vertical_cx0, HVX_Vector &v_vertical_cx1,
...
template <typename Tp, MorphType MORPH_TYPE>
AURA_ALWAYS_INLINE AURA_VOID Morph3x3HCore(HVX_Vector &v_vertical_cx0, HVX_Vector &v_vertical_cx1, HVX_Vector &v_vertical_cx2, HVX_Vector &v_result)
{
    MI_S32 align_size = sizeof(Tp);
...
template <typename Tp, MorphType MORPH_TYPE>
AURA_ALWAYS_INLINE AURA_VOID Morph3x3HCore(HVX_Vector &v_vertical_px1, HVX_Vector &v_vertical_px2, HVX_Vector &v_vertical_cx0, HVX_Vector &v_vertical_cx1,
...
template <typename Tp, MorphType MORPH_TYPE>
AURA_ALWAYS_INLINE AURA_VOID Morph3x3HCore(HVX_Vector &v_vertical_cx0, HVX_Vector &v_vertical_cx1, HVX_Vector &v_vertical_cx2, HVX_Vector &v_vertical_cx3,
...
AURA_VOID Morph3x3Row(const Tp *src_p0, const Tp *src_c, const Tp *src_n0, Tp *dst, MI_S32 width)
{
...
template <typename Tp, MorphShape MORPH_SHAPE, MorphType MORPH_TYPE, MI_S32 C,
          typename std::enable_if<(MORPH_SHAPE == MorphShape::CROSS) || (MORPH_SHAPE == MorphShape::ELLIPSE)>::type* = MI_NULL>
AURA_VOID Morph3x3Row(const Tp *src_p0, const Tp *src_c, const Tp *src_n0, Tp *dst, MI_S32 width)
{
    using MVType = typename MVHvxVector<C>::Type;
...
template <typename Tp, MorphShape MORPH_SHAPE, MorphType MORPH_TYPE, MI_S32 C>
static Status Morph3x3HvxImpl(const Mat &src, Mat &dst, MI_S32 start_row, MI_S32 end_row)
{
    ...
    for (MI_S32 y = start_row; y < end_row; y++)
    {
        ...
        src_p0 = src_c;
        src_c  = src_n0;
        src_n0 = src.Ptr<Tp, BorderType::REPLICATE>(y + 2, MI_NULL);
    }
...
static Status Morph3x3HvxHelper(Context *ctx, const Mat &src, Mat &dst)
{
    ...
    switch (channel)
    {
        case 1:
        {
            ret = wp->ParallelFor((MI_S32)0, height, Morph3x3HvxImpl<Tp, MORPH_SHAPE, MORPH_TYPE, 1>, std::cref(src), std::ref(dst));
            break;
        }

        case 2:
        {
            ret = wp->ParallelFor((MI_S32)0, height, Morph3x3HvxImpl<Tp, MORPH_SHAPE, MORPH_TYPE, 2>, std::cref(src), std::ref(dst));
            break;
        }

        case 3:
        {
            ret = wp->ParallelFor((MI_S32)0, height, Morph3x3HvxImpl<Tp, MORPH_SHAPE, MORPH_TYPE, 3>, std::cref(src), std::ref(dst));
            break;
        }
...
Status Morph3x3Hvx(Context *ctx, const Mat &src, Mat &dst, MorphType type, MorphShape shape)
{
    ...
    switch (src.GetElemType())
    {
        case ElemType::U8:
        {
            ret = Morph3x3HvxHelper<MI_U8>(ctx, src, dst, type, shape);
            break;
        }

        case ElemType::U16:
        {
            ret = Morph3x3HvxHelper<MI_U16>(ctx, src, dst, type, shape);
            break;
        }

        case ElemType::S16:
        {
            ret = Morph3x3HvxHelper<MI_S16>(ctx, src, dst, type, shape);
            break;
        }
