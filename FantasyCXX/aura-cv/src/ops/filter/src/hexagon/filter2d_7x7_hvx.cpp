...
AURA_ALWAYS_INLINE DT_VOID Filter2d7x7Prepare(MVType *mv_src_p2, MVType *mv_src_p1, MVType *mv_src_p0, MVType *mv_src_c, MVType *mv_src_n0, MVType *mv_src_n1, MVType *mv_src_n2)
{
...
AURA_ALWAYS_INLINE DT_VOID Filter2d7x7Core(HVX_Vector &vu8_src_x0, HVX_Vector &vu8_src_x1, HVX_Vector &vu8_src_x2,
                                           ...
                                           const DT_S16 *kernel, DT_S32 line)
{
    ...
    DT_U32 k3k3 = (kernel[idx + 3] << 16) | kernel[idx + 3];
    DT_U32 k4k4 = (kernel[idx + 4] << 16) | kernel[idx + 4];
    DT_U32 k5k5 = (kernel[idx + 5] << 16) | kernel[idx + 5];
    DT_U32 k6k6 = (kernel[idx + 6] << 16) | kernel[idx + 6];

    HVX_VectorPair wu16_src_l2 = Q6_Wuh_vzxt_Vub(Q6_V_vlalign_VVR(vu8_src_x1, vu8_src_x0, 3));
    ...
    HVX_VectorPair wu16_src_r2 = Q6_Wuh_vzxt_Vub(Q6_V_valign_VVR(vu8_src_x2, vu8_src_x1, 3));

    wu32_sum_lo = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum_lo, Q6_V_lo_W(wu16_src_l2), k0k0);
    wu32_sum_hi = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum_hi, Q6_V_hi_W(wu16_src_l2), k0k0);
    wu32_sum_lo = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum_lo, Q6_V_lo_W(wu16_src_l1), k1k1);
    wu32_sum_hi = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum_hi, Q6_V_hi_W(wu16_src_l1), k1k1);
    wu32_sum_lo = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum_lo, Q6_V_lo_W(wu16_src_l0), k2k2);
    wu32_sum_hi = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum_hi, Q6_V_hi_W(wu16_src_l0), k2k2);
    wu32_sum_lo = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum_lo, Q6_V_lo_W(wu16_src_c),  k3k3);
    wu32_sum_hi = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum_hi, Q6_V_hi_W(wu16_src_c),  k3k3);
    wu32_sum_lo = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum_lo, Q6_V_lo_W(wu16_src_r0), k4k4);
    wu32_sum_hi = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum_hi, Q6_V_hi_W(wu16_src_r0), k4k4);
    wu32_sum_lo = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum_lo, Q6_V_lo_W(wu16_src_r1), k5k5);
    wu32_sum_hi = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum_hi, Q6_V_hi_W(wu16_src_r1), k5k5);
    wu32_sum_lo = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum_lo, Q6_V_lo_W(wu16_src_r2), k6k6);
    wu32_sum_hi = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum_hi, Q6_V_hi_W(wu16_src_r2), k6k6);
}

// using Tp = DT_U8
template <typename Tp, typename std::enable_if<std::is_same<Tp, DT_U8>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE HVX_Vector Filter2d7x7Vector(HVX_Vector &vu8_src_p2x0, HVX_Vector &vu8_src_p2x1, HVX_Vector &vu8_src_p2x2,
                                                HVX_Vector &vu8_src_p1x0, HVX_Vector &vu8_src_p1x1, HVX_Vector &vu8_src_p1x2,
                                                ...
                                                HVX_Vector &vu8_src_n2x0, HVX_Vector &vu8_src_n2x1, HVX_Vector &vu8_src_n2x2,
                                                const DT_S16 *kernel)
{
    HVX_VectorPair wu32_sum_lo = Q6_W_vcombine_VV(Q6_V_vzero(), Q6_V_vzero());
    HVX_VectorPair wu32_sum_hi = wu32_sum_lo;

    Filter2d7x7Core<Tp>(vu8_src_p2x0, vu8_src_p2x1, vu8_src_p2x2, wu32_sum_lo, wu32_sum_hi, kernel, 0);
    Filter2d7x7Core<Tp>(vu8_src_p1x0, vu8_src_p1x1, vu8_src_p1x2, wu32_sum_lo, wu32_sum_hi, kernel, 1);
    Filter2d7x7Core<Tp>(vu8_src_p0x0, vu8_src_p0x1, vu8_src_p0x2, wu32_sum_lo, wu32_sum_hi, kernel, 2);
    Filter2d7x7Core<Tp>(vu8_src_cx0,  vu8_src_cx1,  vu8_src_cx2,  wu32_sum_lo, wu32_sum_hi, kernel, 3);
    Filter2d7x7Core<Tp>(vu8_src_n0x0, vu8_src_n0x1, vu8_src_n0x2, wu32_sum_lo, wu32_sum_hi, kernel, 4);
    Filter2d7x7Core<Tp>(vu8_src_n1x0, vu8_src_n1x1, vu8_src_n1x2, wu32_sum_lo, wu32_sum_hi, kernel, 5);
    Filter2d7x7Core<Tp>(vu8_src_n2x0, vu8_src_n2x1, vu8_src_n2x2, wu32_sum_lo, wu32_sum_hi, kernel, 6);
...
AURA_ALWAYS_INLINE DT_VOID Filter2d7x7Core(HVX_Vector &vu16_src_x0, HVX_Vector &vu16_src_x1, HVX_Vector &vu16_src_x2,
                                           HVX_VectorPair &wu32_sum, const DT_S16 *kernel, DT_S32 line)
{
    ...
    HVX_Vector vu16_src_l2 = Q6_V_vlalign_VVR(vu16_src_x1, vu16_src_x0, 6);
    ...
    HVX_Vector vu16_src_r2 = Q6_V_valign_VVR(vu16_src_x2, vu16_src_x1, 6);

    wu32_sum = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum, vu16_src_l2, k0k0);
    wu32_sum = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum, vu16_src_l1, k1k1);
    wu32_sum = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum, vu16_src_l0, k2k2);
    wu32_sum = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum, vu16_src_x1, k3k3);
    wu32_sum = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum, vu16_src_r0, k4k4);
    wu32_sum = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum, vu16_src_r1, k5k5);
    wu32_sum = Q6_Wuw_vmpyacc_WuwVuhRuh(wu32_sum, vu16_src_r2, k6k6);
}

// using Tp = DT_U16
template <typename Tp, typename std::enable_if<std::is_same<Tp, DT_U16>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE HVX_Vector Filter2d7x7Vector(HVX_Vector &vu16_src_p2x0, HVX_Vector &vu16_src_p2x1, HVX_Vector &vu16_src_p2x2,
                                                HVX_Vector &vu16_src_p1x0, HVX_Vector &vu16_src_p1x1, HVX_Vector &vu16_src_p1x2,
                                                ...
                                                HVX_Vector &vu16_src_n2x0, HVX_Vector &vu16_src_n2x1, HVX_Vector &vu16_src_n2x2,
                                                const DT_S16 *kernel)
{
    HVX_VectorPair wu32_sum = Q6_W_vcombine_VV(Q6_V_vzero(), Q6_V_vzero());

    Filter2d7x7Core<Tp>(vu16_src_p2x0, vu16_src_p2x1, vu16_src_p2x2, wu32_sum, kernel, 0);
    Filter2d7x7Core<Tp>(vu16_src_p1x0, vu16_src_p1x1, vu16_src_p1x2, wu32_sum, kernel, 1);
    Filter2d7x7Core<Tp>(vu16_src_p0x0, vu16_src_p0x1, vu16_src_p0x2, wu32_sum, kernel, 2);
    Filter2d7x7Core<Tp>(vu16_src_cx0,  vu16_src_cx1,  vu16_src_cx2,  wu32_sum, kernel, 3);
    Filter2d7x7Core<Tp>(vu16_src_n0x0, vu16_src_n0x1, vu16_src_n0x2, wu32_sum, kernel, 4);
    Filter2d7x7Core<Tp>(vu16_src_n1x0, vu16_src_n1x1, vu16_src_n1x2, wu32_sum, kernel, 5);
    Filter2d7x7Core<Tp>(vu16_src_n2x0, vu16_src_n2x1, vu16_src_n2x2, wu32_sum, kernel, 6);
...
AURA_ALWAYS_INLINE DT_VOID Filter2d7x7Core(HVX_Vector &vs16_src_x0, HVX_Vector &vs16_src_x1, HVX_Vector &vs16_src_x2,
                                           HVX_VectorPair &ws32_sum, const DT_S16 *kernel, DT_S32 line)
{
    ...
    HVX_Vector vs16_src_l2 = Q6_V_vlalign_VVR(vs16_src_x1, vs16_src_x0, 6);
    ...
    HVX_Vector vs16_src_r2 = Q6_V_valign_VVR(vs16_src_x2, vs16_src_x1, 6);

    ws32_sum = Q6_Ww_vmpyacc_WwVhRh(ws32_sum, vs16_src_l2, k0k0);
    ws32_sum = Q6_Ww_vmpyacc_WwVhRh(ws32_sum, vs16_src_l1, k1k1);
    ws32_sum = Q6_Ww_vmpyacc_WwVhRh(ws32_sum, vs16_src_l0, k2k2);
    ws32_sum = Q6_Ww_vmpyacc_WwVhRh(ws32_sum, vs16_src_x1, k3k3);
    ws32_sum = Q6_Ww_vmpyacc_WwVhRh(ws32_sum, vs16_src_r0, k4k4);
    ws32_sum = Q6_Ww_vmpyacc_WwVhRh(ws32_sum, vs16_src_r1, k5k5);
    ws32_sum = Q6_Ww_vmpyacc_WwVhRh(ws32_sum, vs16_src_r2, k6k6);
}

// using Tp = DT_S16
template <typename Tp, typename std::enable_if<std::is_same<Tp, DT_S16>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE HVX_Vector Filter2d7x7Vector(HVX_Vector &vs16_src_p2x0, HVX_Vector &vs16_src_p2x1, HVX_Vector &vs16_src_p2x2,
                                                HVX_Vector &vs16_src_p1x0, HVX_Vector &vs16_src_p1x1, HVX_Vector &vs16_src_p1x2,
                                                ...
                                                HVX_Vector &vs16_src_n2x0, HVX_Vector &vs16_src_n2x1, HVX_Vector &vs16_src_n2x2,
                                                const DT_S16 *kernel)
{
    HVX_VectorPair ws32_sum = Q6_W_vcombine_VV(Q6_V_vzero(), Q6_V_vzero());

    Filter2d7x7Core<Tp>(vs16_src_p2x0, vs16_src_p2x1, vs16_src_p2x2, ws32_sum, kernel, 0);
    Filter2d7x7Core<Tp>(vs16_src_p1x0, vs16_src_p1x1, vs16_src_p1x2, ws32_sum, kernel, 1);
    Filter2d7x7Core<Tp>(vs16_src_p0x0, vs16_src_p0x1, vs16_src_p0x2, ws32_sum, kernel, 2);
    Filter2d7x7Core<Tp>(vs16_src_cx0,  vs16_src_cx1,  vs16_src_cx2,  ws32_sum, kernel, 3);
    Filter2d7x7Core<Tp>(vs16_src_n0x0, vs16_src_n0x1, vs16_src_n0x2, ws32_sum, kernel, 4);
    Filter2d7x7Core<Tp>(vs16_src_n1x0, vs16_src_n1x1, vs16_src_n1x2, ws32_sum, kernel, 5);
    Filter2d7x7Core<Tp>(vs16_src_n2x0, vs16_src_n2x1, vs16_src_n2x2, ws32_sum, kernel, 6);

    return Q6_Vh_vasr_VwVwR_rnd_sat(Q6_V_hi_W(ws32_sum), Q6_V_lo_W(ws32_sum), 12);
}

template <typename Tp>
AURA_ALWAYS_INLINE DT_VOID Filter2d7x7Vector(HVX_Vector &v_src_p2x0, HVX_Vector &v_src_p2x1, HVX_Vector &v_src_p2x2, HVX_Vector &v_border_p2,
                                             HVX_Vector &v_src_p1x0, HVX_Vector &v_src_p1x1, HVX_Vector &v_src_p1x2, HVX_Vector &v_border_p1,
                                             ...
                                             HVX_Vector &v_src_n2x0, HVX_Vector &v_src_n2x1, HVX_Vector &v_src_n2x2, HVX_Vector &v_border_n2,
                                             HVX_Vector &v_result_x0, HVX_Vector &v_result_x1,
                                             const DT_S16 *kernel, DT_S32 align_size)
{
    HVX_Vector v_src_p2r0 = Q6_V_vlalign_VVR(v_border_p2, v_src_p2x2, align_size);
    ...
    HVX_Vector v_src_n2r0 = Q6_V_vlalign_VVR(v_border_n2, v_src_n2x2, align_size);
    v_result_x0 = Filter2d7x7Vector<Tp>(v_src_p2x0, v_src_p2x1, v_src_p2r0,
                                        v_src_p1x0, v_src_p1x1, v_src_p1r0,
                                        ...
                                        v_src_n2x0, v_src_n2x1, v_src_n2r0,
                                        kernel);

    HVX_Vector v_src_p2l0 = Q6_V_valign_VVR(v_src_p2x1, v_src_p2x0, align_size);
    ...
    HVX_Vector v_src_n2l0 = Q6_V_valign_VVR(v_src_n2x1, v_src_n2x0, align_size);
    v_result_x1 = Filter2d7x7Vector<Tp>(v_src_p2l0, v_src_p2x2, v_border_p2,
                                        v_src_p1l0, v_src_p1x2, v_border_p1,
                                        ...
                                        v_src_n2l0, v_src_n2x2, v_border_n2,
                                        kernel);
}

template <typename Tp, BorderType BORDER_TYPE, DT_S32 C>
static DT_VOID Filter2d7x7Row(const Tp *src_p2, const Tp *src_p1, const Tp *src_p0, const Tp *src_c, const Tp *src_n0, const Tp *src_n1,
                              const Tp *src_n2, Tp *dst, DT_S32 width, const DT_S16 *kernel, const std::vector<Tp> &border_value)
{
    ...
    MVType mv_src_p2[3], mv_src_p1[3], mv_src_p0[3], mv_src_c[3], mv_src_n0[3], mv_src_n1[3], mv_src_n2[3];
    MVType mv_result;

    // left border
    {
        vload(src_p2, mv_src_p2[1]);
        vload(src_p1, mv_src_p1[1]);
        vload(src_p0, mv_src_p0[1]);
        vload(src_c,  mv_src_c[1]);
        vload(src_n0, mv_src_n0[1]);
        vload(src_n1, mv_src_n1[1]);
        vload(src_n2, mv_src_n2[1]);

        #pragma unroll(C)
        for (DT_S32 ch = 0; ch < C; ch++)
        {
            mv_src_p2[0].val[ch] = GetBorderVector<Tp, BORDER_TYPE, BorderArea::LEFT>(mv_src_p2[1].val[ch], src_p2[ch], border_value[ch]);
            ...
            mv_src_n2[0].val[ch] = GetBorderVector<Tp, BORDER_TYPE, BorderArea::LEFT>(mv_src_n2[1].val[ch], src_n2[ch], border_value[ch]);
        }
    }
    ...
    // main(0 ~ n-2)
    {
        for (DT_S32 x = ELEM_COUNTS; x <= back_offset; x += ELEM_COUNTS)
        {
            ...
            vload(src_n2 + C * x, mv_src_n2[2]);

            #pragma unroll(C)
            for (DT_S32 ch = 0; ch < C; ch++)
            {
                mv_result.val[ch] = Filter2d7x7Vector<Tp>(mv_src_p2[0].val[ch], mv_src_p2[1].val[ch], mv_src_p2[2].val[ch],
            ...
            Filter2d7x7Prepare(mv_src_p2, mv_src_p1, mv_src_p0, mv_src_c, mv_src_n0, mv_src_n1, mv_src_n2);
        }
    }
    ...
    // remain
    {
        ...
        vload(src_p2 + C * back_offset, mv_src_p2[2]);
        ...
        vload(src_n2 + C * back_offset, mv_src_n2[2]);

        #pragma unroll(C)
        for (DT_S32 ch = 0; ch < C; ch++)
        {
            HVX_Vector v_border_p2 = GetBorderVector<Tp, BORDER_TYPE, BorderArea::RIGHT>(mv_src_p2[2].val[ch], src_p2[ch + last], border_value[ch]);
            ...
            HVX_Vector v_border_n2 = GetBorderVector<Tp, BORDER_TYPE, BorderArea::RIGHT>(mv_src_n2[2].val[ch], src_n2[ch + last], border_value[ch]);

            Filter2d7x7Vector<Tp>(mv_src_p2[0].val[ch], mv_src_p2[1].val[ch], mv_src_p2[2].val[ch], v_border_p2,
                                  mv_src_p1[0].val[ch], mv_src_p1[1].val[ch], mv_src_p1[2].val[ch], v_border_p1,
                                  ...
                                  mv_src_n2[0].val[ch], mv_src_n2[1].val[ch], mv_src_n2[2].val[ch], v_border_n2,
...
template <typename Tp, BorderType BORDER_TYPE, DT_S32 C>
static Status Filter2d7x7HvxImpl(const Mat &src, Mat &dst, const std::vector<DT_S16> &kdata, const std::vector<Tp> &border_value,
                                 const Tp *border_buffer, DT_S32 start_row, DT_S32 end_row)
{
    ...
    for (DT_S32 y = start_row; y < end_row; y++)
    {
        ...
        Filter2d7x7Row<Tp, BORDER_TYPE, C>(src_p2, src_p1, src_p0, src_c, src_n0, src_n1, src_n2, dst_row, width, kernel, border_value);
...
static Status Filter2d7x7HvxHelper(Context *ctx, const Mat &src, Mat &dst, const std::vector<DT_S16> &kdata,
                                   const std::vector<Tp> &border_value, const Tp *border_buffer)
{
    ...
    switch (channel)
    {
        case 1:
        {
            ret = wp->ParallelFor((DT_S32)0, height, Filter2d7x7HvxImpl<Tp, BORDER_TYPE, 1>,
        ...
        case 2:
        {
            ret = wp->ParallelFor((DT_S32)0, height, Filter2d7x7HvxImpl<Tp, BORDER_TYPE, 2>,
                                  std::cref(src), std::ref(dst), std::cref(kdata), std::cref(border_value), border_buffer);
            break;
        }
                                   ...
                                   BorderType &border_type, const Scalar &border_value)
{
    ...
    switch (border_type)
    {
        case BorderType::CONSTANT:
        {
            ...
            ret = Filter2d7x7HvxHelper<Tp, BorderType::CONSTANT>(ctx, src, dst, kdata, vec_border_value, border_buffer);
        ...
        {
            ret = Filter2d7x7HvxHelper<Tp, BorderType::REPLICATE>(ctx, src, dst, kdata, vec_border_value, border_buffer);
            break;
        }

        case BorderType::REFLECT_101:
        {
            ret = Filter2d7x7HvxHelper<Tp, BorderType::REFLECT_101>(ctx, src, dst, kdata, vec_border_value, border_buffer);
            break;
        }
                      ...
                      BorderType border_type, const Scalar &border_value)
{
    ...
    switch (pattern)
    {
        ...
        {
            ret = Filter2d7x7HvxHelper<DT_U8>(ctx, src, dst, kdata, border_type, border_value);
            break;
        }

        case AURA_MAKE_PATTERN(ElemType::U16, ElemType::U16):
        {
            ret = Filter2d7x7HvxHelper<DT_U16>(ctx, src, dst, kdata, border_type, border_value);
            break;
        }

        case AURA_MAKE_PATTERN(ElemType::S16, ElemType::S16):
        {
            ret = Filter2d7x7HvxHelper<DT_S16>(ctx, src, dst, kdata, border_type, border_value);
            break;
        }
