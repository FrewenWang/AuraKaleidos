...
kernel void SobelMain1x1C2(global St *src, int istep,
...
#  if 1 == DX
    v16it_result = ROT_R(v16it_src, 16, 12) - v16it_src;
#  else
    v16it_result = (v16it_src + ROT_R(v16it_src, 16, 12)) - ROT_R(v16it_src, 16, 14) * (V16InterType)2;
#  endif // 1 == DX
#else
...
#  if 1 == DY
    v16it_result = v16it_src_n - v16it_src_p;
#  else
    v16it_result = (v16it_src_p + v16it_src_n) - v16it_src_c * (V16InterType)2;
#  endif // 1 == DY

    v16it_result = ROT_R(v16it_result, 16, 14);
#endif // DX > 0
