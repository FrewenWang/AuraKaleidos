...
DECLFUN(DT_U8,  uint8x8_t,   vsub,  u8)
DECLFUN(DT_U8,  uint8x16_t,  vsubq, u8)
DECLFUN(DT_S8,  int8x8_t,    vsub,  s8)
DECLFUN(DT_S8,  int8x16_t,   vsubq, s8)
DECLFUN(DT_U16, uint16x4_t,  vsub,  u16)
DECLFUN(DT_U16, uint16x8_t,  vsubq, u16)
DECLFUN(DT_S16, int16x4_t,   vsub,  s16)
DECLFUN(DT_S16, int16x8_t,   vsubq, s16)
DECLFUN(DT_U32, uint32x2_t,  vsub,  u32)
DECLFUN(DT_U32, uint32x4_t,  vsubq, u32)
DECLFUN(DT_S32, int32x2_t,   vsub,  s32)
DECLFUN(DT_S32, int32x4_t,   vsubq, s32)
DECLFUN(DT_U64, uint64x1_t,  vsub,  u64)
DECLFUN(DT_U64, uint64x2_t,  vsubq, u64)
DECLFUN(DT_S64, int64x1_t,   vsub,  s64)
DECLFUN(DT_S64, int64x2_t,   vsubq, s64)
DECLFUN(DT_F32, float32x2_t, vsub,  f32)
DECLFUN(DT_F32, float32x4_t, vsubq, f32)
