...
AURA_ALWAYS_INLINE DT_VOID Gaussian9x9VCore(HVX_Vector &vu8_src_p3, HVX_Vector &vu8_src_p2, HVX_Vector &vu8_src_p1,
                                            ...
                                            HVX_VectorPair &wu16_sum, const DT_U16 *kernel)
{
    ...
    DT_U32 k4k4k4k4 = Q6_R_vsplatb_R(kernel[4]);
...
// using Tp = DT_U8
template <typename Tp, typename std::enable_if<std::is_same<Tp, DT_U8>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID Gaussian9x9HCore(HVX_VectorPair &wu16_sum_x0, HVX_VectorPair &wu16_sum_x1, HVX_VectorPair &wu16_sum_x2,
                                            HVX_Vector &vu8_result, const DT_U16 *kernel)
{
    ...
    DT_U32 k2k2k2k2   = Q6_R_vsplatb_R(kernel[2]);
    DT_U32 k3k3k3k3   = Q6_R_vsplatb_R(kernel[3]);
    DT_U32 k4k4       = (kernel[4] << 16) | kernel[4];
...
AURA_ALWAYS_INLINE DT_VOID Gaussian9x9VCore(HVX_Vector &vu16_src_p3, HVX_Vector &vu16_src_p2, HVX_Vector &vu16_src_p1,
...
// using Tp = DT_U16
template <typename Tp, typename std::enable_if<std::is_same<Tp, DT_U16>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID Gaussian9x9HCore(HVX_VectorPair &wu32_sum_x0, HVX_VectorPair &wu32_sum_x1, HVX_VectorPair &wu32_sum_x2,
...
AURA_ALWAYS_INLINE DT_VOID Gaussian9x9VCore(HVX_Vector &vs16_src_p3, HVX_Vector &vs16_src_p2, HVX_Vector &vs16_src_p1,
                                            ...
                                            HVX_VectorPair &ws32_sum, const DT_S32 *kernel)
{
    ...
    DT_S32 k4k4 = (kernel[4] << 16) | kernel[4];
...
// using Tp = DT_S16
template <typename Tp, typename std::enable_if<std::is_same<Tp, DT_S16>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID Gaussian9x9HCore(HVX_VectorPair &ws32_sum_x0, HVX_VectorPair &ws32_sum_x1, HVX_VectorPair &ws32_sum_x2,
...
AURA_ALWAYS_INLINE DT_VOID Gaussian9x9VCore(HVX_Vector &vu32_src_p3, HVX_Vector &vu32_src_p2, HVX_Vector &vu32_src_p1,
...
AURA_ALWAYS_INLINE DT_VOID Gaussian9x9VCore(HVX_Vector &vs32_src_p3, HVX_Vector &vs32_src_p2, HVX_Vector &vs32_src_p1,
...
AURA_ALWAYS_INLINE DT_VOID Gaussian9x9HCore(HVX_VectorPair &wd64_sum_x0, HVX_VectorPair &wd64_sum_x1, HVX_VectorPair &wd64_sum_x2,
...
template <typename Tp, typename Kt, typename std::enable_if<sizeof(Tp) != 4>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID Gaussian9x9HCore(HVX_VectorPair &w_sum_x0, HVX_VectorPair &w_sum_x1, HVX_VectorPair &w_sum_x2, HVX_VectorPair &w_sum_x3,
...
// Tp = DT_U32 DT_S32
template <typename Tp, typename Kt, typename std::enable_if<sizeof(Tp) == 4>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID Gaussian9x9HCore(HVX_VectorPair &wd64_sum_x0, HVX_VectorPair &wd64_sum_x1, HVX_VectorPair &wd64_sum_x2, HVX_VectorPair &wd64_sum_x3,
...
DT_VOID Gaussian9x9Row(const Tp *src_p3, const Tp *src_p2, const Tp *src_p1, const Tp *src_p0, const Tp *src_c,
                       const Tp *src_n0, const Tp *src_n1, const Tp *src_n2, const Tp *src_n3, Tp *dst, DT_S32 width,
                                   ...
                                   const std::vector<Tp> &border_value, const Tp *border_buffer)
{
    ...
    switch (channel)
    {
        case 1:
        {
            ret = wp->ParallelFor((DT_S32)0, height, Gaussian9x9HvxImpl<Tp, BORDER_TYPE, 1>,
        ...
        case 2:
        {
            ret = wp->ParallelFor((DT_S32)0, height, Gaussian9x9HvxImpl<Tp, BORDER_TYPE, 2>,
                                  std::cref(src), std::ref(dst), std::cref(kmat), std::cref(border_value), border_buffer);
            break;
        }
        ...
        case 3:
        {
            ret = wp->ParallelFor((DT_S32)0, height, Gaussian9x9HvxImpl<Tp, BORDER_TYPE, 3>,
                                  std::cref(src), std::ref(dst), std::cref(kmat), std::cref(border_value), border_buffer);
            break;
        }
                      ...
                      BorderType border_type, const Scalar &border_value)
{
    ...
    switch (src.GetElemType())
    {
        case ElemType::U8:
        {
            ret = Gaussian9x9HvxHelper<DT_U8>(ctx, src, dst, kmat, border_type, border_value);
            break;
        }

        case ElemType::U16:
        {
            ret = Gaussian9x9HvxHelper<DT_U16>(ctx, src, dst, kmat, border_type, border_value);
            break;
        }

        case ElemType::S16:
        {
            ret = Gaussian9x9HvxHelper<DT_S16>(ctx, src, dst, kmat, border_type, border_value);
            break;
        }

        case ElemType::U32:
        {
            ret = Gaussian9x9HvxHelper<DT_U32>(ctx, src, dst, kmat, border_type, border_value);
            break;
        }

        case ElemType::S32:
        {
            ret = Gaussian9x9HvxHelper<DT_S32>(ctx, src, dst, kmat, border_type, border_value);
            break;
        }
