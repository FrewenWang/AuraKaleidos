...
from . import mobilenet_2d96
from . import mobilenet_2d4f5904
from . import mobilenet_50M224
from . import mobilenet_c7230302
from . import mobilenet_792bcf52
from . import mobilenet_b0b5e552
from . import x2paddle_code_2d4f5904_prune50
...
class PPYoloTiny(paddle.nn.Layer):
    ...
    def __init__(
        ...
        anchor_masks = DEFAULT_ANCHOR_MASKS if anchor_masks is None else anchor_masks
        ...
        if self.model == "2d96":
            ...
            raise ValueError(f"Unsupported PPYoloTiny model variant: {self.model!r}")
