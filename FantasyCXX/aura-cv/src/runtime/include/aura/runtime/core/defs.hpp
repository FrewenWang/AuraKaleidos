#ifndef AURA_RUNTIME_CORE_DEFS_HPP__
#define AURA_RUNTIME_CORE_DEFS_HPP__

#include "aura/config.h"

#define AURA_TAG    "aura2.0"
...
#if (defined(AURA_BUILD_WIN) || defined(__CYGWIN__))
...
// TODO 非常重点。删除这个类的拷贝构造函数。和赋值运算符
#if !defined(AURA_DISABLE_COPY_AND_ASSIGN)
#  define AURA_DISABLE_COPY_AND_ASSIGN(CLASSNAME)            \
          CLASSNAME(const CLASSNAME &) = delete;             \
          CLASSNAME &operator=(const CLASSNAME &) = delete;  \
          CLASSNAME(CLASSNAME &&) = delete;                  \
          CLASSNAME &operator=(CLASSNAME &&) = delete;
#endif // AURA_DISABLE_COPY_AND_ASSIGN
...
#endif // AURA_RUNTIME_CORE_DEFS_HPP__