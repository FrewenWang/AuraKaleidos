...
static ConvertToParam::TupleTable g_convert_to_table_neon
{
    // src_type
    {
...
NEW_TESTCASE(matrix, ConvertTo, neon)
{
    MatrixConvertToTest matrix_convert_to_test(UnitTest::GetInstance()->GetContext(), g_convert_to_table_neon);
