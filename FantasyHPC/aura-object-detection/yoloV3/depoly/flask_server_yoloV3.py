...
def load_model():
    ...
    # 配置文件和权重文件路径
    # 网络结构的配置文件
    config_path = '/Users/frewen/03.ProgramSpace/01.WorkSpace/AuraKaleidoScope/AuraKaleidoHPC/aura-object-detection/yoloV3/config/yolov3.cfg'
    # 权重的配置文件
    weights_path = '/Users/frewen/03.ProgramSpace/01.WorkSpace/AuraKaleidoScope/AuraKaleidoHPC/aura-object-detection/yoloV3/weights/yolov3.weights'
    
    class_path = '/Users/frewen/03.ProgramSpace/01.WorkSpace/AuraKaleidoScope/AuraKaleidoHPC/aura-object-detection/yoloV3/data/coco/coco.names'
    global classes
...
def yolo_detection_prepare(img_array, img_size = 416):
...
def predict():
    ...
    if flask.request.method == 'POST':
        if flask.request.files.get("image"):
            ...
            # 进行图像的处理
            res = yolo_detection_prepare(image)
