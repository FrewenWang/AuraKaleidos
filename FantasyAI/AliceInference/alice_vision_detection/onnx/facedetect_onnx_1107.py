...
def predict_image_onnx(ort_sess):
    ...
    image = cv2.imread("/home/frewen/Downloads/test/dump_20230301153310_15_1.mp4-3.png")
    ...
    # 存储到前处理的梳理
    # image.tofile("./debug_save/face_rect_prepare.bin")
...
if __name__ == "__main__":
    onnx_file = "../../models/onnx_models/FaceDetection1107V4Main_noquant.onnx"
