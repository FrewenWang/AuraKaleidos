...
static TransposeParam::TupleTable g_transpose_table_neon
{
    // elem_type
    {
        ElemType::U8,  
...
NEW_TESTCASE(matrix, Transpose, neon)
{
    MatrixTranspose matrix_transpose_test(UnitTest::GetInstance()->GetContext(), g_transpose_table_neon);
