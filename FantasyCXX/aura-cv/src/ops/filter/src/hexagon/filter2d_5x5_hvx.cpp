...
AURA_ALWAYS_INLINE DT_VOID Filter2d5x5Core(HVX_Vector &vu8_src_x0, HVX_Vector &vu8_src_x1, HVX_Vector &vu8_src_x2,
...
AURA_ALWAYS_INLINE DT_VOID Filter2d5x5Core(HVX_Vector &vu16_src_x0, HVX_Vector &vu16_src_x1, HVX_Vector &vu16_src_x2,
...
AURA_ALWAYS_INLINE DT_VOID Filter2d5x5Core(HVX_Vector &vs16_src_x0, HVX_Vector &vs16_src_x1, HVX_Vector &vs16_src_x2,
...
AURA_ALWAYS_INLINE DT_VOID Filter2d5x5Vector(HVX_Vector &v_src_p1x0, HVX_Vector &v_src_p1x1, HVX_Vector &v_src_p1x2, HVX_Vector &v_border_p1,
...
static DT_VOID Filter2d5x5Row(const Tp *src_p1, const Tp *src_p0, const Tp *src_c, const Tp *src_n0, const Tp *src_n1,
                              Tp *dst, DT_S32 width, const DT_S16 *kernel, const std::vector<Tp> &border_value)
{
...
template <typename Tp, BorderType BORDER_TYPE, DT_S32 C>
static Status Filter2d5x5HvxImpl(const Mat &src, Mat &dst, const std::vector<DT_S16> &kdata, const std::vector<Tp> &border_value,
...
static Status Filter2d5x5HvxHelper(Context *ctx, const Mat &src, Mat &dst, const std::vector<DT_S16> &kdata,
                                   const std::vector<Tp> &border_value, const Tp *border_buffer)
{
    ...
    switch (channel)
    {
        case 1:
        {
            ret = wp->ParallelFor((DT_S32)0, height, Filter2d5x5HvxImpl<Tp, BORDER_TYPE, 1>,
        ...
        case 2:
        {
            ret = wp->ParallelFor((DT_S32)0, height, Filter2d5x5HvxImpl<Tp, BORDER_TYPE, 2>,
                                  std::cref(src), std::ref(dst), std::cref(kdata), std::cref(border_value), border_buffer);
            break;
        }
        ...
        case 3:
        {
            ret = wp->ParallelFor((DT_S32)0, height, Filter2d5x5HvxImpl<Tp, BORDER_TYPE, 3>,
                                  std::cref(src), std::ref(dst), std::cref(kdata), std::cref(border_value), border_buffer);
            break;
        }
                      ...
                      BorderType border_type, const Scalar &border_value)
{
    ...
    switch (pattern)
    {
        ...
        {
            ret = Filter2d5x5HvxHelper<DT_U8>(ctx, src, dst, kdata, border_type, border_value);
            break;
        }

        case AURA_MAKE_PATTERN(ElemType::U16, ElemType::U16):
        {
            ret = Filter2d5x5HvxHelper<DT_U16>(ctx, src, dst, kdata, border_type, border_value);
            break;
        }

        case AURA_MAKE_PATTERN(ElemType::S16, ElemType::S16):
        {
            ret = Filter2d5x5HvxHelper<DT_S16>(ctx, src, dst, kdata, border_type, border_value);
            break;
        }
