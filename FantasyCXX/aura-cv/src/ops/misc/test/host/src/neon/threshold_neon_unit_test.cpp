...
static MiscThresholdParam::TupleTable g_threshold_table_neon
{
    // datatype
    {
...
static MiscThresholdParam::TupleTable g_combine_threshold_table_neon
{
    // datatype
    {
        aura::ElemType::U8
...
NEW_TESTCASE(misc, Threshold, neon)
{
    ThresholdTest test_threshold(aura::UnitTest::GetInstance()->GetContext(), g_threshold_table_neon);
    test_threshold.RunTest(this, UnitTest::GetInstance()->GetStressCount());

    ThresholdTest test_combine_threshold(aura::UnitTest::GetInstance()->GetContext(), g_combine_threshold_table_neon);
