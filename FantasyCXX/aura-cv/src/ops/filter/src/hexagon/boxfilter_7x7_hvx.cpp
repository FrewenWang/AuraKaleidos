                                             ...
                                             HVX_Vector &vu8_result, const SumType *row_sum, MI_S32 row_sum_step)
{
    ...
    HVX_Vector vs16_common0 = Q6_V_vlalign_VVI(vs16_sum1, vs16_sum0, 2);
    HVX_Vector vs16_common1 = vs16_sum1;

    HVX_Vector vs16_sum2    = Q6_Vh_vadd_VhVh(Q6_V_lo_W(ws16_diff2), Q6_V_hi_W(ws16_diff2));
    HVX_Vector vs16_common2 = Q6_V_valign_VVI(vs16_sum2, vs16_common1, 2);
    HVX_Vector vs16_common  = Q6_Vh_vadd_VhVh(vs16_common1, Q6_Vh_vadd_VhVh(vs16_common0, vs16_common2));

    HVX_Vector vs16_even = Q6_V_vlalign_VVI(Q6_V_hi_W(ws16_diff1), Q6_V_hi_W(ws16_diff0), 4);
    HVX_Vector vs16_odd  = Q6_V_valign_VVI(Q6_V_lo_W(ws16_diff2), Q6_V_lo_W(ws16_diff1), 4);
    ...
    vs16_sum_even = Q6_Vh_vadd_VhVh(vs16_sum_even, Q6_Vh_vadd_VhVh(vs16_common, vs16_even));
    vs16_sum_odd  = Q6_Vh_vadd_VhVh(vs16_sum_odd,  Q6_Vh_vadd_VhVh(vs16_common, vs16_odd));
...
{
    HVX_VectorPair ws16_sum_p2n2 = Q6_Wh_vadd_VubVub(vu8_src_p2, vu8_n2_src);
    HVX_VectorPair ws16_sum_p1n1 = Q6_Wh_vadd_VubVub(vu8_src_p1, vu8_src_n1);
    HVX_VectorPair ws16_sum      = Q6_Wh_vadd_WhWh(ws16_sum_p2n2, ws16_sum_p1n1);
    ws16_result = Q6_Wh_vadd_VubVub(vu8_src_p0, vu8_src_n0);
    ws16_result = Q6_Wh_vadd_WhWh(ws16_result, ws16_sum);
                                                     ...
                                                     HVX_Vector &vu8_result, const SumType *row_sum, MI_S32 row_sum_step)
{
    ...
    HVX_Vector vs16_sum2    = Q6_Vh_vadd_VhVh(Q6_V_lo_W(ws16_sum2), Q6_V_hi_W(ws16_sum2));
    HVX_Vector vs16_common2 = Q6_V_valign_VVI(vs16_sum2, vs16_common1, 2);
    HVX_Vector vs16_common  = Q6_Vh_vadd_VhVh(vs16_common1, Q6_Vh_vadd_VhVh(vs16_common0, vs16_common2));

    HVX_Vector vs16_even = Q6_V_vlalign_VVI(Q6_V_hi_W(ws16_sum1), Q6_V_hi_W(ws16_sum0), 4);
    HVX_Vector vs16_odd  = Q6_V_valign_VVI(Q6_V_lo_W(ws16_sum2), Q6_V_lo_W(ws16_sum1), 4);

    HVX_Vector *row_sum_data_out = (HVX_Vector*)(row_sum + row_sum_step);

    HVX_Vector vs16_sum_even = Q6_Vh_vadd_VhVh(vs16_common, vs16_even);
    HVX_Vector vs16_sum_odd  = Q6_Vh_vadd_VhVh(vs16_common, vs16_odd);
                                             ...
                                             HVX_Vector &vu16_result, const SumType *row_sum, MI_S32 row_sum_step)
{
    ...
    HVX_Vector vs32_sum1    = Q6_Vw_vadd_VwVw(Q6_V_lo_W(ws32_diff1), Q6_V_hi_W(ws32_diff1));
    HVX_Vector vs32_common0 = Q6_V_vlalign_VVI(vs32_sum1, vs32_sum0, 4);
    HVX_Vector vs32_common1 = vs32_sum1;

    HVX_Vector vs32_sum2    = Q6_Vw_vadd_VwVw(Q6_V_lo_W(ws32_diff2), Q6_V_hi_W(ws32_diff2));
    HVX_Vector vs32_common2 = Q6_V_valign_VVI(vs32_sum2, vs32_common1, 4);
    HVX_Vector vs32_common  = Q6_Vw_vadd_VwVw(vs32_common1, Q6_Vw_vadd_VwVw(vs32_common0, vs32_common2));

    HVX_Vector vs32_even = Q6_V_vmux_QVV(vq_mask0, Q6_V_vror_VR(Q6_V_hi_W(ws32_diff0), -8), Q6_V_vror_VR(Q6_V_hi_W(ws32_diff1), -8));
    HVX_Vector vs32_odd  = Q6_V_vmux_QVV(vq_mask1, Q6_V_vror_VR(Q6_V_lo_W(ws32_diff1),  8), Q6_V_vror_VR(Q6_V_lo_W(ws32_diff2),  8));
    ...
    vs32_sum_even = Q6_Vw_vadd_VwVw(vs32_sum_even, Q6_Vw_vadd_VwVw(vs32_common, vs32_even));
    vs32_sum_odd  = Q6_Vw_vadd_VwVw(vs32_sum_odd,  Q6_Vw_vadd_VwVw(vs32_common, vs32_odd));
                                                     ...
                                                     const HVX_Vector &vu16_src_n2, HVX_VectorPair &ws32_result)
{
    ...
    HVX_VectorPair ws32_sum      = Q6_Ww_vadd_WwWw(ws32_sum_p2n2, ws32_sum_p1n1);
                                                     ...
                                                     HVX_Vector &vu16_result, const SumType *row_sum, MI_S32 row_sum_step)
{
    ...
    HVX_Vector vs32_sum1    = Q6_Vw_vadd_VwVw(Q6_V_lo_W(ws32_sum1), Q6_V_hi_W(ws32_sum1));
    HVX_Vector vs32_common0 = Q6_V_vlalign_VVI(vs32_sum1, vs32_sum0, 4);
    HVX_Vector vs32_common1 = vs32_sum1;

    HVX_Vector vs32_sum2    = Q6_Vw_vadd_VwVw(Q6_V_lo_W(ws32_sum2), Q6_V_hi_W(ws32_sum2));
    HVX_Vector vs32_common2 = Q6_V_valign_VVI(vs32_sum2, vs32_common1, 4);
    HVX_Vector vs32_common  = Q6_Vw_vadd_VwVw(vs32_common1, Q6_Vw_vadd_VwVw(vs32_common0, vs32_common2));

    HVX_Vector vs32_even = Q6_V_vmux_QVV(vq_mask0, Q6_V_vror_VR(Q6_V_hi_W(ws32_sum0), -8), Q6_V_vror_VR(Q6_V_hi_W(ws32_sum1), -8));
    HVX_Vector vs32_odd  = Q6_V_vmux_QVV(vq_mask1, Q6_V_vror_VR(Q6_V_lo_W(ws32_sum1),  8), Q6_V_vror_VR(Q6_V_lo_W(ws32_sum2),  8));

    HVX_Vector *row_sum_data_out = (HVX_Vector*)(row_sum + row_sum_step);

    HVX_Vector vs32_sum_even = Q6_Vw_vadd_VwVw(vs32_common, vs32_even);
    HVX_Vector vs32_sum_odd  = Q6_Vw_vadd_VwVw(vs32_common, vs32_odd);
                                                     ...
                                                     const HVX_Vector &vs16_src_n2, HVX_VectorPair &ws32_result)
{
    ...
    HVX_VectorPair ws32_sum      = Q6_Ww_vadd_WwWw(ws32_sum_p2n2, ws32_sum_p1n1);
    HVX_VectorPair ws32_sum_p0n0 = Q6_Ww_vadd_VhVh(vs16_src_p0, vs16_src_n0);
    ws32_result  = Q6_Ww_vadd_WwWw(ws32_sum_p0n0, ws32_sum);
                                             ...
                                             HVX_Vector &v_result_x0, HVX_Vector &v_result_x1, SumType *row_sum, MI_S32 row_sum_step, MI_S32 rest)
{
    ...
    BoxFilter7x7HCore<Tp, SumType>(w_sum_x0, w_sum_x1, w_sum_r0, v_result_x0, row_sum, row_sum_step);
    BoxFilter7x7HCore<Tp, SumType>(w_sum_l0, w_sum_x2, w_sum_x3, v_result_x1, row_sum, row_sum_step + 128);
}
                                                     ...
                                                     HVX_Vector &v_result_x0, HVX_Vector &v_result_x1, SumType *row_sum, MI_S32 row_sum_step, MI_S32 rest)
{
    ...
    BoxFilter7x7FirstRowHCore<Tp, SumType>(w_sum_x0, w_sum_x1, w_sum_r0, v_result_x0, row_sum, row_sum_step);
                               ...
                               const std::vector<Tp> &border_value)
{
    ...
    // left border
    {
        ...
        for (MI_S32 ch = 0; ch < C; ch++)
        {
            ...
            BoxFilter7x7VCore<Tp, SumType>(v_border_p1, v_border_n1, mw_diff0.val[ch]);
            BoxFilter7x7VCore<Tp, SumType>(mv_src_p0.val[ch], mv_src_n0.val[ch], mw_diff1.val[ch]);
        }
    }
    ...
    // remain
    {
        ...
        for (MI_S32 ch = 0; ch < C; ch++)
        {
            ...
            HVX_VectorPair mw_diff2, mw_diff3;
            BoxFilter7x7VCore<Tp, SumType>(mv_src_p0.val[ch], mv_src_n0.val[ch], mw_diff2);
            BoxFilter7x7VCore<Tp, SumType>(v_border_p1, v_border_n1, mw_diff3);

            BoxFilter7x7HCore<Tp, SumType>(mw_diff0.val[ch], mw_diff1.val[ch], mw_diff2, mw_diff3,
                                    ...
                                    const Tp *src_n2, Tp *dst, MI_S32 width, SumType *row_sum, MI_S32 row_sum_step, const std::vector<Tp> &border_value)
{
    ...
    // left border
    {
        ...
        for (MI_S32 ch = 0; ch < C; ch++)
        {
            ...
            BoxFilter7x7FirstRowVCore<Tp, SumType>(v_border_p2, v_border_p1, v_border_p0, v_border_c, v_border_n0, v_border_n1, v_border_n2, mw_sum0.val[ch]);
            BoxFilter7x7FirstRowVCore<Tp, SumType>(mv_src_p2.val[ch], mv_src_p1.val[ch], mv_src_p0.val[ch], mv_src_c.val[ch], mv_src_n0.val[ch],
                                                   mv_src_n1.val[ch], mv_src_n2.val[ch], mw_sum1.val[ch]);
        }
    }
    ...
    // main(0 ~ n-2)
    {
        for (MI_S32 x = ELEM_COUNTS; x <= back_offset; x += ELEM_COUNTS, shift += ELEM_COUNTS)
        {
            ...
            for (MI_S32 ch = 0; ch < C; ch++)
            {
                ...
                BoxFilter7x7FirstRowHCore<Tp, SumType>(mw_sum0.val[ch], mw_sum1.val[ch], mw_sum2.val[ch],
                                                       mv_result.val[ch], row_sum, row_sum_step * ch + shift);
            }
    ...
    // remain
    {
        ...
        for (MI_S32 ch = 0; ch < C; ch++)
        {
            ...
            BoxFilter7x7FirstRowVCore<Tp, SumType>(mv_src_p2.val[ch], mv_src_p1.val[ch], mv_src_p0.val[ch], mv_src_c.val[ch],
                                                   mv_src_n0.val[ch], mv_src_n1.val[ch], mv_src_n2.val[ch], w_sum2);
            BoxFilter7x7FirstRowVCore<Tp, SumType>(v_border_p2, v_border_p1, v_border_p0, v_border_c, v_border_n0, v_border_n1, v_border_n2, w_sum3);

            BoxFilter7x7FirstRowHCore<Tp, SumType>(mw_sum0.val[ch], mw_sum1.val[ch], w_sum2, w_sum3,
                                                   mv_result.val[ch], mv_last.val[ch], row_sum, row_sum_step * ch + shift, rest);
        }
                                  ...
                                  const Tp *border_buffer, MI_S32 start_row, MI_S32 end_row)
{
    ...
    BoxFilter7x7FirstRow<Tp, SumType, BORDER_TYPE, C>(src_p2, src_p1, src_p0, src_c, src_n0, src_n1, src_n2, dst_row, width, row_sum, sum_size,
                                                      border_value);

    const Tp *src_p3 = src_p2;
    src_p2 = src_p1;
    src_p1 = src_p0;
    src_p0 = src_c;
    src_c  = src_n0;
    ...
    for (MI_S32 y = start_row + 1; y < end_row; y++)
    {
        ...
        BoxFilter7x7Row<Tp, SumType, BORDER_TYPE, C>(src_p3, src_n2, dst_row, width, row_sum, sum_size, border_value);
...
static Status BoxFilter7x7HvxHelper(Context *ctx, const Mat &src, Mat &dst, const std::vector<Tp> &border_value, const Tp *border_buffer)
{
...
static Status BoxFilter7x7HvxHelper(Context *ctx, const Mat &src, Mat &dst, BorderType &border_type, const Scalar &border_value)
{
    ...
    switch (border_type)
    {
        case BorderType::CONSTANT:
        {
            ...
            ret = BoxFilter7x7HvxHelper<Tp, SumType, BorderType::CONSTANT>(ctx, src, dst, vec_border_value, border_buffer);
        ...
        {
            ret = BoxFilter7x7HvxHelper<Tp, SumType, BorderType::REPLICATE>(ctx, src, dst, vec_border_value, border_buffer);
            break;
        }

        case BorderType::REFLECT_101:
        {
            ret = BoxFilter7x7HvxHelper<Tp, SumType, BorderType::REFLECT_101>(ctx, src, dst, vec_border_value, border_buffer);
            break;
        }
