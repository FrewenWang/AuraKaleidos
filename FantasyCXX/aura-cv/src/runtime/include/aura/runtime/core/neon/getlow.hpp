#ifndef AURA_RUNTIME_CORE_NEON_GETLOW_HPP__
#define AURA_RUNTIME_CORE_NEON_GETLOW_HPP__
...
#define DECLFUN(dtype, vtype, postfix)   \
    inline dtype vgetlow(const vtype &v) \
    {                                    \
        return vget_low_##postfix(v);    \
    }
...
#endif // AURA_RUNTIME_CORE_NEON_GETLOW_HPP__