...
static PyrDownParam::TupleTable g_pyrdown_table_cl
{
    //elem type
    {
        ElemType::U8,
...
NEW_TESTCASE(pyramid, PyrDown, opencl)
{
    PyrDownTest test(UnitTest::GetInstance()->GetContext(), g_pyrdown_table_cl);
