...
static HoughCirclesParam::TupleTable g_hough_circles_table_none
{
    // datatype
    {
        aura::ElemType::U8,
...
NEW_TESTCASE(misc, HoughCircles, none)
{
    HoughCirclesTest test(aura::UnitTest::GetInstance()->GetContext(), g_hough_circles_table_none);
