...
Status HoughCircles::SetArgs(const Array *src, std::vector<Scalar> &circles, HoughCirclesMethod method, MI_F64 dp,
...
Status HoughCirclesImpl::SetArgs(const Array *mat, std::vector<Scalar> &circles, HoughCirclesMethod method, MI_F64 dp,
                                 MI_F64 min_dist, MI_F64 canny_thresh, MI_F64 acc_thresh, MI_S32 min_radius, MI_S32 max_radius)
{
    if (MI_NULL == m_ctx)
    {
...
AURA_VOID HoughCirclesImpl::Dump(const std::string &prefix) const
{
