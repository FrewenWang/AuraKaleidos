...
class FaceAttributeRGB(BaseEval):
    def __init__(self):
        super(FaceAttributeRGB, self).__init__()
        self.feature_name = 'face_attribute_rgb'
        self.local_data_path = self.local_data_path + '/' + self.feature_name
        self.save_file_name = 'face_attribute_rgb_sample_images'
