...
kernel void GaussianRemain3x3C3(global St *src, int istep,
                                ...
                                struct Scalar border_value)
{
    ...
    v16it_src_p = GAUSSIAN_CONVERT(v16st_src_p, V16InterType);
    v16it_src_c = GAUSSIAN_CONVERT(v16st_src_c, V16InterType);
    v16it_src_n = GAUSSIAN_CONVERT(v16st_src_n, V16InterType);

    v16it_sum   = (v16it_src_p + v16it_src_n) * (V16InterType)filter[0] + v16it_src_c * (V16InterType)filter[1];
    v3it_result = (v16it_sum.s012 + v16it_sum.s678) * (V3InterType)filter[0] + v16it_sum.s345 * (V3InterType)filter[1];
