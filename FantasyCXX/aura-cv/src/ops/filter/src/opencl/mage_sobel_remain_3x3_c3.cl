...
kernel void SobelRemain3x3C3(global St *src, int istep,
                             ...
                             int main_width, struct Scalar border_value)
{
    ...
    v16it_src_p = SOBEL_CONVERT(v16st_src_p, V16InterType);
    v16it_src_c = SOBEL_CONVERT(v16st_src_c, V16InterType);
    v16it_src_n = SOBEL_CONVERT(v16st_src_n, V16InterType);

#if 0 == DY
    v16it_sum = (v16it_src_p + v16it_src_n) + v16it_src_c * (V16InterType)2;
#elif 1 == DY
    v16it_sum = v16it_src_n - v16it_src_p;
#elif 2 == DY
    v16it_sum = (v16it_src_p + v16it_src_n) - v16it_src_c * (V16InterType)2;
#else
    v16it_sum = (v16it_src_p + v16it_src_n) * (V16InterType)3 + v16it_src_c * (V16InterType)10;
#endif // 0 == DY

#if 0 == DX
    v3it_result = (v16it_sum.s012 + v16it_sum.s678) + v16it_sum.s345 * (V3InterType)2;
#elif 1 == DX
    v3it_result = v16it_sum.s678 - v16it_sum.s012;
#elif 2 == DX
    v3it_result = (v16it_sum.s012 + v16it_sum.s678) - v16it_sum.s345 * (V3InterType)2;
#else
    v3it_result = (v16it_sum.s012 + v16it_sum.s678) * (V3InterType)3 + v16it_sum.s345 * (V3InterType)10;
#endif // 0 == DX
...
#if WITH_SCALE
    v3dt_result = CONVERT_SAT(CONVERT(v3dt_result, float3) * (float3)scale, V3Dt);
#endif // WITH_SCALE
