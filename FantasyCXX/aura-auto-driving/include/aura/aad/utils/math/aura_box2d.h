...
public:
     ...
     */
    Box2d(const Vector2d &center, const double length, const double width);
     ...
     */
    Box2d(const Vector2d &one_corner, const Vector2d &opposite_corner);
     ...
     */
    explicit Box2d(const safe::vector<Vector2d> &points);
    ...
    */
    void GetAllCorners(safe::vector<Vector2d> *const corners) const;
    ...
    */
    void MergeFrom(const Box2d &other_box);
