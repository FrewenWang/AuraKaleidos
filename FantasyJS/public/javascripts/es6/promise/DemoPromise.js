// Promise 对象的基础知识学习
// 文章参考：https://es6.ruanyifeng.com/#docs/promise
"use strict";
...
const TAG = 'PromiseDemo';
console.log(TAG, '===========Promise基础用法============')
...
let promise = new Promise(function (resolve, reject) {
    console.log('Promise创建之后就会立即执行！！！！');
    resolve();
});

promise.then(function () {
    console.log('然后then方法才会异步执行执行resolved.');
});
...
loadImageAsync("http://n.sinaimg.cn/translate/w500h337/20180108/lDRm-fyqincv2761796.jpg");


// 下面是一个用Promise对象实现的 Ajax 操作的例子。
/**
 * 这个方法返回的是一个Promise对象。
 * 所以这个方法我们通过返回的promise对象调用then方法来接收正常回调结果。或者异常回调结果
 * @param url
...
getJSON("./public/javascripts/es6/promise/post.json").then(function (json) {
...
const p1Reject = new Promise(function (resolve, reject) {
    setTimeout(() => reject("p1Reject called"), 3000);
});

const p2Resolve = new Promise(function (resolve, reject) {
    setTimeout(() => resolve(p1Reject), 1000)
});
