...
from alice_face_detection import train_utils
import paddle
import paddle.distributed as dist
from paddle.distributed import fleet

from alice_face_detection.vehicle_pdc_facedetect import FaceDataSet
from alice_face_detection.reader import TrainReader, EvalReader

from alice_face_detection.PPYoloMobileNetV3 import PPYoloTiny
from alice_face_detection.metrics import VOCMetric
...
from alice_face_detection import stats
from alice_face_detection.logger import setup_logger
...
if __name__ == "__main__":
    use_cloud = False  # 判断是否使用云端训练
    usePruner = True   # 是否使用模型剪枝
    worker_scale = 1
    use_gpu = True   # 使用GPU
    ...
    if use_cloud:
        ...
        pretrain_weight = './afs_aicv/filelist/20211116192715_epoch17_v2'
        pretrain_weight = "./afs_aicv/filelist/xinsuanyiti_model50M224"
        ...
        images_root = '/media/baidu/3.6TB_SSD/facedetect/缩小尺寸'
        # 训练标注文件
        train_label_file = [
            # '/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/filelist/train_filelist/train1.txt',
            # '/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/filelist/train_filelist/oms_SmallFace_biaozhu1_20211115.txt',
            # '/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/filelist/train_filelist/oms_SmallFace_biaozhu_20211118.txt',
            # '/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/filelist/train_filelist/train_5w.txt',
            '/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/filelist/val_filelist/val_omsface_test100.txt',
        ]
        eval_label_file_prune = [
            # '/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/filelist/val_filelist/val_omsface_test100.txt',
            # '/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/filelist/val_filelist/val1_test200.txt',
            '/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/filelist/val200.txt',
        ]
        eval_label_file = [
            # '/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/filelist/val_filelist/val1.txt',
            # '/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/filelist/val_filelist/val_omsface1.txt',
            '/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/filelist/val_filelist/val_omsface_test100.txt',
        ]
        # model_save_path = '/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/models_save/芯算一体/model50M224/prune0.8'
        model_save_path = '/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/models_save/剪枝模型/量化模型/lianghua'
        pretrain_weight = '/home/baidu/.cache/paddle/weights/MobileNetV3_large_x0_5_pretrained'
        pretrain_weight = "/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/models_save/剪枝模型/v1/20211111103031_epoch24_2000"
        pretrain_weight = "/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/models_save/芯算一体/c7230302/pretrained/c7230302_weights"
        pretrain_weight = "/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/models_save/芯算一体/model50M224/epoch19"
        pretrain_weight = "/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/models_save/剪枝模型/v3/epoch19_v3"
        pretrain_weight = "/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/models_save/pd222/全量数据/原始模型/epoch9"
        pretrain_weight = "/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/models_save/pd222/2d4f5904/原始网络/epoch19"
        path_prune_pickle = "/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/models_save/芯算一体/model50M224/剪枝文件/L1Norm_sen_yb_sense2.pickle"
        path_prune_pickle = "/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/models_save/剪枝文件/L1Norm_sen_yb_sense60.pickle"
        path_prune_pickle = "/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/models_save/pd222/剪枝文件/L1Norm_sen_yb_pd222_new.pickle"
        path_prune_pickle = "/media/baidu/3.6TB_SSD/facedetect/缩小尺寸/models_save/pd222/2d4f5904/剪枝量化/剪枝文件/2d4f5904_prune.pickle"
        pathNeg = "/media/baidu/3.6TB_SSD/val_data/back_noHand_img/back_from_ImgNet"
        resume_weight = ''
    ...
    # model = PPYoloTiny(model="model50M224") #
    ...
    paddle.flops(model, (1, 3, 160, 288))
    print("**********************************************************")
    ...
    if usePruner:
        try:
            ...
            os.system('pip3 install paddleslim==2.2.2')
            from paddleslim.dygraph import L1NormFilterPruner
        #         from paddleslim.dygraph import L1NormFilterPruner
        pruner = L1NormFilterPruner(model, [1, 3, 160, 288])
        ...
        sen = pruner.sensitive(eval_func=eval_fn,
                               sen_file=path_prune_pickle)  # skip_vars=['conv2d_80.w_0','conv2d_80.w_0','conv2d_80.w_0'])
        # pruner.sensitive(sen_file=path_prune_pickle)

        paddle.flops(model, (1, 3, 160, 288))
        print("+1" * 100)
        plan = pruner.sensitive_prune(0.9)
        paddle.flops(model, (1, 3, 160, 288))
        print("+2" * 100)
