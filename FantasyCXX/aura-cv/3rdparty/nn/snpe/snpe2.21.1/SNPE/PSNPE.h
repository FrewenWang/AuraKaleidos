...
/**
 * @brief To be deprecated, set the encode value when you want to divide one iaura into 2 or 4 parts to run, default is 0 which means the input don't need dividing.
 *
 * @param[in] bcHandle Handle to access the object of snpe buid config
 *
