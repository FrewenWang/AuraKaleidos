...
static ResizeParam::TupleTable g_resize_up_table_cl
{
    // elem_type
    {
...
static ResizeParam::TupleTable g_resize_down_table_cl
{
    // elem_type
    {
        ElemType::U8,  ElemType::S8,
...
NEW_TESTCASE(resize, Resize, opencl)
{
    ResizeTest test_up(UnitTest::GetInstance()->GetContext(), g_resize_up_table_cl);
    test_up.RunTest(this, UnitTest::GetInstance()->GetStressCount());
    ResizeTest test_down(UnitTest::GetInstance()->GetContext(), g_resize_down_table_cl);
