...
kernel void LaplacianRemain5x5C2(global St *src, int istep,
                                 ...
                                 int main_width, struct Scalar border_value)
{
    ...
    V2InterType  v2it_sum_pn1, v2it_sum_pn0, v2it_sum_c;
    ...
    v2it_sum_pn1 = (v16it_sum_pn1.s01 + v16it_sum_pn1.s89) * (V2InterType)2 +
                   (v16it_sum_pn1.s23 + v16it_sum_pn1.s67) * (V2InterType)4 +
                   (v16it_sum_pn1.s45 * (V2InterType)4);
    v2it_sum_pn0 = (v16it_sum_pn0.s01 + v16it_sum_pn0.s89) * (V2InterType)4 +
                   (v16it_sum_pn0.s45 * (V2InterType)-8);
    v2it_sum_c   = (v16it_src_c.s01 + v16it_src_c.s89) * (V2InterType)4 +
                   (v16it_src_c.s23 + v16it_src_c.s67) * (V2InterType)-8 +
                   (v16it_src_c.s45 * (V2InterType)-24);
    v2it_result = v2it_sum_pn1 + v2it_sum_pn0 + v2it_sum_c;
