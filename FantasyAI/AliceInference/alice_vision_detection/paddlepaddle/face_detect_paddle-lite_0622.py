...
def predict_image_paddle(model_file, param_file):
    # 1. Set config information
    # 创建 config
    config = paddle_infer.Config(model_file)
...
# 文章参考：https://paddle-lite.readthedocs.io/zh/develop/user_guides/python_demo.html
if __name__ == "__main__":
    ...
    # 使用paddle-lite进行推理
    param_file = "../../models/paddle-lite_models/FaceDetection0620V4MainQuant.nb"
    predict_image_paddle(model_file, param_file)
