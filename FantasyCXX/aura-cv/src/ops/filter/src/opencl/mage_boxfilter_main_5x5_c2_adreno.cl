                               ...
                               struct Scalar border_value)
{
    ...
    V8InterType  v8it_sum_c0, v8it_sum_c1;
    ...
    v8it_sum_c1      = v16it_sum_c1.s01234567 + v16it_sum_c1.s23456789 + v16it_sum_c1.s456789AB + 
                       v16it_sum_c1.s6789ABCD + v16it_sum_c1.s89ABCDEF;

#if IS_FLOAT(InterType)
    v8it_sum_c0      = v8it_sum_c0 / 25.f;
    v8it_sum_c1      = v8it_sum_c1 / 25.f;
    ...
    V8Float v8float_result_c1 = CONVERT(v8it_sum_c1, V8Float) / 25.f;
