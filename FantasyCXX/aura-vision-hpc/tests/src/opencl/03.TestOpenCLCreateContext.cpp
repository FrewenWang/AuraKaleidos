...
const static char *TAG = "TestOpenCLCreateContext";


class TestOpenCLCreateContext : public testing::Test {
public:
...
TEST_F(TestOpenCLCreateContext, TestGetPlatform) {
...
TEST_F(TestOpenCLCreateContext, TestGetPlatformInfo) {
...
TEST_F(TestOpenCLCreateContext, TestGetDevice) {
