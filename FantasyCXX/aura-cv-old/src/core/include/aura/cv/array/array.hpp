#ifndef MAGE_RUNTIME_ARRAY_ARRAY_HPP__
#define MAGE_RUNTIME_ARRAY_ARRAY_HPP__
...
template <>            AURA_NO_STATIC_INLINE ElemType GetElemType<AURA_U8>()    { return ElemType::U8;      }
template <>            AURA_NO_STATIC_INLINE ElemType GetElemType<AURA_S8>()    { return ElemType::S8;      }
template <>            AURA_NO_STATIC_INLINE ElemType GetElemType<AURA_U16>()   { return ElemType::U16;     }
template <>            AURA_NO_STATIC_INLINE ElemType GetElemType<AURA_S16>()   { return ElemType::S16;     }
template <>            AURA_NO_STATIC_INLINE ElemType GetElemType<AURA_U32>()   { return ElemType::U32;     }
template <>            AURA_NO_STATIC_INLINE ElemType GetElemType<AURA_S32>()   { return ElemType::S32;     }
template <>            AURA_NO_STATIC_INLINE ElemType GetElemType<AURA_F32>()   { return ElemType::F32;     }
template <>            AURA_NO_STATIC_INLINE ElemType GetElemType<AURA_F64>()   { return ElemType::F64;     }
#if defined(MAGE_BUILD_HOST)
template <>            AURA_NO_STATIC_INLINE ElemType GetElemType<AURA_F16>()   { return ElemType::F16;     }
#endif
 ...
 */
AURA_INLINE AURA_S32 ElemTypeSize(ElemType elem_type)
{
    AURA_S32 elem_size = 0;
    ...
    switch (elem_type)
    {
        ...
        case ElemType::S8:
        {
            elem_size = sizeof(AURA_U8);
            break;
        }
        case ElemType::U16:
        case ElemType::S16:
        {
            elem_size = sizeof(AURA_U16);
            break;
        }
        case ElemType::U32:
        case ElemType::S32:
        {
            elem_size = sizeof(AURA_U32);
            break;
        }
        case ElemType::F32:
        {
            elem_size = sizeof(AURA_F32);
            break;
        }
        case ElemType::F64:
        {
            elem_size = sizeof(AURA_F64);
            break;
        }
#if defined(MAGE_BUILD_HOST)
        case ElemType::F16:
        {
            elem_size = sizeof(AURA_F16);
            break;
        }
#endif
        default:
...
public:
     ...
     */
    virtual AURA_BOOL IsValid() const;
     ...
     */
    AURA_BOOL IsEqual(const Array &array) const;
     ...
     */
    AURA_BOOL IsSizesEqual(const Array &array) const;
     ...
     */
    AURA_BOOL IsChannelEqual(const Array &array) const;
...
protected:
     ...
     */
    AURA_S32 AddRefCount(AURA_S32 num) const;
    ...
    */
    ...
    AURA_S64      m_total_bytes;      /*!< Total number of bytes occupied by the array. */
    AURA_S32      *m_refcount;        /*!< Reference count for managing array's memory. */
...
#endif // MAGE_RUNTIME_ARRAY_ARRAY_HPP__