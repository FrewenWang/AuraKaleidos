...
void ResizeNeon::resizeNeonInterLinearOneChannel(const uint8_t *src, int w_in, int h_in,
    ...
    auto *ialpha = reinterpret_cast<int16_t *>(buf + w_out + h_out);  // new short[w * 2];
    auto *ibeta = reinterpret_cast<int16_t *>(buf + w_out * 2 + h_out);  // new short[h * 2];
...
void ResizeNeon::resize_neon_inter_linear_three_channel(const uint8_t *src,
                                                        int w_in,
                                                        int h_in,
                                                        uint8_t *dst,
                                                        int w_out,
