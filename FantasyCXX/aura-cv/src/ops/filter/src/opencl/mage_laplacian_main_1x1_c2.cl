...
kernel void LaplacianMain1x1C2(global St *src, int istep,
                               ...
                               struct Scalar border_value)
{
    ...
    V16InterType v16it_sum_pn, v16it_sum_lr, v16it_sum_c;
    ...
    v16it_sum_pn =  ROT_R(v16it_src_p + v16it_src_n, 16, 14);
    v16it_sum_lr = v16it_src_c +  ROT_R(v16it_src_c, 16, 12);
    v16it_sum_c  =  ROT_R(v16it_src_c, 16, 14) * (V16InterType)-4;

    v16it_result = v16it_sum_pn + v16it_sum_lr + v16it_sum_c;
