...
/**
 * Open the compiled network from dla file.
 * @param runtime The address of the created neuron runtime instance.
 * @param pathToDlaFile The dla file path.
 * @return A RuntimeAPI error code.
 */
int NeuronRuntime_openNetworkFromFile(void* runtime, const char* pathToDlaFile);

/**
 * Open the compiled network from a memory buffer.
 * @note The memory buffer should be kept until NeuronRuntime_initializeNetwork() is done.
 * @param runtime The address of the created neuron runtime instance.
 * @param buffer The memory buffer.
 * @param size The size of the buffer.
 * @return A RuntimeAPI error code.
 */
int NeuronRuntime_openNetworkFromBuffer(void* runtime, const void* buffer, size_t size);

/**
 * Get the temporary buffer size required by the compiled network opened in the runtime.
 * The size (byte) will be passed back in *size.
 * @param runtime The address of the created neuron runtime instance.
 * @param size The temporary buffer size.
 * @return A RuntimeAPI error code.
 */
int NeuronRuntime_getTempSize(void* runtime, size_t* size);

/**
 * Set the memory buffer and offset for the temporary buffer required by the compiled network
 * opened in the runtime.
 * @param runtime The address of the created neuron runtime instance.
 * @param length The temporary buffer size. This length doesn't include offset.
 * @param attribute The buffer attribute for setting ION.
 * @param offset The offset for ION buffer.
 * @return A RuntimeAPI error code.
 */
int NeuronRuntime_setTemp(void* runtime, size_t length, BufferAttribute attribute, size_t offset);

/**
 * Initialize the compiled network opened by NeuronRuntime_openNetworkFrom*().
 * @param runtime The address of the created neuron runtime instance.
 * @return A RuntimeAPI error code.
 */
int NeuronRuntime_initializeNetwork(void* runtime);
 ...
 * @param runtime The address of the created neuron runtime instance.
 * @param kind The kind of QoS configuration. Choose one from RuntimeAPIQoSKind.
 * @param value The value for QoS configuration.
 * @return A RuntimeAPI error code.
 */
int NeuronRuntime_setQoS(void* runtime, int32_t kind, int64_t value);
