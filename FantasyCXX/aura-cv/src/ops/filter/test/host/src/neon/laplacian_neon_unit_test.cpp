...
static LaplacianParam::TupleTable g_laplacian_table_neon {
    // element type
    {
...
NEW_TESTCASE(filter, Laplacian, neon)
{
    LaplacianTest test(UnitTest::GetInstance()->GetContext(), g_laplacian_table_neon);
