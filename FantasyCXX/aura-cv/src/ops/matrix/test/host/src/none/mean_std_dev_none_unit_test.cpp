...
static MeanStdDevParam::TupleTable g_mean_std_dev_table_none
{
    // element type
    {
...
NEW_TESTCASE(matrix, MeanStdDev, none)
{
    MeanStdDevTest test(UnitTest::GetInstance()->GetContext(), g_mean_std_dev_table_none);
