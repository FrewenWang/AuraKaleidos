...
DECLFUN(MI_U8,  uint8x8_t,   vadd,  u8)
DECLFUN(MI_U8,  uint8x16_t,  vaddq, u8)
DECLFUN(MI_S8,  int8x8_t,    vadd,  s8)
DECLFUN(MI_S8,  int8x16_t,   vaddq, s8)
DECLFUN(MI_U16, uint16x4_t,  vadd,  u16)
DECLFUN(MI_U16, uint16x8_t,  vaddq, u16)
DECLFUN(MI_S16, int16x4_t,   vadd,  s16)
DECLFUN(MI_S16, int16x8_t,   vaddq, s16)
DECLFUN(MI_U32, uint32x2_t,  vadd,  u32)
DECLFUN(MI_U32, uint32x4_t,  vaddq, u32)
DECLFUN(MI_S32, int32x2_t,   vadd,  s32)
DECLFUN(MI_S32, int32x4_t,   vaddq, s32)
DECLFUN(MI_U64, uint64x1_t,  vadd,  u64)
DECLFUN(MI_U64, uint64x2_t,  vaddq, u64)
DECLFUN(MI_S64, int64x1_t,   vadd,  s64)
DECLFUN(MI_S64, int64x2_t,   vaddq, s64)
DECLFUN(MI_F32, float32x2_t, vadd,  f32)
DECLFUN(MI_F32, float32x4_t, vaddq, f32)
