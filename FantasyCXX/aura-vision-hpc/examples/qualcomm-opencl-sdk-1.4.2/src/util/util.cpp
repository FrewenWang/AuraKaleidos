...
void save_raw_image_data(const std::string &filename, std::vector<unsigned char> image_dump, size_t size)
{
    std::ofstream fout(filename, std::ios::binary);
    if (!fout)
    {
    ...
    fout.write((char*)image_dump.data(), size);
...
complex_matrix_t load_real_matrix_as_complex_matrix(const std::string &filename)
{
    std::ifstream fin(filename);
    if (!fin)
    {
...
void save_matrix(const std::string &filename_real, const std::string &filename_imag, const complex_matrix_t &matrix)
{
    std::ofstream real_fout(filename_real);
    if (!real_fout)
    {
        std::cerr << "Can't open " << filename_real << " for writing.\n";
        std::exit(EXIT_FAILURE);
    }

    std::ofstream imag_fout(filename_imag);
    if (!imag_fout)
    {
        std::cerr << "Can't open " << filename_imag << " for writing.\n";
        std::exit(EXIT_FAILURE);
    }

    save_matrix(real_fout, imag_fout, matrix);
}
...
void save_matrix(std::ostream &real, std::ostream &imag, const complex_matrix_t &matrix)
{
    real << matrix.width << " " << matrix.height << "\n";
    imag << matrix.width << " " << matrix.height << "\n";
    for (auto i = 0; i < matrix.height; ++i)
    {
        for (auto j = 0; j < matrix.width; ++j)
        {
            const int idx = i * matrix.width + j;
            real << matrix.elements[idx].x << " ";
            imag << matrix.elements[idx].y << " ";
        }
        real << "\n";
        imag << "\n";
    }
...
std::string get_image_order(cl_image_format format)
{
    std::string order;
    ...
    case CL_QCOM_NV12:
        ...
        break;
    case CL_QCOM_NV12_Y:
        order = "CL_QCOM_NV12_Y";
        break;
    case CL_QCOM_NV12_UV:
        order = "CL_QCOM_NV12_UV";
        break;
    case CL_QCOM_NV12_512:
        order = "CL_QCOM_NV12_512";
        break;
    case CL_QCOM_NV12_512_Y:
        order = "CL_QCOM_NV12_512_Y";
        break;
    case CL_QCOM_NV12_512_UV:
        order = "CL_QCOM_NV12_512_UV";
        break;
    case CL_QCOM_TILED_NV12:
        order = "CL_QCOM_TILED_NV12";
        break;
    case CL_QCOM_TILED_NV12_Y:
        order = "CL_QCOM_TILED_NV12_Y";
        break;
    case CL_QCOM_TILED_NV12_UV:
        order = "CL_QCOM_TILED_NV12_UV";
        break;
    ...
    case CL_QCOM_P010:
        ...
        break;
    case CL_QCOM_P010_Y:
        order = "CL_QCOM_P010_Y";
        break;
    case CL_QCOM_P010_UV:
        order = "CL_QCOM_P010_UV";
        break;
    case CL_QCOM_TILED_P010:
        order = "CL_QCOM_TILED_P010";
        break;
    case CL_QCOM_TILED_P010_Y:
        order = "CL_QCOM_TILED_P010_Y";
        break;
    case CL_QCOM_TILED_P010_UV:
        order = "CL_QCOM_TILED_P010_UV";
        break;
    ...
    case CL_QCOM_TP10:
        ...
        break;
    case CL_QCOM_TP10_Y:
        order = "CL_QCOM_TP10_Y";
        break;
    case CL_QCOM_TP10_UV:
        order = "CL_QCOM_TP10_UV";
        break;
    case CL_QCOM_TILED_TP10:
        order = "CL_QCOM_TILED_TP10";
        break;
    case CL_QCOM_TILED_TP10_Y:
        order = "CL_QCOM_TILED_TP10_Y";
        break;
    case CL_QCOM_TILED_TP10_UV:
        order = "CL_QCOM_TILED_TP10_UV";
        break;
    ...
    case CL_QCOM_COMPRESSED_TP10_UV:
        ...
        break;
    case CL_QCOM_COMPRESSED_RGBA:
        order = "CL_QCOM_COMPRESSED_RGBA";
        break;
    case CL_QCOM_COMPRESSED_RGBx:
        order = "CL_QCOM_COMPRESSED_RGBx";
        break;
    case CL_RGBA:
        order = "CL_RGBA";
        break;
...
std::string get_image_datatype(cl_image_format format)
{
    ...
    case CL_QCOM_UNORM_INT10:
        ...
        break;
    case CL_QCOM_UNORM_MIPI10:
        data_type = "CL_QCOM_UNORM_MIPI10";
        break;
    case CL_QCOM_UNORM_MIPI12:
        data_type = "CL_QCOM_UNORM_MIPI12";
        break;
    case CL_QCOM_UNSIGNED_MIPI10:
        data_type = "CL_QCOM_UNSIGNED_MIPI10";
        break;
    case CL_QCOM_UNSIGNED_MIPI12:
        data_type = "CL_QCOM_UNSIGNED_MIPI12";
        break;
    case CL_QCOM_UNORM_INT12:
        data_type = "CL_QCOM_UNORM_INT12";
        break;
    case CL_QCOM_UNSIGNED_INT16:
        data_type = "CL_QCOM_UNSIGNED_INT16";
        break;
    default:
        std::stringstream strm;
...
void print_formats(const std::vector<cl_image_format> &formats)
{
    for (const auto &format : formats)
    {
        ...
        order = get_image_order(format);
        data_type = get_image_datatype(format);
