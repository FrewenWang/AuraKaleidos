...
# python scripts/legacy/predict_images_cloud.py
# python scripts/evaluation/count_face_PR.py > /root/paddlejob/workspace/log/pr_rslt.txt
# python scripts/evaluation/count_loss.py
# date=`date +%Y%m%d-%H%M%S`
