...
AURA_INLINE MI_F32 Sqrt(MI_F32 value)
{
    return sqrtf(value);
}

AURA_INLINE MI_F64 Sqrt(MI_F64 value)
{
    return sqrt(value);
}

AURA_INLINE MI_F32 Div(MI_F32 n, MI_F32 d)
{
    return n / d;
}

AURA_INLINE MI_F32 Exp(MI_F32 value)
{
    return expf(value);
}

AURA_INLINE MI_F64 Exp(MI_F64 value)
{
    return exp(value);
}

AURA_INLINE MI_F32 Exp2(MI_F32 value)
{
    return exp2f(value);
}

AURA_INLINE MI_F64 Exp2(MI_F64 value)
{
    return exp2(value);
}

AURA_INLINE MI_F32 Log(MI_F32 value)
{
    return logf(value);
}

AURA_INLINE MI_F64 Log(MI_F64 value)
{
    return log(value);
}

AURA_INLINE MI_F32 Log2(MI_F32 value)
{
    return log2f(value);
}

AURA_INLINE MI_F64 Log2(MI_F64 value)
{
    return log2(value);
}

AURA_INLINE MI_F32 Log10(MI_F32 value)
{
    return log10f(value);
}

AURA_INLINE MI_F64 Log10(MI_F64 value)
{
    return log10(value);
}

AURA_INLINE MI_F32 Pow(MI_F32 x, MI_F32 y)
{
    return powf(x, y);
}

AURA_INLINE MI_F64 Pow(MI_F64 x, MI_F64 y)
{
    return pow(x, y);
}

AURA_INLINE MI_F32 Sin(MI_F32 value)
{
    return sinf(value);
}

AURA_INLINE MI_F64 Sin(MI_F64 value)
{
    return sin(value);
}

AURA_INLINE MI_F32 Cos(MI_F32 value)
{
    return cosf(value);
}

AURA_INLINE MI_F64 Cos(MI_F64 value)
{
    return cos(value);
}

AURA_INLINE MI_F32 Tan(MI_F32 value)
{
    return tanf(value);
}

AURA_INLINE MI_F64 Tan(MI_F64 value)
{
    return tan(value);
}

AURA_INLINE MI_F32 Asin(MI_F32 value)
{
    return asinf(value);
}

AURA_INLINE MI_F64 Asin(MI_F64 value)
{
    return asin(value);
}

AURA_INLINE MI_F32 Acos(MI_F32 value)
{
    return acosf(value);
}

AURA_INLINE MI_F64 Acos(MI_F64 value)
{
    return acos(value);
}

AURA_INLINE MI_F32 Atan(MI_F32 value)
{
    return atanf(value);
}

AURA_INLINE MI_F64 Atan(MI_F64 value)
{
    return atan(value);
}

AURA_INLINE MI_F32 Atan2(MI_F32 x, MI_F32 y)
{
    return atan2f(x, y);
}

AURA_INLINE MI_F64 Atan2(MI_F64 x, MI_F64 y)
{
    return atan2(x, y);
}
