...
NEW_TESTCASE(runtime_hexagon_instructions_sub_test)
{
    ...
    // Q6_Wd_vsub_VuwVuw
    {
        ...
        HVX_VectorPair ws64 = Q6_Wd_vsub_VuwVuw(vu32_u, vu32_v);
    ...
    // Q6_Wd_vsub_VwVw
    {
        ...
        HVX_VectorPair ws64 = Q6_Wd_vsub_VwVw(vs32_u, vs32_v);
        ws64 = Q6_W_vshuff_VVR(Q6_V_hi_W(ws64), Q6_V_lo_W(ws64), -4);
        vmemu(dst) = Q6_V_lo_W(ws64);
        vmemu(dst + 16) = Q6_V_hi_W(ws64);
    ...
    // Q6_Wd_vsub_WdWd
    {
        ...
        HVX_VectorPair ws64 = Q6_Wd_vsub_WdWd(ws64_u, ws64_v);
        ws64 = Q6_W_vshuff_VVR(Q6_V_hi_W(ws64), Q6_V_lo_W(ws64), -4);
        vmemu(dst) = Q6_V_lo_W(ws64);
        vmemu(dst + 16) = Q6_V_hi_W(ws64);
    ...
    // Q6_Wud_vsub_WudWud
    {
        ...
        HVX_VectorPair wu64 = Q6_Wud_vsub_WudWud(wu64_u, wu64_v);
