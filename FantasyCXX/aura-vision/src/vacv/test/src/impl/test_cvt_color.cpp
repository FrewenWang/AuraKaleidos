...
static const char* TAG = "Test_Cvt_Color";
...
std::vector<double> TestCvtColor::test_nv21_to_bgr(std::string img_path) {
    ...
    double vacv_duration;
    {
        ...
        va_cv::cvt_color(yuv_tensor, yuv_to_bgr_tensor, vision::COLOR_YUV2BGR_NV21);
    }

    float cosine_distance = FaceIdUtil::compare_image_data((unsigned char*)src_mat.data,
