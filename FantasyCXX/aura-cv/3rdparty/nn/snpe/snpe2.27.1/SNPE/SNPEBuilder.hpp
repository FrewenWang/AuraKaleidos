 ...
 *
 * @note If this setting is enabled, the DlContainer object passed to this builder will be
 * invalidated and closed upon build to allow for an in-place save of the cached DLC over the
 * original DLC. User must re-open the DLC for subsequent use
 *
