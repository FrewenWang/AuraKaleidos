...
static DctParam::TupleTable g_dct_table_neon
{
    // ElemType
    {
        aura::ElemType::U8,
...
static IDctParam::TupleTable g_idct_table_neon
{
    // ElemType
    {
        aura::ElemType::U8,
    ...
    // MatSize
    {
        ...
        {aura::Sizes3(64,   512,  1), aura::Sizes()},
        {aura::Sizes3(2,    64,   1), aura::Sizes()},
        {aura::Sizes3(64,   8,    1), aura::Sizes()},
        {aura::Sizes3(64,   4,    1), aura::Sizes()},
        {aura::Sizes3(64,   2,    1), aura::Sizes()},
        {aura::Sizes3(1,    64,   1), aura::Sizes()},
        {aura::Sizes3(64,   1,    1), aura::Sizes()},
    },
...
NEW_TESTCASE(matrix, Dct, neon)
{
    MatrixDctTest matrix_dct_test(UnitTest::GetInstance()->GetContext(), g_dct_table_neon);
    matrix_dct_test.RunTest(this, UnitTest::GetInstance()->GetStressCount());
}


NEW_TESTCASE(matrix, IDct, neon)
{
    MatrixIDctTest matrix_idct_test(UnitTest::GetInstance()->GetContext(), g_idct_table_neon);
