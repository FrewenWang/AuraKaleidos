...
static ArithmScalarTestParam::TupleTable g_arithmetic_scalar_table_neon
{
    // element type src
    {
        ElemType::F32,
...
NEW_TESTCASE(matrix, Arithmetic_with_scalar, neon)
{
    ArithmScalarTest arithmetic_scalar_test(UnitTest::GetInstance()->GetContext(), g_arithmetic_scalar_table_neon);
