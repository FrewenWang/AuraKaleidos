...
void Crop::crop(const vision::VTensor &src, vision::VTensor &dst, const VRect &rect) {
#ifdef BUILD_OPENCV
...
void Crop::crop(const VTensor &src, int &srcFormat, VTensor &dst, const VRect &rect) {
    cropOpencv(src, srcFormat, dst, rect);
}

void Crop::cropOpencv(const VTensor &src, int &format, VTensor &dst, const VRect &rect) {

}

void Crop::crop_opencv(const vision::VTensor& src, vision::VTensor& dst, const vision::VRect& rect) {
#ifdef USE_OPENCV
...
void Crop::crop_naive_chw(const vision::VTensor& src, vision::VTensor& dst,
...
void Crop::crop_naive_hwc_rgb(const vision::VTensor& src, vision::VTensor& dst,
							  int crop_left, int crop_top, int crop_width, int crop_height) {
    if (src.dType == INT8) {
...
void Crop::crop_naive(const vision::VTensor& src, vision::VTensor& dst, const vision::VRect& rect) {
...
void Crop::crop_sse(const vision::VTensor& src, vision::VTensor& dst, const vision::VRect& rect) {
    // todo:
}

#if defined (USE_NEON) and __ARM_NEON
void Crop::crop_neon(const vision::VTensor& src, vision::VTensor& dst, const vision::VRect& rect) {
    int crop_left   = static_cast<int>(rect.left);
    int crop_top    = static_cast<int>(rect.top);
    int crop_width  = static_cast<int>(rect.width());
    int crop_height = static_cast<int>(rect.height());
...
void Crop::crop_neon_hwc_rgb_ir(const vision::VTensor& src, vision::VTensor& dst,
                                int crop_left, int crop_top, int crop_width, int crop_height) {
    if (src.dType == INT8) {
        dst.create(crop_width, crop_height, src.c, NHWC, INT8);
...
void Crop::crop_neon_chw_rgb(const vision::VTensor& src, vision::VTensor& dst,
                             int crop_left, int crop_top, int crop_width, int crop_height) {
    if (src.dType == INT8) {
        dst.create(crop_width, crop_height, src.c, NCHW, INT8);
        uint8_t* src_data = (uint8_t*)src.data;
