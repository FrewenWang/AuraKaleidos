...
static ConvertToParam::TupleTable g_convert_to_table_cl
{
    // src_type
    {
...
NEW_TESTCASE(matrix, ConvertTo, opencl)
{
    MatrixConvertToTest matrix_convert_to_test(UnitTest::GetInstance()->GetContext(), g_convert_to_table_cl);
