...
void VPoint::toString(std::stringstream &ss) const {
    ss << "{x = " << x << ", y = " << y << "}";
}

void VPoint::setValue(float _x, float _y) {
    x = _x;
    y = _y;
}
...
void VPoint3::toString(std::stringstream &ss) const {
    ss << "{x = " << x << ", y = " << y << ", z = " << z << "}";
}
...
void VAngle::toString(std::stringstream &ss) const {
    ss << "{yaw = " << yaw << ", pitch = " << pitch << ", roll = " << roll << "}";
}
...
void VRect::toString(std::stringstream &ss) const {
    ss << "{l = " << left << ", t = " << top << "r = " << right << ", b = " << bottom << "}";
}
...
void VEyeInfo::toString(std::stringstream &ss) const {
...
void VMatrix::toString(std::stringstream &ss) const {
    ss << "{x = " << x << ", y = " << y << ", z = " << z << "}";
}
...
void VState::toString(std::stringstream &ss) const {
    //    ss << "{state = " << state << ", ctime = " << continue_time << ", tcount = " << trigger_count << "}";
    ss << "{state = " << state << ", ctime = ..." << ", tcount = " << trigger_count << "}";
}
