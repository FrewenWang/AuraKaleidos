...
static BilateralParam::TupleTable g_bilateral_table_none {
    // element
    {
        ElemType::U8,
        ElemType::F32,
...
NEW_TESTCASE(filter, Bilateral, none)
{
    BilateralTest test(UnitTest::GetInstance()->GetContext(), g_bilateral_table_none);
