        ...
        for i, anno_path in enumerate(self.anno_path):
            with open(anno_path, 'r') as fr:
                while True:
                    ...
                    #加数据
                    elif "/widerMoreFace/" in pathimg1 or  "/openImageMoreface/" in pathimg1 or  "/jidu_data/" in pathimg1 or  "/jidu_data_1107/" in pathimg1 or  "/jidu_data_1108/" in pathimg1 or  "/jidu_data_0112/" in pathimg1 or  "/jidu_data_0227/" in pathimg1 or  "/jidu_data_0227_fl/" in pathimg1:
                    ...
                    is_fl = False
                    #加反例
                    if "/jidu_data_0227/" in pathimg1 or  "/jidu_data_0227_fl/" in pathimg1 :
                        is_fl = True 
                    ...
                    if ".jpg.txt" in jsonname:
                        ...
                        if len(box_label) == 0 and not is_fl:
                            continue
