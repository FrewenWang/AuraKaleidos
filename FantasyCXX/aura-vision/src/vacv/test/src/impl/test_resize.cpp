...
static const char* TAG = "TestResize";
...
std::vector<double> TestResize::test_resize_bilinear_hwc_u8_320x180() {
    ...
    double vacv_duration;
    {
        ...
        va_cv::resize(src_tensor, vacv_resize_bilinear_hwc_u8_tensor, vacv_size_320x180, 0, 0, va_cv::INTER_NEAREST);
    }

    float cosine_distance = FaceIdUtil::compare_image_data((char*)cv_resize320x180_mat.data,
...
std::vector<double> TestResize::test_resize_bilinear_chw_u8_320x180() {
    ...
    {
        TIME_PERF(vacv_duration);
        va_cv::resize(src_tensor_chw, vacv_resize_bilinear_chw_u8_tensor, vacv_size_320x180, 0, 0, va_cv::INTER_NEAREST);
    }
...
std::vector<double> TestResize::test_resize_bilinear_hwc_fp32_320x180() {
    ...
    {
        TIME_PERF(vacv_duration);
        va_cv::resize(src_tensor, vacv_resize_bilinear_hwc_fp32_tensor, vacv_size_320x180, 0, 0, va_cv::INTER_NEAREST);
    }

    float cosine_distance = FaceIdUtil::compare_image_data((float*)cv_resize320x180_mat.data,
...
std::vector<double> TestResize::test_resize_bilinear_chw_fp32_320x180() {
    ...
    {
        TIME_PERF(vacv_duration);
        va_cv::resize(src_tensor_chw, vacv_resize_bilinear_chw_fp32_tensor, vacv_size_320x180, 0, 0, va_cv::INTER_NEAREST);
    }
...
std::vector<double> TestResize::test_resize_cubic_hwc_fp32_320x180() {
    ...
    {
        TIME_PERF(vacv_duration);
        va_cv::resize(src_tensor_fp32, vacv_resize_bilinear_hwc_fp32_tensor, vacv_size_320x180, 0, 0, va_cv::INTER_CUBIC);
    }
...
std::vector<double> TestResize::test_resize_cubic_chw_fp32_320x180() {
    ...
    {
        TIME_PERF(vacv_duration);
        va_cv::resize(src_tensor_fp32, vacv_resize_bilinear_chw_fp32_tensor, vacv_size_320x180, 0, 0, va_cv::INTER_CUBIC);
    }
    Tensor vacv_resize_bilinear_hwc_fp32_tensor = vacv_resize_bilinear_chw_fp32_tensor.change_layout(NHWC);
    float cosine_distance = FaceIdUtil::compare_image_data((float*)cv_resize320x180_mat.data,
                                                           (float*)vacv_resize_bilinear_hwc_fp32_tensor.data,
