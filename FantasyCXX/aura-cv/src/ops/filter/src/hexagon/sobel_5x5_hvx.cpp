...
const static MI_S8 g_kernel_tabel[5][5] =
{
    { 1,  4,  6,  4, 1},
    {-1, -2,  0,  2, 1},
    { 1,  0, -2,  0, 1},
...
AURA_ALWAYS_INLINE AURA_VOID Sobel5x5VCore(HVX_Vector &vu8_src_p1, HVX_Vector &vu8_src_p0, HVX_Vector &vu8_src_c,
                                         HVX_Vector &vu8_src_n0, HVX_Vector &vu8_src_n1, HVX_VectorPair &ws16_sum, const MI_U8 *kernel_y)
{
    MI_U32 k0k0k0k0 = Q6_R_vsplatb_R(kernel_y[0]);
    MI_U32 k2k1k2k1 = (kernel_y[2] << 24) | (kernel_y[1] << 16) | (kernel_y[2] << 8) | kernel_y[1];
    MI_U32 k4k3k4k3 = (kernel_y[4] << 24) | (kernel_y[3] << 16) | (kernel_y[4] << 8) | kernel_y[3];

    ws16_sum = Q6_Wh_vmpy_VubRb(vu8_src_p1, k0k0k0k0);
    ws16_sum = Q6_Wh_vmpaacc_WhWubRb(ws16_sum, Q6_W_vcombine_VV(vu8_src_c,  vu8_src_p0), k2k1k2k1);
    ws16_sum = Q6_Wh_vmpaacc_WhWubRb(ws16_sum, Q6_W_vcombine_VV(vu8_src_n1, vu8_src_n0), k4k3k4k3);
}

// using St = MI_U8, Dt = S16
template <typename St, typename Dt, typename std::enable_if<std::is_same<St, MI_U8>::value && std::is_same<Dt, MI_S16>::value>::type* = MI_NULL>
AURA_ALWAYS_INLINE AURA_VOID Sobel5x5HCore(HVX_VectorPair &ws16_sum_x0, HVX_VectorPair &ws16_sum_x1, HVX_VectorPair &ws16_sum_x2,
                                         HVX_Vector &vs16_result_lo, HVX_Vector &vs16_result_hi, const MI_S8 *kernel_x)
{
    constexpr MI_S32 ALIGN = sizeof(Dt);

    MI_U32 k0k0k0k0            = Q6_R_vsplatb_R(kernel_x[0]);
    MI_U32 k1k1k1k1            = Q6_R_vsplatb_R(kernel_x[1]);
    MI_U32 k2k2k2k2            = Q6_R_vsplatb_R(kernel_x[2]);
    MI_U32 k3k3k3k3            = Q6_R_vsplatb_R(kernel_x[3]);
    MI_U32 k4k4k4k4            = Q6_R_vsplatb_R(kernel_x[4]);

    HVX_Vector vs16_sum_x1_lo  = Q6_V_lo_W(ws16_sum_x1);
    HVX_Vector vs16_sum_x1_hi  = Q6_V_hi_W(ws16_sum_x1);

    HVX_Vector vs16_sum_l0_lo  = Q6_V_vlalign_VVR(vs16_sum_x1_lo, Q6_V_lo_W(ws16_sum_x0), ALIGN);
    ...
    HVX_Vector vs16_sum_r0_hi  = Q6_V_valign_VVR(Q6_V_hi_W(ws16_sum_x2), vs16_sum_x1_hi, ALIGN);

    HVX_Vector vs16_sum_lo     = Q6_Vh_vmpyi_VhRb(vs16_sum_l0_lo, k0k0k0k0);
    vs16_sum_lo                = Q6_Vh_vmpyiacc_VhVhRb(vs16_sum_lo, vs16_sum_l0_hi, k1k1k1k1);
    vs16_sum_lo                = Q6_Vh_vmpyiacc_VhVhRb(vs16_sum_lo, vs16_sum_c_lo,  k2k2k2k2);
    vs16_sum_lo                = Q6_Vh_vmpyiacc_VhVhRb(vs16_sum_lo, vs16_sum_c_hi,  k3k3k3k3);
    vs16_sum_lo                = Q6_Vh_vmpyiacc_VhVhRb(vs16_sum_lo, vs16_sum_r0_lo, k4k4k4k4);
    HVX_Vector vs16_sum_hi     = Q6_Vh_vmpyi_VhRb(vs16_sum_l0_hi, k0k0k0k0);
    vs16_sum_hi                = Q6_Vh_vmpyiacc_VhVhRb(vs16_sum_hi, vs16_sum_c_lo,  k1k1k1k1);
    vs16_sum_hi                = Q6_Vh_vmpyiacc_VhVhRb(vs16_sum_hi, vs16_sum_c_hi,  k2k2k2k2);
    vs16_sum_hi                = Q6_Vh_vmpyiacc_VhVhRb(vs16_sum_hi, vs16_sum_r0_lo, k3k3k3k3);
    vs16_sum_hi                = Q6_Vh_vmpyiacc_VhVhRb(vs16_sum_hi, vs16_sum_r0_hi, k4k4k4k4);
...
template <typename St, typename Dt, typename std::enable_if<std::is_same<St, MI_U8>::value && std::is_same<Dt, MI_S16>::value>::type* = MI_NULL>
AURA_ALWAYS_INLINE AURA_VOID Sobel5x5HCore(HVX_VectorPair &ws16_sum_x0, HVX_VectorPair &ws16_sum_x1, HVX_VectorPair &ws16_sum_x2, HVX_VectorPair &ws16_sum_x3,
                                         HVX_Vector &vs16_result_x0_lo, HVX_Vector &vs16_result_x0_hi, HVX_Vector &vs16_result_x1_lo, HVX_Vector &vs16_result_x1_hi,
                                         const MI_S8 *kernel_x, MI_S32 rest)
{
    ...
    if (rest & 1)
    {
        MI_S32 align_size0 = (rest / 2) * sizeof(Dt);
        MI_S32 align_size1 = align_size0 + sizeof(Dt);
    ...
    {
        MI_S32 align_size  = (rest / 2) * sizeof(Dt);
    ...
    Sobel5x5HCore<St, Dt>(ws16_sum_x0, ws16_sum_x1, ws16_sum_r0, vs16_result_x0_lo, vs16_result_x0_hi,kernel_x);
    Sobel5x5HCore<St, Dt>(ws16_sum_l0, ws16_sum_x2, ws16_sum_x3, vs16_result_x1_lo, vs16_result_x1_hi, kernel_x);
}
...
static AURA_VOID Sobel5x5Row(const St *src_p1, const St *src_p0, const St *src_c, const St *src_n0, const St *src_n1, Dt *dst,
                           const MI_S8 *kernel_x, const MI_S8 *kernel_y, MI_F32 scale, const std::vector<St> &border_value, MI_S32 width)
{
    ...
    // left border
    {
        ...
        {
            HVX_Vector v_p1_border = GetBorderVector<St, BORDER_TYPE, BorderArea::LEFT>(mv_src_p1.val[ch], src_p1[ch], border_value[ch]);
            ...
            HVX_Vector v_n1_border = GetBorderVector<St, BORDER_TYPE, BorderArea::LEFT>(mv_src_n1.val[ch], src_n1[ch], border_value[ch]);

            Sobel5x5VCore<St, Dt>(v_p1_border, v_p0_border, v_c_border, v_n0_border, v_n1_border, mw_sum_x0.val[ch], (MI_U8 *)kernel_y);
            Sobel5x5VCore<St, Dt>(mv_src_p1.val[ch], mv_src_p0.val[ch], mv_src_c.val[ch], mv_src_n0.val[ch], mv_src_n1.val[ch], mw_sum_x1.val[ch], (MI_U8 *)kernel_y);
        }
    }
    ...
    // main(0 ~ n-2)
    {
        for (MI_S32 x = SRC_ELEM_COUNTS; x <= back_offset; x += SRC_ELEM_COUNTS)
        {
            ...
            for (MI_S32 ch = 0; ch < C; ch++)
            {
                Sobel5x5VCore<St, Dt>(mv_src_p1.val[ch], mv_src_p0.val[ch], mv_src_c.val[ch], mv_src_n0.val[ch], mv_src_n1.val[ch], mw_sum_x2.val[ch], (MI_U8 *)kernel_y);
                Sobel5x5HCore<St, Dt>(mw_sum_x0.val[ch], mw_sum_x1.val[ch], mw_sum_x2.val[ch], mv_result_lo.val[ch], mv_result_hi.val[ch], kernel_x);
                if (WITH_SCALE)
                {
    ...
    // remain
    {
        ...
        for (MI_S32 ch = 0; ch < C; ch++)
        {
            HVX_Vector v_p1_border = GetBorderVector<St, BORDER_TYPE, BorderArea::RIGHT>(mv_src_p1.val[ch], src_p1[last + ch], border_value[ch]);
            ...
            HVX_Vector v_n1_border = GetBorderVector<St, BORDER_TYPE, BorderArea::RIGHT>(mv_src_n1.val[ch], src_n1[last + ch], border_value[ch]);

            Sobel5x5VCore<St, Dt>(mv_src_p1.val[ch], mv_src_p0.val[ch], mv_src_c.val[ch], mv_src_n0.val[ch], mv_src_n1.val[ch], mw_sum_x2.val[ch], (MI_U8 *)kernel_y);
            Sobel5x5VCore<St, Dt>(v_p1_border, v_p0_border, v_c_border, v_n0_border, v_n1_border, mw_sum_x3.val[ch], (MI_U8 *)kernel_y);

            Sobel5x5HCore<St, Dt>(mw_sum_x0.val[ch],    mw_sum_x1.val[ch],    mw_sum_x2.val[ch],  mw_sum_x3.val[ch],
                                  mv_result_lo.val[ch], mv_result_hi.val[ch], mv_last_lo.val[ch], mv_last_hi.val[ch],
                                  kernel_x, rest);
            if (WITH_SCALE)
            {
                SobelPostProcess(mv_result_lo.val[ch], mv_result_hi.val[ch], scale);
...
template <typename St, typename Dt, BorderType BORDER_TYPE, MI_S32 C, MI_BOOL WITH_SCALE>
static Status Sobel5x5HvxImpl(const Mat &src, Mat &dst, MI_S8 *kernel_x, MI_S8 *kernel_y, MI_F32 scale, const std::vector<St> &border_value,
                              const St *border_buffer, MI_S32 start_row, MI_S32 end_row)
{
    ...
    for (MI_S32 y = start_row; y < end_row; y++)
    {
        if (y + 3 < height)
        {
            L2Fetch(reinterpret_cast<MI_U32>(src.Ptr<St>(y + 3)), L2fetch_param);
        }

        Dt *dst_row = dst.Ptr<Dt>(y);
        Sobel5x5Row<St, Dt, BORDER_TYPE, C, WITH_SCALE>(src_p1, src_p0, src_c, src_n0, src_n1, dst_row, kernel_x, kernel_y, scale, border_value, width);
...
static Status Sobel5x5HvxHelper(Context *ctx, const Mat &src, Mat &dst, MI_S32 dx, MI_S32 dy, MI_F32 scale,
                                const std::vector<St> &border_value, const St *border_buffer)
{
    ...
    MI_S8  *kernel_x    = const_cast<MI_S8 *>(g_kernel_tabel[dx]);
    MI_S8  *kernel_y    = const_cast<MI_S8 *>(g_kernel_tabel[dy]);
    MI_S32 height       = dst.GetSizes().m_height;

    if (NearlyEqual(scale, 1.f))
    {
        ret = wp->ParallelFor((MI_S32)0, height, Sobel5x5HvxImpl<St, Dt, BORDER_TYPE, C, MI_FALSE>,
                              std::cref(src), std::ref(dst), kernel_x, kernel_y, scale, std::cref(border_value), border_buffer);
        if (ret != Status::OK)
        {
            AURA_ADD_ERROR_STRING(ctx, "Sobel5x5HvxImpl<St, Dt, BORDER_TYPE, C, MI_FALSE> failed");
        }
    }
    else
    {
        ret = wp->ParallelFor((MI_S32)0, height, Sobel5x5HvxImpl<St, Dt, BORDER_TYPE, C, MI_TRUE>,
                              std::cref(src), std::ref(dst), kernel_x, kernel_y, scale, std::cref(border_value), border_buffer);
        if (ret != Status::OK)
        {
            AURA_ADD_ERROR_STRING(ctx, "Sobel5x5HvxImpl<St, Dt, BORDER_TYPE, C, MI_TRUE> failed");
        }
    }
                                ...
                                const std::vector<St> &border_value, const St *border_buffer)
{
    ...
    switch (src.GetSizes().m_channel)
    {
        case 1:
        {
            ret = Sobel5x5HvxHelper<St, Dt, BORDER_TYPE, 1>(ctx, src, dst, dx, dy, scale, border_value, border_buffer);
            break;
        }

        case 2:
        {
            ret = Sobel5x5HvxHelper<St, Dt, BORDER_TYPE, 2>(ctx, src, dst, dx, dy, scale, border_value, border_buffer);
            break;
        }

        case 3:
        {
            ret = Sobel5x5HvxHelper<St, Dt, BORDER_TYPE, 3>(ctx, src, dst, dx, dy, scale, border_value, border_buffer);
            break;
        }
                                ...
                                BorderType border_type, const Scalar &border_value)
{
    ...
    switch (border_type)
    {
        case BorderType::CONSTANT:
        {
            ...
            ret = Sobel5x5HvxHelper<St, Dt, BorderType::CONSTANT>(ctx, src, dst, dx, dy, scale, vec_border_value, border_buffer);
        ...
        {
            ret = Sobel5x5HvxHelper<St, Dt, BorderType::REPLICATE>(ctx, src, dst, dx, dy, scale, vec_border_value, border_buffer);
            break;
        }

        case BorderType::REFLECT_101:
        {
            ret = Sobel5x5HvxHelper<St, Dt, BorderType::REFLECT_101>(ctx, src, dst, dx, dy, scale, vec_border_value, border_buffer);
            break;
        }
                   ...
                   BorderType border_type, const Scalar &border_value)
{
    ...
    switch (pattern)
    {
        ...
        {
            ret = Sobel5x5HvxHelper<MI_U8, MI_S16>(ctx, src, dst, dx, dy, scale, border_type, border_value);
            break;
        }
        default:
        {
