...
static WarpAffineParam::TupleTable g_warpaffine_table_opencl
{
    // elem_type
    {
        ElemType::U8,
...
NEW_TESTCASE(warp, Warpaffine, opencl)
{
    WarpAffineTest test(UnitTest::GetInstance()->GetContext(), g_warpaffine_table_opencl);
