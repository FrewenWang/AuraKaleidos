...
AURA_ALWAYS_INLINE AURA_VOID BoxFilter5x5VCore(const HVX_Vector &vu8_src_p0, const HVX_Vector &vu8_src_n0, HVX_VectorPair &ws16_result)
{
    ws16_result = Q6_Wh_vsub_VubVub(vu8_src_n0, vu8_src_p0);
}

template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, MI_U8>::value>::type* = MI_NULL>
AURA_ALWAYS_INLINE AURA_VOID BoxFilter5x5HCore(HVX_VectorPair &ws16_diff0, HVX_VectorPair &ws16_diff1, HVX_VectorPair &ws16_diff2,
                                             HVX_Vector &vu8_result, const SumType *row_sum, MI_S32 row_sum_step)
{
    ...
    HVX_Vector vu16_dst_odd  = vdiv_n<MI_U16, 25>(vs16_sum_odd);
    HVX_Vector vu16_dst_even = vdiv_n<MI_U16, 25>(vs16_sum_even);

    vu8_result = Q6_Vub_vsat_VhVh(vu16_dst_odd, vu16_dst_even);
}

template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, MI_U8>::value>::type* = MI_NULL>
AURA_ALWAYS_INLINE AURA_VOID BoxFilter5x5FirstRowVCore(const HVX_Vector &vu8_src_p1, const HVX_Vector &vu8_src_p0, const HVX_Vector &vu8_src_c,
...
template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, MI_U8>::value>::type* = MI_NULL>
AURA_ALWAYS_INLINE AURA_VOID BoxFilter5x5FirstRowHCore(HVX_VectorPair &ws16_sum0, HVX_VectorPair &ws16_sum1, HVX_VectorPair &ws16_sum2,
                                                     HVX_Vector &vu8_result, const SumType *row_sum, MI_S32 row_sum_step)
{
...
AURA_ALWAYS_INLINE AURA_VOID BoxFilter5x5VCore(const HVX_Vector &vu16_src_p0, const HVX_Vector &vu16_src_n0, HVX_VectorPair &ws32_result)
{
    ws32_result = Q6_Ww_vsub_VuhVuh(vu16_src_n0, vu16_src_p0);
}

template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, MI_U16>::value>::type* = MI_NULL>
AURA_ALWAYS_INLINE AURA_VOID BoxFilter5x5HCore(HVX_VectorPair &ws32_diff0, HVX_VectorPair &ws32_diff1, HVX_VectorPair &ws32_diff2,
                                             HVX_Vector &vu16_result, const SumType *row_sum, MI_S32 row_sum_step)
{
    ...
    HVX_Vector vu32_dst_odd  = vdiv_n<MI_U32, 25>(vs32_sum_odd);
    HVX_Vector vu32_dst_even = vdiv_n<MI_U32, 25>(vs32_sum_even);
    vu16_result = Q6_Vuh_vsat_VuwVuw(vu32_dst_odd, vu32_dst_even);
}

template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, MI_U16>::value>::type* = MI_NULL>
AURA_ALWAYS_INLINE AURA_VOID BoxFilter5x5FirstRowVCore(const HVX_Vector &vu16_src_p1, const HVX_Vector &vu16_src_p0, const HVX_Vector &vu16_src_c,
...
template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, MI_U16>::value>::type* = MI_NULL>
AURA_ALWAYS_INLINE AURA_VOID BoxFilter5x5FirstRowHCore(HVX_VectorPair &ws32_sum0, HVX_VectorPair &ws32_sum1, HVX_VectorPair &ws32_sum2,
                                                     HVX_Vector &vu16_result, const SumType *row_sum, MI_S32 row_sum_step)
{
...
AURA_ALWAYS_INLINE AURA_VOID BoxFilter5x5VCore(const HVX_Vector &vs16_src_p1, const HVX_Vector &vs16_src_n1, HVX_VectorPair &ws32_result)
{
                                             ...
                                             HVX_Vector &vs16_result, const SumType *row_sum, MI_S32 row_sum_step)
{
    ...
    HVX_Vector vs32_dst_odd  = vdiv_n<MI_S32, 25>(vs32_sum_odd);
    HVX_Vector vs32_dst_even = vdiv_n<MI_S32, 25>(vs32_sum_even);

    vs16_result = Q6_Vh_vsat_VwVw(vs32_dst_odd, vs32_dst_even);
}

template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, MI_S16>::value>::type* = MI_NULL>
AURA_ALWAYS_INLINE AURA_VOID BoxFilter5x5FirstRowVCore(const HVX_Vector &vs16_src_p1, const HVX_Vector &vs16_src_p0, const HVX_Vector &vs16_src_c,
...
AURA_ALWAYS_INLINE AURA_VOID BoxFilter5x5HCore(HVX_VectorPair &w_sum_x0, HVX_VectorPair &w_sum_x1, HVX_VectorPair &w_sum_x2, HVX_VectorPair &w_sum_x3,
...
template <typename Tp, typename SumType>
AURA_ALWAYS_INLINE AURA_VOID BoxFilter5x5FirstRowHCore(HVX_VectorPair &w_sum_x0, HVX_VectorPair &w_sum_x1, HVX_VectorPair &w_sum_x2, HVX_VectorPair &w_sum_x3,
                                                     HVX_Vector &v_result_x0, HVX_Vector &v_result_x1, SumType *row_sum, MI_S32 row_sum_step, MI_S32 rest)
{
    HVX_Vector v_sum_x0_lo = Q6_V_lo_W(w_sum_x0);
    HVX_Vector v_sum_x0_hi = Q6_V_hi_W(w_sum_x0);
...
static AURA_VOID BoxFilter5x5Row(const Tp *src_p0, const Tp *src_n0, Tp *dst, MI_S32 width, SumType *row_sum, MI_S32 row_sum_step,
...
template <typename Tp, typename SumType, BorderType BORDER_TYPE, MI_S32 C>
static AURA_VOID BoxFilter5x5FirstRow(const Tp *src_p1, const Tp *src_p0, const Tp *src_c, const Tp *src_n0, const Tp *src_n1, Tp *dst,
...
static Status BoxFilter5x5HvxHelper(Context *ctx, const Mat &src, Mat &dst, const std::vector<Tp> &border_value, const Tp *border_buffer)
{
    ...
    switch (channel)
    {
        case 1:
        {
            ret = wp->ParallelFor((MI_S32)0, height, BoxFilter5x5HvxImpl<Tp, SumType, BORDER_TYPE, 1>,
        ...
        case 2:
        {
            ret = wp->ParallelFor((MI_S32)0, height, BoxFilter5x5HvxImpl<Tp, SumType, BORDER_TYPE, 2>,
                                  ctx, std::cref(src), std::ref(dst), std::ref(row_sum_buffer), std::cref(border_value), border_buffer);
            break;
        }
        ...
        case 3:
        {
            ret = wp->ParallelFor((MI_S32)0, height, BoxFilter5x5HvxImpl<Tp, SumType, BORDER_TYPE, 3>,
                                  ctx, std::cref(src), std::ref(dst), std::ref(row_sum_buffer), std::cref(border_value), border_buffer);
            break;
        }
...
Status BoxFilter5x5Hvx(Context *ctx, const Mat &src, Mat &dst, BorderType border_type, const Scalar &border_value)
{
    ...
    switch (src.GetElemType())
    {
        case ElemType::U8:
        {
            ret = BoxFilter5x5HvxHelper<MI_U8, MI_S16>(ctx, src, dst, border_type, border_value);
            break;
        }

        case ElemType::U16:
        {
            ret = BoxFilter5x5HvxHelper<MI_U16, MI_S32>(ctx, src, dst, border_type, border_value);
            break;
        }

        case ElemType::S16:
        {
            ret = BoxFilter5x5HvxHelper<MI_S16, MI_S32>(ctx, src, dst, border_type, border_value);
            break;
        }
