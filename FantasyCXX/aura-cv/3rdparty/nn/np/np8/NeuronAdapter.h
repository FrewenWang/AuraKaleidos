...
typedef enum {
     ...
     * depends on the original iauras' shape ([batches, height, width, channels]).
     ...
     * Note:
     * If iaura mode is YUV420_8BITS, use NEURON_TENSOR_QUANT8_ASYMM; if mode is
     ...
     * YUV420 H-axis pitch. Set to the original compressed iaura height with video
     * codec alignment.
     * * 11: outPitchW, an {@link NEURON_INT32} scalar, specifying the
     * YUV420 W-axis pitch. Set to the original compressed iaura width with video
     * codec alignment.
     ...
     * YUV420_10BITS formats. AFBC (Arm Frame Buffer Compression) is a lossless compressed iaura
     * format, created by ARM to reduce the size of iauras.
     *
     * For input part, need to set two inputs with different shape, representing Y
     ...
     * channel size should be 1; for UV plane, channel size should be 2. Besides,
     * the height and width of UV plane should be half of Y's height and width.
     * For AFBC output, its height should be 3/2 of Y's height, and its width equals to Y's width.
     * Example:
     *
     *      original_img.shape = [1, 384, 640, 3]
     *      inputY.shape = [1, 384, 640, 1]
     ...
     * YUV420 H-axis pitch. Set to the expected compressed iaura height.
     * * 10: inPitchW, an {@link NEURON_INT32} scalar, specifying the
     * YUV420 W-axis pitch. Set to the expected compressed iaura height.
