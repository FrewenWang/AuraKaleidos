...
static LaplacianParam::TupleTable g_laplacian_table_cl {
    // element type
    {
...
NEW_TESTCASE(filter, Laplacian, opencl)
{
    LaplacianTest test(UnitTest::GetInstance()->GetContext(), g_laplacian_table_cl);
