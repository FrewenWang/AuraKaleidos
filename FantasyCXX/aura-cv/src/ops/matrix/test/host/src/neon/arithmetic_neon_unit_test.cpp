...
static ArithmeticParam::TupleTable g_arithmetic_table_neon
{
    // element type src
    {
        ElemType::U8,
...
NEW_TESTCASE(matrix, Arithmetic, neon)
{
    ArithmeticTest arithmetic_test(UnitTest::GetInstance()->GetContext(), g_arithmetic_table_neon);
