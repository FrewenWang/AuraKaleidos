...
def main_facept_img():
    facedetect = FaceDetectOnnx(pathModel="../models/onnx_models/FaceDetection1107V4Main_noquant.onnx")
    net_inputH = 192
    net_inputW = 192
    ...
    img = cv.imread("/home/frewen/Pictures/dms_call_1/946686129299.jpg")
    ...
    for boxitem in boxRslt:
        ...
        l, t, r, b = map(int, [l, t, r, b])
        imgface = img[t:b, l:r, :]
        # cv2.imwrite("demo_face.jpg", imgface)
