...
static const char* TAG = "Test_Warp_Affine";
...
std::vector<double> TestWarpAffine::test_warp_affine_hwc_u8() {
    ...
    float cosine_distance = FaceIdUtil::compare_image_data((char*)mat_warpped.data,
...
std::vector<double> TestWarpAffine::test_warp_affine_chw_fp32() {
    ...
    float cosine_distance = FaceIdUtil::compare_image_data((float*)mat_warpped.data,
