...
kernel void SobelRemain5x5C2(global St *src, int istep,
                             ...
                             int main_width, struct Scalar border_value)
{
    ...
    v2it_result = v16it_sum.s01 * (V2InterType)h0 + v16it_sum.s23 * (V2InterType)h1 +
                  v16it_sum.s45 * (V2InterType)h2 + v16it_sum.s67 * (V2InterType)h3 +
                  v16it_sum.s89 * (V2InterType)h4;
