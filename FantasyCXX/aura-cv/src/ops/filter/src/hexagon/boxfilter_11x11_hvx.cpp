...
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11VCore(const HVX_Vector &vu8_src_p0, const HVX_Vector &vu8_src_n0, HVX_VectorPair &ws16_result)
{
    ws16_result = Q6_Wh_vsub_VubVub(vu8_src_n0, vu8_src_p0);
}

template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, DT_U8>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11VCore(const HVX_Vector &vu8_src_p0, const HVX_Vector &vu8_src_n0,
...
template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, DT_U8>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11HCore(HVX_VectorPair &ws16_diff0, HVX_VectorPair &ws16_diff1,
                                               ...
                                               HVX_Vector &vu8_result, const SumType *row_sum, DT_S32 row_sum_step)
{
    ...
    *row_sum_data_out++ = vs16_com_sumo;
    ...
    HVX_Vector vu16_dst_odd  = vdiv_n<DT_U16, 121>(vs16_com_sumo);
    HVX_Vector vu16_dst_even = vdiv_n<DT_U16, 121>(vs16_com_sume);

    vu8_result = Q6_Vub_vsat_VhVh(vu16_dst_odd, vu16_dst_even);
}

template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, DT_U8>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11HCore(HVX_VectorPair &ws16_diff_x0, HVX_VectorPair &ws16_diff_x1,
...
template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, DT_U8>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11FirstRowVCore(const HVX_Vector &vu8_src_p4, const HVX_Vector &vu8_src_p3,
...
template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, DT_U8>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11FirstRowVCore(const HVX_Vector &vu8_src_p4l0, const HVX_Vector &vu8_src_p3l0, const HVX_Vector &vu8_src_p2l0,
...
template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, DT_U8>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11FirstRowHCore(HVX_VectorPair &ws16_sum0, HVX_VectorPair &ws16_sum1,
...
template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, DT_U8>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11FirstRowHCore(HVX_VectorPair &wu16_sum_x0, HVX_VectorPair &wu16_sum_x1, HVX_VectorPair &wu16_sum_x2, HVX_VectorPair &wu16_sum_x3,
                                                       HVX_Vector &vu8_result_x0, HVX_Vector &vu8_result_x1, SumType *row_sum, DT_S32 row_sum_step, DT_S32 rest)
{
...
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11VCore(const HVX_Vector &vu16_src_p0, const HVX_Vector &vu16_src_n0, HVX_VectorPair &ws32_result)
{
    ws32_result = Q6_Ww_vsub_VuhVuh(vu16_src_n0, vu16_src_p0);
}

template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, DT_U16>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11VCore(const HVX_Vector &vu16_src_p0, const HVX_Vector &vu16_src_n0,
...
template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, DT_U16>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11HCore(HVX_VectorPair &ws32_diff0, HVX_VectorPair &ws32_diff1,
                                               ...
                                               const SumType *row_sum, DT_S32 row_sum_step)
{
    ...
    *row_sum_data_out++ = vs32_sum_odd;
    ...
    HVX_Vector vu32_dst_odd  = vdiv_n<DT_U32, 121>(vs32_sum_odd);
    HVX_Vector vu32_dst_even = vdiv_n<DT_U32, 121>(vs32_sum_even);

    vu16_result = Q6_Vuh_vsat_VuwVuw(vu32_dst_odd, vu32_dst_even);
}

template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, DT_U16>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11FirstRowVCore(const HVX_Vector &vu16_src_p4, const HVX_Vector &vu16_src_p3, const HVX_Vector &vu16_src_p2,
...
template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, DT_U16>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11FirstRowVCore(const HVX_Vector &vu16_src_p4l0, const HVX_Vector &vu16_src_p3l0, const HVX_Vector &vu16_src_p2l0,
...
template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, DT_U16>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11FirstRowHCore(HVX_VectorPair &ws32_sum0, HVX_VectorPair &ws32_sum1,
...
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11VCore(const HVX_Vector &vs16_src_p1, const HVX_Vector &vs16_src_n1, HVX_VectorPair &ws32_result)
{
    ws32_result = Q6_Ww_vsub_VhVh(vs16_src_n1, vs16_src_p1);
}

template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, DT_S16>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11VCore(const HVX_Vector &vs16_src_p0, const HVX_Vector &vs16_src_n0,
                                               ...
                                               const SumType *row_sum, DT_S32 row_sum_step)
{
    ...
    *row_sum_data_out++ = vs32_sum_odd;
    ...
    HVX_Vector vs32_dst_odd  = vdiv_n<DT_S32, 121>(vs32_sum_odd);
    HVX_Vector vs32_dst_even = vdiv_n<DT_S32, 121>(vs32_sum_even);

    vs16_result = Q6_Vh_vsat_VwVw(vs32_dst_odd, vs32_dst_even);
}

template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, DT_S16>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11FirstRowVCore(const HVX_Vector &vs16_src_p4, const HVX_Vector &vs16_src_p3, const HVX_Vector &vs16_src_p2,
...
template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, DT_S16>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11FirstRowVCore(
...
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11HCore(HVX_VectorPair &ws32_diff_x0, HVX_VectorPair &ws32_diff_x1,
...
template <typename Tp, typename SumType, typename std::enable_if<std::is_same<Tp, DT_S16>::value || std::is_same<Tp, DT_U16>::value>::type* = DT_NULL>
AURA_ALWAYS_INLINE DT_VOID BoxFilter11x11FirstRowHCore(HVX_VectorPair &wd32_sum_x0, HVX_VectorPair &wd32_sum_x1,
...
static DT_VOID BoxFilter11x11Row(const Tp *src_p0, const Tp *src_n0, Tp *dst, DT_S32 width, SumType *row_sum, DT_S32 row_sum_step,
...
template <typename Tp, typename SumType, BorderType BORDER_TYPE, DT_S32 C>
static DT_VOID BoxFilter11x11FirstRow(const Tp *src_p4, const Tp *src_p3, const Tp *src_p2, const Tp *src_p1, const Tp *src_p0, const Tp *src_c,
                                    ...
                                    const Tp *border_buffer, DT_S32 start_row, DT_S32 end_row)
{
    ...
    DT_S32 thread_idx = ctx->GetWorkerPool()->GetComputeThreadIdx();
    ...
    for (DT_S32 y = start_row + 1; y < end_row; y++)
    {
        if (y + 6 < height)
        {
            L2Fetch(reinterpret_cast<DT_U32>(src.Ptr<Tp>(y + 6)), L2fetch_param);
        }
...
static Status BoxFilter11x11HvxHelper(Context *ctx, const Mat &src, Mat &dst, const std::vector<Tp> &border_value, const Tp *border_buffer)
{
    ...
    DT_VOID *buffer_sum = AURA_ALLOC(ctx, wp->GetComputeThreadNum() * (sum_size * sizeof(SumType) * channel));
    if (DT_NULL == buffer_sum)
    {
    ...
    switch (channel)
    {
        case 1:
        {
            ret = wp->ParallelFor((DT_S32)0, height, BoxFilter11x11HvxImpl<Tp, SumType, BORDER_TYPE, 1>,
        ...
        case 2:
        {
            ret = wp->ParallelFor((DT_S32)0, height, BoxFilter11x11HvxImpl<Tp, SumType, BORDER_TYPE, 2>,
                                  ctx, std::cref(src), std::ref(dst), std::ref(buffer_sum_idx), std::cref(border_value), border_buffer);
            break;
        }
        ...
        case 3:
        {
            ret = wp->ParallelFor((DT_S32)0, height, BoxFilter11x11HvxImpl<Tp, SumType, BORDER_TYPE, 3>,
                                  ctx, std::cref(src), std::ref(dst), std::ref(buffer_sum_idx), std::cref(border_value), border_buffer);
            break;
        }
...
Status BoxFilter11x11Hvx(Context *ctx, const Mat &src, Mat &dst, BorderType border_type, const Scalar &border_value)
{
    ...
    switch (src.GetElemType())
    {
        case ElemType::U8:
        {
            ret = BoxFilter11x11HvxHelper<DT_U8, DT_S16>(ctx, src, dst, border_type, border_value);
            break;
        }

        case ElemType::U16:
        {
            ret = BoxFilter11x11HvxHelper<DT_U16, DT_S32>(ctx, src, dst, border_type, border_value);
            break;
        }

        case ElemType::S16:
        {
            ret = BoxFilter11x11HvxHelper<DT_S16, DT_S32>(ctx, src, dst, border_type, border_value);
            break;
        }
