...
#define XVMEM_HEAP3_DEFAULT_NUM_BLOCKS      (32u)
#define XVMEM_HEAP3_MIN_ALLOC_SIZE          (4u)
#define XVMEM_HEAP3_BLOCK_STRUCT_SIZE_LOG2  (4u)
...
typedef struct
{
  ...
  uint16_t      _alignment_temp;                                 // creates proper size 
} xvmem_mgr_t;
