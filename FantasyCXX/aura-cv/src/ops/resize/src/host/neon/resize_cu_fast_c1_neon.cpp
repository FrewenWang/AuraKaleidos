...
ResizeCuC1DownX4NeonImpl(const Mat &src, Mat &dst, DT_S32 start_row, DT_S32 end_row)
{
    ...
    for (DT_S32 dy = start_row; dy < end_row; dy++)
    {
        ...
        for (; x < width_align8; x += 8)
        {
            ...
            int16x8_t vqs16_c_x19     = neon::vmul(vqs16_c_12, static_cast<DT_S16>(19));
            int16x8_t vqs16_c_result  = neon::vmls(vqs16_c_x19, vqs16_c_03, static_cast<DT_S16>(3));
            int16x8_t vqs16_n0_x19    = neon::vmul(vqs16_n0_12, static_cast<DT_S16>(19));
            int16x8_t vqs16_n0_result = neon::vmls(vqs16_n0_x19, vqs16_n0_03, static_cast<DT_S16>(3));
            int16x8_t vqs16_n1_x19    = neon::vmul(vqs16_n1_12, static_cast<DT_S16>(19));
            int16x8_t vqs16_n1_result = neon::vmls(vqs16_n1_x19, vqs16_n1_03, static_cast<DT_S16>(3));
            int16x8_t vqs16_n2_x19    = neon::vmul(vqs16_n2_12, static_cast<DT_S16>(19));
            int16x8_t vqs16_n2_result = neon::vmls(vqs16_n2_x19, vqs16_n2_03, static_cast<DT_S16>(3));
            ...
            int32x4_t vqs32_lo_x19    = neon::vmul(vqs32_result_lo12, static_cast<DT_S32>(19));
            int32x4_t vqs32_result_lo = neon::vmls(vqs32_lo_x19, vqs32_result_lo03, static_cast<DT_S32>(3));
            int32x4_t vqs32_hi_x19    = neon::vmul(vqs32_result_hi12, static_cast<DT_S32>(19));
            int32x4_t vqs32_result_hi = neon::vmls(vqs32_hi_x19, vqs32_result_hi03, static_cast<DT_S32>(3));
        ...
        for (; x < owidth; x++)
        {
            DT_S32 y0 = (src_c[1] + src_c[2]) * 19 - (src_c[0] + src_c[3]) * 3;
            DT_S32 y1 = (src_n0[1] + src_n0[2]) * 19 - (src_n0[0] + src_n0[3]) * 3;
            DT_S32 y2 = (src_n1[1] + src_n1[2]) * 19 - (src_n1[0] + src_n1[3]) * 3;
            DT_S32 y3 = (src_n2[1] + src_n2[2]) * 19 - (src_n2[0] + src_n2[3]) * 3;

            DT_S32 temp = (y1 * 19 - y0 * 3 + y2 * 19 - y3 * 3 + 512) >> 10;
...
ResizeCuC1DownX4NeonImpl(const Mat &src, Mat &dst, DT_S32 start_row, DT_S32 end_row)
{
    ...
    for (DT_S32 dy = start_row; dy < end_row; dy++)
    {
        ...
        for (; x < width_align4; x += 4)
        {
            ...
            int32x4_t vqs32_c_x19     = neon::vmul(vqs32_c_12, static_cast<DT_S32>(19));
            int32x4_t vqs32_c_result  = neon::vmls(vqs32_c_x19, vqs32_c_03, static_cast<DT_S32>(3));
            int32x4_t vqs32_n0_x19    = neon::vmul(vqs32_n0_12, static_cast<DT_S32>(19));
            int32x4_t vqs32_n0_result = neon::vmls(vqs32_n0_x19, vqs32_n0_03, static_cast<DT_S32>(3));
            int32x4_t vqs32_n1_x19    = neon::vmul(vqs32_n1_12, static_cast<DT_S32>(19));
            int32x4_t vqs32_n1_result = neon::vmls(vqs32_n1_x19, vqs32_n1_03, static_cast<DT_S32>(3));
            int32x4_t vqs32_n2_x19    = neon::vmul(vqs32_n2_12, static_cast<DT_S32>(19));
            int32x4_t vqs32_n2_result = neon::vmls(vqs32_n2_x19, vqs32_n2_03, static_cast<DT_S32>(3));
            ...
            int32x4_t vqs32_result_x19 = neon::vmul(vqs32_result_12, static_cast<DT_S32>(19));
            int32x4_t vqs32_result     = neon::vmls(vqs32_result_x19, vqs32_result_03, static_cast<DT_S32>(3));
...
ResizeCuC1DownX4NeonImpl(const Mat &src, Mat &dst, DT_S32 start_row, DT_S32 end_row)
{
    ...
    for (DT_S32 dy = start_row; dy < end_row; dy++)
    {
        ...
        for (; x < width_align4; x += 4)
        {
            ...
            float32x4_t vqf32_c_12  = neon::vadd(neon::vcvt<DT_F32>(v4df16_c.val[1]),  neon::vcvt<DT_F32>(v4df16_c.val[2]));
            float32x4_t vqf32_c_03  = neon::vadd(neon::vcvt<DT_F32>(v4df16_c.val[0]),  neon::vcvt<DT_F32>(v4df16_c.val[3]));
            float32x4_t vqf32_n0_12 = neon::vadd(neon::vcvt<DT_F32>(v4df16_n0.val[1]), neon::vcvt<DT_F32>(v4df16_n0.val[2]));
            float32x4_t vqf32_n0_03 = neon::vadd(neon::vcvt<DT_F32>(v4df16_n0.val[0]), neon::vcvt<DT_F32>(v4df16_n0.val[3]));
            float32x4_t vqf32_n1_12 = neon::vadd(neon::vcvt<DT_F32>(v4df16_n1.val[1]), neon::vcvt<DT_F32>(v4df16_n1.val[2]));
            float32x4_t vqf32_n1_03 = neon::vadd(neon::vcvt<DT_F32>(v4df16_n1.val[0]), neon::vcvt<DT_F32>(v4df16_n1.val[3]));
            float32x4_t vqf32_n2_12 = neon::vadd(neon::vcvt<DT_F32>(v4df16_n2.val[1]), neon::vcvt<DT_F32>(v4df16_n2.val[2]));
            float32x4_t vqf32_n2_03 = neon::vadd(neon::vcvt<DT_F32>(v4df16_n2.val[0]), neon::vcvt<DT_F32>(v4df16_n2.val[3]));

            float32x4_t vqf32_c_x19     = neon::vmul(vqf32_c_12, static_cast<DT_F32>(0.59375));
            float32x4_t vqf32_c_x3      = neon::vmul(vqf32_c_03, static_cast<DT_F32>(-0.09375));
            float32x4_t vqf32_c_result  = neon::vadd(vqf32_c_x19, vqf32_c_x3);
            float32x4_t vqf32_n0_x19    = neon::vmul(vqf32_n0_12, static_cast<DT_F32>(0.59375));
            float32x4_t vqf32_n0_x3     = neon::vmul(vqf32_n0_03, static_cast<DT_F32>(-0.09375));
            float32x4_t vqf32_n0_result = neon::vadd(vqf32_n0_x19, vqf32_n0_x3);
            float32x4_t vqf32_n1_x19    = neon::vmul(vqf32_n1_12, static_cast<DT_F32>(0.59375));
            float32x4_t vqf32_n1_x3     = neon::vmul(vqf32_n1_03, static_cast<DT_F32>(-0.09375));
            float32x4_t vqf32_n1_result = neon::vadd(vqf32_n1_x19, vqf32_n1_x3);
            float32x4_t vqf32_n2_x19    = neon::vmul(vqf32_n2_12, static_cast<DT_F32>(0.59375));
            float32x4_t vqf32_n2_x3     = neon::vmul(vqf32_n2_03, static_cast<DT_F32>(-0.09375));
            ...
            float32x4_t vqf32_x19 = neon::vmul(vqf32_result_12, static_cast<DT_F32>(0.59375));
            float32x4_t vqf32_x3  = neon::vmul(vqf32_result_03, static_cast<DT_F32>(-0.09375));
        ...
        for (; x < owidth; x++)
        {
            DT_F32 y0 = (src_c[1] + src_c[2]) * 0.59375f + (src_c[0] + src_c[3]) * (-0.09375f);
            DT_F32 y1 = (src_n0[1] + src_n0[2]) * 0.59375f + (src_n0[0] + src_n0[3]) * (-0.09375f);
            DT_F32 y2 = (src_n1[1] + src_n1[2]) * 0.59375f + (src_n1[0] + src_n1[3]) * (-0.09375f);
            DT_F32 y3 = (src_n2[1] + src_n2[2]) * 0.59375f + (src_n2[0] + src_n2[3]) * (-0.09375f);
...
ResizeCuC1DownX4NeonImpl(const Mat &src, Mat &dst, DT_S32 start_row, DT_S32 end_row)
{
    ...
    for (DT_S32 dy = start_row; dy < end_row; dy++)
    {
        ...
        for (; x < width_align4; x += 4)
        {
            ...
            float32x4_t vqf32_c_x19     = neon::vmul(vqf32_c_12, static_cast<DT_F32>(0.59375));
            float32x4_t vqf32_c_result  = neon::vmls(vqf32_c_x19, vqf32_c_03, static_cast<DT_F32>(0.09375));
            float32x4_t vqf32_n0_x19    = neon::vmul(vqf32_n0_12, static_cast<DT_F32>(0.59375));
            float32x4_t vqf32_n0_result = neon::vmls(vqf32_n0_x19, vqf32_n0_03, static_cast<DT_F32>(0.09375));
            float32x4_t vqf32_n1_x19    = neon::vmul(vqf32_n1_12, static_cast<DT_F32>(0.59375));
            float32x4_t vqf32_n1_result = neon::vmls(vqf32_n1_x19, vqf32_n1_03, static_cast<DT_F32>(0.09375));
            float32x4_t vqf32_n2_x19    = neon::vmul(vqf32_n2_12, static_cast<DT_F32>(0.59375));
            float32x4_t vqf32_n2_result = neon::vmls(vqf32_n2_x19, vqf32_n2_03, static_cast<DT_F32>(0.09375));
            ...
            float32x2_t vdf32_lo_x19    = neon::vmul(vdf32_result_lo12, static_cast<DT_F32>(0.59375));
            float32x2_t vdf32_result_lo = neon::vmls(vdf32_lo_x19, vdf32_result_lo03, static_cast<DT_F32>(0.09375));
            float32x2_t vdf32_hi_x19    = neon::vmul(vdf32_result_hi12, static_cast<DT_F32>(0.59375));
            float32x2_t vdf32_result_hi = neon::vmls(vdf32_hi_x19, vdf32_result_hi03, static_cast<DT_F32>(0.09375));
...
template <typename Tp>
static typename std::enable_if<std::is_same<DT_U8, Tp>::value || std::is_same<DT_S8, Tp>::value, Status>::type
ResizeCuC1DownX2NeonImpl(Context *ctx, const Mat &src, Mat &dst, ThreadBuffer &thread_buffer, DT_S32 start_row, DT_S32 end_row)
{
    ...
    DT_S16 *rows0 = rows;
    DT_S16 *rows1 = rows0 + owidth;
    DT_S16 *rows2 = rows1 + owidth;
    DT_S16 *rows3 = rows2 + owidth;
    ...
    for (; dx < owidth_align8; dx += 8)
    {
        ...
        int16x8_t vqs16_c_x19   = neon::vmul(vqs16_c_12, static_cast<DT_S16>(19));
        int16x8_t vqs16_result0 = neon::vmls(vqs16_c_x19, vqs16_c_03, static_cast<DT_S16>(3));

        int16x8_t vqs16_n0_x19  = neon::vmul(vqs16_n0_12, static_cast<DT_S16>(19));
        int16x8_t vqs16_result1 = neon::vmls(vqs16_n0_x19, vqs16_n0_03, static_cast<DT_S16>(3));

        int16x8_t vqs16_n1_x19  = neon::vmul(vqs16_n1_12, static_cast<DT_S16>(19));
        int16x8_t vqs16_result2 = neon::vmls(vqs16_n1_x19, vqs16_n1_03, static_cast<DT_S16>(3));

        int16x8_t vqs16_n2_x19  = neon::vmul(vqs16_n2_12, static_cast<DT_S16>(19));
        int16x8_t vqs16_result3 = neon::vmls(vqs16_n2_x19, vqs16_n2_03, static_cast<DT_S16>(3));
    ...
    *rows3_x = src_n2[1] * 19 - src_n2[0] * 3 + src_n2[2] * 16;
    ...
    neon::vdup(vds16_zero, static_cast<DT_S16>(0));
    int16x4_t vds16_255;
    neon::vdup(vds16_255, static_cast<DT_S16>(255));
    ...
    for (; dx < owidth_align8; dx += 8)
    {
        ...
        int32x4_t vqs32_lo_x19 = neon::vmul(vqs32_lo12, static_cast<DT_S32>(19));
        int32x4_t vqs32_hi_x19 = neon::vmul(vqs32_hi12, static_cast<DT_S32>(19));

        int32x4_t vqs32_des_lo = neon::vmls(vqs32_lo_x19, vqs32_lo03, static_cast<DT_S32>(3));
        int32x4_t vqs32_des_hi = neon::vmls(vqs32_hi_x19, vqs32_hi03, static_cast<DT_S32>(3));
    ...
    for (; dx < owidth; dx++)
    {
        DT_S32 result = (*rows1_y * 19 - *rows0_y * 3 + *rows2_y * 19 - *rows3_y * 3 + 512) >> 10;
...
ResizeCuC1DownX2NeonImpl(Context *ctx, const Mat &src, Mat &dst, ThreadBuffer &thread_buffer, DT_S32 start_row, DT_S32 end_row)
{
    ...
    DT_S32 *rows0 = rows;
    DT_S32 *rows1 = rows0 + owidth;
    DT_S32 *rows2 = rows1 + owidth;
    DT_S32 *rows3 = rows2 + owidth;
    ...
    for (; dx < owidth_align4; dx += 4)
    {
        ...
        int32x4_t vqs32_c_x19   = neon::vmul(vqs32_c_12, static_cast<DT_S32>(19));
        int32x4_t vqs32_result0 = neon::vmls(vqs32_c_x19, vqs32_c_03, static_cast<DT_S32>(3));

        int32x4_t vqs32_n0_x19  = neon::vmul(vqs32_n0_12, static_cast<DT_S32>(19));
        int32x4_t vqs32_result1 = neon::vmls(vqs32_n0_x19, vqs32_n0_03, static_cast<DT_S32>(3));

        int32x4_t vqs32_n1_x19  = neon::vmul(vqs32_n1_12, static_cast<DT_S32>(19));
        int32x4_t vqs32_result2 = neon::vmls(vqs32_n1_x19, vqs32_n1_03, static_cast<DT_S32>(3));

        int32x4_t vqs32_n2_x19  = neon::vmul(vqs32_n2_12, static_cast<DT_S32>(19));
        int32x4_t vqs32_result3 = neon::vmls(vqs32_n2_x19, vqs32_n2_03, static_cast<DT_S32>(3));
...
ResizeCuC1DownX2NeonImpl(Context *ctx, const Mat &src, Mat &dst, ThreadBuffer &thread_buffer, DT_S32 start_row, DT_S32 end_row)
{
    ...
    DT_F32 coef0 = -0.093750; // GetCuCoef(1.5f);
    DT_F32 coef1 = 0.593750; // GetCuCoef(0.5f);
    ...
    DT_F32 *rows0 = rows;
    DT_F32 *rows1 = rows0 + owidth;
    DT_F32 *rows2 = rows1 + owidth;
    DT_F32 *rows3 = rows2 + owidth;
    ...
    for (; dx < owidth_align4; dx += 4)
    {
        ...
        // vmul 3||19
        float32x4_t vqf32_cc_x3    = neon::vmul(neon::vcvt<DT_F32>(mvdf16_cx0.val[0]), coef0);
        float32x4_t vqf32_cc_x19   = neon::vmul(neon::vcvt<DT_F32>(mvdf16_cx0.val[1]), coef1);
        float32x4_t vqf32_cr0_x3   = neon::vmul(neon::vcvt<DT_F32>(mvdf16_cx1.val[1]), coef0);
        float32x4_t vqf32_cr0_x19  = neon::vmul(neon::vcvt<DT_F32>(mvdf16_cx1.val[0]), coef1);
        float32x4_t vqf32_n0c_x3   = neon::vmul(neon::vcvt<DT_F32>(mvdf16_n0x0.val[0]), coef0);
        float32x4_t vqf32_n0c_x19  = neon::vmul(neon::vcvt<DT_F32>(mvdf16_n0x0.val[1]), coef1);
        float32x4_t vqf32_n0r0_x3  = neon::vmul(neon::vcvt<DT_F32>(mvdf16_n0x1.val[1]), coef0);
        float32x4_t vqf32_n0r0_x19 = neon::vmul(neon::vcvt<DT_F32>(mvdf16_n0x1.val[0]), coef1);
        float32x4_t vqf32_n1c_x3   = neon::vmul(neon::vcvt<DT_F32>(mvdf16_n1x0.val[0]), coef0);
        float32x4_t vqf32_n1c_x19  = neon::vmul(neon::vcvt<DT_F32>(mvdf16_n1x0.val[1]), coef1);
        float32x4_t vqf32_n1r0_x3  = neon::vmul(neon::vcvt<DT_F32>(mvdf16_n1x1.val[1]), coef0);
        float32x4_t vqf32_n1r0_x19 = neon::vmul(neon::vcvt<DT_F32>(mvdf16_n1x1.val[0]), coef1);
        float32x4_t vqf32_n2c_x3   = neon::vmul(neon::vcvt<DT_F32>(mvdf16_n2x0.val[0]), coef0);
        float32x4_t vqf32_n2c_x19  = neon::vmul(neon::vcvt<DT_F32>(mvdf16_n2x0.val[1]), coef1);
        float32x4_t vqf32_n2r0_x3  = neon::vmul(neon::vcvt<DT_F32>(mvdf16_n2x1.val[1]), coef0);
        float32x4_t vqf32_n2r0_x19 = neon::vmul(neon::vcvt<DT_F32>(mvdf16_n2x1.val[0]), coef1);
...
Status ResizeCuFastC1Neon(Context *ctx, const Mat &src, Mat &dst, const OpTarget &target)
{
    ...
    switch (src.GetElemType())
    {
        case ElemType::U8:
        {
            ret = ResizeCuFastC1NeonHelper<DT_U8>(ctx, src, dst, target);
            if (ret != Status::OK)
            {
                AURA_ADD_ERROR_STRING(ctx, "ResizeCuFastC1NeonHelper run failed, type: DT_U8");
            }
            break;
        }
        ...
        case ElemType::S8:
        {
            ret = ResizeCuFastC1NeonHelper<DT_S8>(ctx, src, dst, target);
            if (ret != Status::OK)
            {
                AURA_ADD_ERROR_STRING(ctx, "ResizeCuFastC1NeonHelper run failed, type: DT_S8");
            }
            break;
        }
        ...
        case ElemType::U16:
        {
            ret = ResizeCuFastC1NeonHelper<DT_U16>(ctx, src, dst, target);
            if (ret != Status::OK)
            {
                AURA_ADD_ERROR_STRING(ctx, "ResizeCuFastC1NeonHelper run failed, type: DT_U16");
            }
            break;
        }
        ...
        case ElemType::S16:
        {
            ret = ResizeCuFastC1NeonHelper<DT_S16>(ctx, src, dst, target);
            if (ret != Status::OK)
            {
                AURA_ADD_ERROR_STRING(ctx, "ResizeCuFastC1NeonHelper run failed, type: DT_S16");
            }
            break;
        }
        ...
        case ElemType::F32:
        {
            ret = ResizeCuFastC1NeonHelper<DT_F32>(ctx, src, dst, target);
            if (ret != Status::OK)
            {
                AURA_ADD_ERROR_STRING(ctx, "ResizeCuFastC1NeonHelper run failed, type: DT_F32");
            }
            break;
        }
