...
static MinMaxTestParam::TupleTable g_minmax_table_neon
{
    // element type
    {
        ElemType::U8,
...
NEW_TESTCASE(matrix, MinMax, neon)
{
    MinMaxTest minmax_test(UnitTest::GetInstance()->GetContext(), g_minmax_table_neon);
